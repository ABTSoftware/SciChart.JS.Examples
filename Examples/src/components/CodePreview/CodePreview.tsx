    ...
    return (
        ...
        >
            ...
            <div className={classes.rightButtonGroup}>
                ...
                {/* Minimize */}
                <IconButton
                    icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="2 2 20 20" fill="none" stroke={isFullscreen ? "#888" : "var(--text)"}>
                ...
                {/* Fullscreen */}
                <IconButton
                    icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="2 2 20 20" fill={isFullscreen ? "var(--text)" : "#888"}>
