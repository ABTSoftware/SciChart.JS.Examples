...
export const searchItems: TSearchItem[] = [
    ...
    {
        title: EXAMPLES_PAGES.chart2D_Animations_GenericAnimation.title,
        link: EXAMPLES_PAGES.chart2D_Animations_GenericAnimation.path
    },
    {
    ...
    {
        title: EXAMPLES_PAGES.chart2D_basicCharts_NonUniformHeatmapChart.title,
        link: EXAMPLES_PAGES.chart2D_basicCharts_NonUniformHeatmapChart.path
    },
    {
