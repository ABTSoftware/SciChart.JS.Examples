...
export default [
    ...
    "../Examples/Charts2D/PolarCharts/PolarSplineMountainChart",
    "../Examples/Charts2D/PolarCharts/PolarSplineStackedMountainChart",
    ...
    "../Examples/FeaturedApps/ShowCases/F1TelemetryDashboard",
