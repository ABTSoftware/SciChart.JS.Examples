...
export const MENU_ITEMS_FEATURED_APPS: TMenuItem[] = [
    {
        ...
        submenu: [
            ...
            // comment out until done
            EXAMPLES_PAGES.featuredApps_showcases_F1TelemetryDashboard,
        ],
    },
    {
...
export const MENU_ITEMS_2D: TMenuItem[] = [
    ...
    },
    {
        ...
        submenu: [
            ...
            // EXAMPLES_PAGES.chart2D_polarCharts_PolarSplineMountainChart,
            EXAMPLES_PAGES.chart2D_polarCharts_PolarStackedMountainChart,
            // EXAMPLES_PAGES.chart2D_polarCharts_PolarSplineStackedMountainChart,
            ...
            EXAMPLES_PAGES.chart2D_polarCharts_PolarHeatmapKineticTomography,
