...
const Example = React.forwardRef<HTMLHeadingElement, ExampleProps>(
    ({ example, index, gridType, setGridType }, ref) => {
                                ...
                                <div className={classes.content}>
                                    ...
                                    {gridType === EGridType.Cardview && (
                                        <div className={classes.contentButtons}>
                                            ...
                                            >
                                                <svg style={{ height: 30, width: 30 }} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="3 0 24 30">
        ...
        const calculateClosest = () => {
            ...
            headingRefs.current.forEach(ref => {
                ...
                if (distance < minDistance || 
                    (distance === minDistance && rect.top < referenceLine)) {
