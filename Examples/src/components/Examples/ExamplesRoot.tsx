            ...
            <div className={classes.body}>
                ...
                <div className={classes.colDescription}>
                    ...
                    <div className={classes.description}>
                        ...
                        <em>SciChart.js ships with ~40 <a href="https://demo.scichart.com">JavaScript Chart
                            Examples</a> which you can browse, play with, view the source code and see
                            related documentation.
                            All of this is possible with the SciChart.js Examples Suite, which ships as part of
                            the <a href="https://www.scichart.com/downloads">SciChart.js SDK</a></em>
                        <ButtonGroup
                            style={{ marginTop: 30 }}
                            size="large"
                            color="primary"
                        ...
                        >
                            <Button href="https://www.scichart.com/downloads/" target="_blank">Download the SDK</Button>
                        </ButtonGroup>
                    </div>
                    {DescComponent && (
                        <div className={classes.description}>
