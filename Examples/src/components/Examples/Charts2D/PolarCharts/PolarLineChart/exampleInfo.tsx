...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        description:
            "Creates many **JavaScript Polar Line Charts** using SciChart.js, with: data labels, line interpolation, pointMarkers, gradient stroke, startup animations.",
        tips: [],
        frameworks: {
            javascript: {
                subtitle:
                ...
                pageTitle: "JavaScript Polar Line Chart",
                metaDescription:
                ...
                markdownContent:
                    "## Polar Line Chart - JavaScript\n\n### Overview\nThis example demonstrates how to create a **Polar Line Chart** using SciChart.js in JavaScript. The implementation showcases multiple polar line series with various configurations including interpolation, point markers, and palette providers for dynamic styling.\n\n### Technical Implementation\nThe chart is initialized using `SciChartPolarSurface.create()` with common configuration options for both angular and radial axes. The example includes six distinct polar line configurations:\n1. Basic polar lines with simple data\n2. Mathematical function traces (rose curve, butterfly curve)\n3. Interpolated lines with point markers\n4. Y-value based palette providers for threshold coloring\n5. Data labels with custom styling\n6. X-value based palette providers for segment coloring\n\nEach configuration uses [PolarLineRenderableSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarlinerenderableseries.html) with [XyDataSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/xydataseries.html) for data storage. Interactive features are added via [PolarZoomExtentsModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarzoomextentsmodifier.html) and [PolarPanModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarpanmodifier.html).\n\n### Features and Capabilities\nThe example highlights advanced polar chart capabilities including:\n- [Interpolation](https://www.scichart.com/documentation/js/v5/typedoc/interfaces/ipolarlinerenderableseriesoptions.html#interpolateline) for smooth curves\n- Custom [palette providers](https://www.scichart.com/documentation/js/v5/typedoc/interfaces/ipolarlinerenderableseriesoptions.html#paletteprovider) for dynamic coloring\n- [Data labels](https://www.scichart.com/documentation/js/v5/typedoc/interfaces/ipolarlinerenderableseriesoptions.html#datalabels) with various positioning options\n- Mathematical function plotting in polar coordinates",
            },
            react: {
                subtitle:
