    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            ...
            react: {
                ...
                title: "React Polar Radial Column Chart",
                pageTitle: "React Polar Radial Column Chart",
                metaDescription: "View the React Radial Column Chart example to see the difference that SciChart has to offer. Switch radial and angular axes and add interactive modifiers.",
                markdownContent:
