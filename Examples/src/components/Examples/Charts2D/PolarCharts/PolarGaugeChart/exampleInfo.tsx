    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                pageTitle: "JavaScript Gauge Chart Example | JavaScript Circular Gauge Example",
                metaDescription: "Create JavaScript Gauge Charts, including a JavaScript Circular Gauge Dashboard, with user-friendly initialization and responsive design. Give SciChart a go.",
                markdownContent:
            ...
            angular: {
                ...
                pageTitle: "Angular Gauge Chart Example | Angular Circular Gauge Example",
                metaDescription: "Create Angular Gauge Charts, including an Angular Circular Gauge Dashboard, with a friendly initialization and responsive design. Give the SciChart demo a go.",
                markdownContent:
