    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                subtitle:
                    "Creates a **JavaScript Polar Label Modes Chart** using SciChart.js, which demonstrates the different label modes we support for Polar Axes.",
                title: "JavaScript Polar Axis Label Modes",
                pageTitle: "JavaScript Polar Axis Label Modes",
                metaDescription: "Create a JavaScript Polar Axis Label with SciChart. This demo shows the various label modes for Polar Axes – all optimised for pan, zoom, and mouse wheel.",
            ...
            react: {
                ...
                title: "React Polar Axis Label Modes",
                pageTitle: "React Polar Axis Label Modes",
                metaDescription: "Create a React Polar Axis Label with SciChart. This demo shows the various label modes for Polar Axes – all optimised for pan, zoom, and mouse wheel.",
            ...
            angular: {
                ...
                title: "Angular Polar Axis Label Modes",
                pageTitle: "Angular Polar Axis Label Modes",
                metaDescription: "Create an Angular Polar Axis Label with SciChart. This demo shows the various label modes for Polar Axes – all optimised for pan, zoom, and mouse wheel.",
        ...
        metaKeywords: "polar, axis, label, polarLabelMode, javascript, webgl, canvas",
        onWebsite: true,
