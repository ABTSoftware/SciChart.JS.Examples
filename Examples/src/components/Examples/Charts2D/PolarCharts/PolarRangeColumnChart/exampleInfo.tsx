    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                pageTitle: "JavaScript Polar Range Column Chart",
                metaDescription: "Create a JavaScript Polar Range Column Chart with SciChart. This example displays monthly minimum and maximum temperatures within a Polar layout. Try the demo.",
                markdownContent: "## Polar Range Column Chart - JavaScript\n\n### Overview\nThis example renders a **Polar Range Column Chart** visualizing monthly minimum and maximum surface temperatures using SciChart.js. It a polar surface with radial and angular axes to display a donut-style column series.\n\n### Technical Implementation\nThe chart is initialized via `SciChartPolarSurface.create()`, applying `PolarNumericAxis` for the radial axis ([documentation](https://www.scichart.com/documentation/js/v4/2d-charts/axis-api/axis-types/polar-numeric-axis/)) and `PolarCategoryAxis` for the angular axis to map 12 months evenly around the circle ([layout guide](https://www.scichart.com/documentation/js/v4/2d-charts/axis-api/multi-axis-and-layout/polar-chart-layout/)). A `PolarColumnRenderableSeries` is configured with an `XyyDataSeries` supplying `yValues` (min) and `y1Values` (max), and animated via `SweepAnimation`.\n\n### Features and Capabilities\nReal-time updates can be achieved by updating the data series. Interactive modifiers include `PolarPanModifier`, `PolarZoomExtentsModifier`, and `PolarMouseWheelZoomModifier` for smooth panning, zooming, and mouse-wheel control.\n\n### Integration and Best Practices\nUse `SciChartSurface.delete()` to clean up WebAssembly resources when disposing. For performance, enable `zoomExtentsToInitialRange` on axes and minimize redraws by batching data updates."
            },
            react: {
                subtitle:
