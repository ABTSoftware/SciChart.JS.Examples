    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                pageTitle: "JavaScript Windrose Column Chart | Polar Stacked Column Chart ",
                metaDescription: "View the JavaScript Windrose Chart example to display directional data with stacked columns in a polar layout. Try the polar chart demo with customizable labels",
            ...
            react: {
                ...
                pageTitle: "React Windrose Column Chart | Polar Stacked Column Chart ",
                metaDescription: "View the React Windrose Chart example to display directional data with stacked columns in a polar layout. Try the polar chart demo with customizable labels.",
            ...
            angular: {
                ...
                pageTitle: "Angular Windrose Column Chart | Polar Stacked Column Chart ",
                metaDescription: "View the Angular Windrose Chart example to display directional data with stacked columns in a polar layout. Try the polar chart demo with customizable labels.",
