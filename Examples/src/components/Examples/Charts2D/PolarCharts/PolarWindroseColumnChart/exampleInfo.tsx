    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Polar Windrose Column Chart - JavaScript\n\n### Overview\nThis example demonstrates how to create a **Polar Windrose Column Chart** using SciChart.js in JavaScript. The chart visualizes directional data with stacked columns in a polar coordinate system, commonly used for wind speed/direction analysis.\n\n### Technical Implementation\nThe chart uses [SciChartPolarSurface](https://www.scichart.com/documentation/js/v5/typedoc/classes/scichartpolarsurface.html) with [PolarNumericAxis](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarnumericaxis.html) for radial and angular axes. A custom [CustomNESWLabelProvider](https://www.scichart.com/documentation/js/v5/typedoc/classes/numericlabelprovider.html) displays compass directions. Data is generated via `getBiasedRandomWalkInBounds` function to create realistic wind patterns.\n\n### Features and Capabilities\nThe implementation uses [PolarStackedColumnCollection](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarstackedcolumncollection.html) with multiple [PolarStackedColumnRenderableSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarstackedcolumnrenderableseries.html) for stacked visualization. Interactive features include [PolarPanModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarpanmodifier.html) and [PolarZoomExtentsModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarzoomextentsmodifier.html).\n\n### Integration and Best Practices\nThe example follows async initialization pattern with proper cleanup. Developers can extend this by adding real-time data updates or customizing the [WaveAnimation](https://www.scichart.com/documentation/js/v5/typedoc/classes/waveanimation.html) effects.",
            },
            react: {
                subtitle:
