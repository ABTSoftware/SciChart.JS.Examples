    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                subtitle:
                    "Creates a **JavaScript Polar Stacked Mountain Chart** using SciChart's powerful JavaScript Charts and its range of features.",
                title: "JavaScript Polar Stacked Radial Mountain Chart",
                pageTitle: "JavaScript Polar Stacked Radial Mountain Chart",
                metaDescription:
