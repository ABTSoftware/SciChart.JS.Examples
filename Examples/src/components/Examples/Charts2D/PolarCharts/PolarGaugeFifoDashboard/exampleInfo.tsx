    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                metaDescription: "View JavaScript Arc Gauge Charts alongside FIFO Scrolling Charts, all on the same dashboard with real-time, high-performance data rendering. Try the demo.",
                markdownContent:
            ...
            react: {
                ...
                pageTitle:
                    "React Arc Gauge & FIFO Scrolling Charts Dashboard",
                metaDescription: "View React Arc Gauge Charts alongside FIFO Scrolling Charts, all on the same dashboard with real-time, high-performance data rendering. Try the demo.",
                markdownContent:
            ...
            angular: {
                ...
                metaDescription: "View Angular Arc Gauge Charts alongside FIFO Scrolling Charts, all on the same dashboard with real-time, high-performance data rendering. Try the demo.",
                markdownContent:
