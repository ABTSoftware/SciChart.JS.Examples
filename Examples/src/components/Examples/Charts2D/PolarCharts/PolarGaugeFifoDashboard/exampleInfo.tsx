    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                subtitle:
                    "Creates a **JavaScript Realtime Radial Gauges and Fifo Scrolling Charts Dashboard** using SciChart.js, which displays Polar Gauge Charts for the current values, and a cartesian historical FIFO view.",
                title: "JavaScript Arc Gauge & FIFO Scrolling Charts Dashboard Example",
                pageTitle: "JavaScript Arc Gauge & FIFO Scrolling Charts Dashboard",
                metaDescription:
                ...
                markdownContent:
                    "## Realtime Radial Gauges and Fifo Scrolling Charts Dashboard - React\n\n### Overview\nThis React example demonstrates a dynamic dashboard featuring **polar gauge charts** and **FIFO (First-In-First-Out) line charts** using SciChart.js. The implementation combines [SciChartPolarSubSurface](https://www.scichart.com/documentation/js/v5/typedoc/classes/scichartpolarsubsurface.html) for gauge visualization with [SciChartSubSurface](https://www.scichart.com/documentation/js/v5/typedoc/classes/scichartsubsurface.html) for real-time data streaming.\n\n### Technical Implementation\nThe dashboard uses React's `SciChartReact` component with an `initChart` function that creates two polar gauges and two FIFO charts. The gauges are built using [PolarArcAnnotation](https://www.scichart.com/documentation/js/v5/typedoc/classes/polararcannotation.html) for the arc segments and [NativeTextAnnotation](https://www.scichart.com/documentation/js/v5/typedoc/classes/nativetextannotation.html) for centered values. The FIFO charts utilize [XyDataSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/xydataseries.html) with `fifoCapacity` for efficient memory management.\n\n### Features and Capabilities\nKey features include:\n- **Real-time updates** with smooth gauge needle animations\n- **Color thresholds** that change based on value ranges (green/orange/pink)\n- **Optimized rendering** through WebGL acceleration\n- **Responsive layout** using relative positioning with [Rect](https://www.scichart.com/documentation/js/v5/typedoc/classes/rect.html) coordinates\n\n### Integration and Best Practices\nThe example follows React best practices by:\n- Using the [SciChart React wrapper](https://www.scichart.com/documentation/js/v5/get-started/tutorials-react/tutorial-01-setting-up-project-with-scichart-react/) for proper lifecycle management\n- Implementing efficient updates with `requestAnimationFrame`\n- Separating gauge and chart logic into reusable functions\n- Providing cleanup via `sciChartSurface.delete()`",
            },
            react: {
                subtitle:
                ...
                title: "React Arc Gauge & FIFO Scrolling Charts Dashboard Example",
                pageTitle: "React Arc Gauge & FIFO Scrolling Charts Dashboard",
                metaDescription:
            ...
            angular: {
                ...
                title: "Angular Arc Gauge & FIFO Scrolling Charts Dashboard Example",
                pageTitle: "Angular Arc Gauge & FIFO Scrolling Charts Dashboard",
                metaDescription:
        ...
        metaKeywords: "polar, column, arc, gauge, chart, javascript, webgl, canvas",
        onWebsite: true,
