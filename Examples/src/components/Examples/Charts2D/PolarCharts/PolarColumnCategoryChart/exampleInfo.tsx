    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                pageTitle: "JavaScript Polar Column Category Chart",
                metaDescription:
                ...
                markdownContent:
                    "## Polar Column Category Chart - JavaScript\n\n### Overview\nThis example demonstrates how to create a **Polar Column Chart** with category axis labels in JavaScript using SciChart.js. The visualization displays UK consumer price changes as radial columns with color-coded positive/negative values.\n\n### Technical Implementation\nThe chart uses a [PolarCategoryAxis](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarcategoryaxis.html) for angular positioning of food categories and a [PolarNumericAxis](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarnumericaxis.html) for radial value display. Data is rendered via [PolarColumnRenderableSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarcolumnrenderableseries.html) with a custom [ColumnPaletteProvider](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/palette-provider-api/polar-column-renderable-series) that colors columns differently above/below a threshold.\n\n### Features and Capabilities\nKey features include:\n- Radial data labels with percentage formatting\n- Custom color thresholds using palette providers\n- Interactive modifiers like [PolarZoomExtentsModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarzoomextentsmodifier.html) and [PolarPanModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarpanmodifier.html)\n- Wave animation effects on initial render\n\n### Integration and Best Practices\nThe implementation follows SciChart's async initialization pattern for optimal performance. Proper cleanup is handled via surface disposal. For production use, consider [data streaming techniques](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/data-series-api/realtime-updates/) for dynamic updates.",
            },
            react: {
                subtitle:
                ...
                pageTitle: "React Polar Column Category Chart",
                metaDescription:
            ...
            angular: {
                ...
                pageTitle: "Angular Polar Column Category Chart",
                metaDescription:
