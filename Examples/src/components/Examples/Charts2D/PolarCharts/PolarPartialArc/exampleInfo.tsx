    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                pageTitle: "JavaScript Polar Partial Arc",
                metaDescription:
                ...
                markdownContent:
                    "## Polar Partial Arc Chart - JavaScript\n\n### Overview\nThis example demonstrates how to create a **partial polar chart** in JavaScript using SciChart.js, where the polar coordinate system is configured to display only a small arc segment. The chart mimics Cartesian coordinates by setting extreme values for [innerRadius](https://www.scichart.com/documentation/js/v5/typedoc/classes/polaraxisbase.html#innerradius) and [totalAngle](https://www.scichart.com/documentation/js/v5/typedoc/classes/polaraxisbase.html#totalangle) properties.\n\n### Technical Implementation\nThe implementation uses [SciChartPolarSurface.create()](https://www.scichart.com/documentation/js/v5/typedoc/classes/scichartpolarsurface.html) to initialize the chart with radial and angular axes. A [PolarLineRenderableSeries](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/polar-line-renderable-series/) displays petal-shaped data, while modifiers like [PolarZoomExtentsModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarzoomextentsmodifier.html) enable interactivity. The animation transitions between partial and full polar views using [GenericAnimation](https://www.scichart.com/documentation/js/v5/typedoc/classes/genericanimation.html).\n\n### Features and Capabilities\nKey features include dynamic adjustment of polar chart parameters, smooth animations between view states, and interactive zoom/pan behavior. The example showcases how polar charts can visually approximate Cartesian coordinates when configured with specific axis properties.\n\n### Integration and Best Practices\nThe implementation follows best practices for asynchronous chart initialization and proper resource cleanup. Developers can extend this example by incorporating real-time data updates or additional polar series types as described in the [Polar Chart documentation](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/polar-partial-chart-type/).",
            },
            react: {
                subtitle:
                ...
                pageTitle: "React Polar Partial Arc",
                metaDescription:
                ...
                markdownContent:
                    "## Polar Partial Arc Chart - React\n\n### Overview\nThis React example demonstrates a **partial polar chart** using SciChart.js, configured through the [SciChart React](https://www.scichart.com/blog/react-charts-with-scichart-js/) component. The chart displays a small arc segment of polar coordinates, visually resembling Cartesian axes.\n\n### Technical Implementation\nThe chart is initialized via an `initChart` function passed to SciChartReact, creating a [SciChartPolarSurface](https://www.scichart.com/documentation/js/v5/typedoc/classes/scichartpolarsurface.html) with customized [PolarNumericAxis](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarnumericaxis.html) instances. The example includes interactive modifiers and animations that update component state through callbacks.\n\n### Features and Capabilities\nThe implementation features dynamic control over polar chart parameters, smooth animated transitions between view states, and real-time updates to React state. The [PolarLineRenderableSeries](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/polar-line-renderable-series/) demonstrates efficient rendering of polar data.\n\n### Integration and Best Practices\nThis example follows React best practices by managing chart lifecycle through the SciChartReact component and demonstrating proper cleanup. For more complex implementations, refer to the [React integration guide](https://www.scichart.com/blog/react-charts-with-scichart-js/).",
            },
            angular: {
                subtitle:
                ...
                pageTitle: "Angular Polar Partial Arc",
                metaDescription:
