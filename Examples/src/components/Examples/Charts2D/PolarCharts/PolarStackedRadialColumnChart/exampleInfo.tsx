    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                subtitle:
                    "Creates a **JavaScript Stacked Radial Column Chart** representing Olympic medals per country, using SciChart.js",
                title: "JavaScript Stacked Radial Column Chart | Stacked Radial Bar Chart",
                pageTitle: "JavaScript Stacked Radial Column Chart | Stacked Radial Bar Chart",
                metaDescription:
                ...
                markdownContent:
                    "## Polar Stacked Radial Column Chart - JavaScript\n\n### Overview\nThis example demonstrates how to create a **Polar Stacked Radial Column Chart** using SciChart.js, visualizing Winter Olympic medals per country with stacked columns in a polar coordinate system. The chart uses [PolarStackedColumnCollection](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarstackedcolumncollection.html) to display medal counts as radial columns.\n\n### Technical Implementation\nThe chart initializes a [SciChartPolarSurface](https://www.scichart.com/documentation/js/v5/typedoc/classes/scichartpolarsurface.html) with radial (x) and angular (y) axes. The x-axis is configured with [EPolarAxisMode.Radial](https://www.scichart.com/documentation/js/v5/typedoc/enums/epolaraxismode.html) and uses a [TextLabelProvider](https://www.scichart.com/documentation/js/v5/typedoc/classes/textlabelprovider.html) for country names. Three [PolarStackedColumnRenderableSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarstackedcolumnrenderableseries.html) represent gold, silver, and bronze medals with gradient fills.\n\n### Features and Capabilities\nThe example includes interactive modifiers like [PolarZoomExtentsModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarzoomextentsmodifier.html) and [PolarLegendModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarlegendmodifier.html) for user interaction. The [WaveAnimation](https://www.scichart.com/documentation/js/v5/typedoc/classes/waveanimation.html) provides smooth series initialization.\n\n### Integration and Best Practices\nThe implementation follows async initialization patterns and includes proper cleanup. The radial layout with [flippedCoordinates](https://www.scichart.com/documentation/js/v5/typedoc/interfaces/ipolarnumericaxisoptions.html#flippedcoordinates) ensures optimal data presentation.",
            },
            react: {
                subtitle:
                    "Creates a **React Stacked Radial Column Chart** representing Olympic medals per country, using SciChart.js",
                title: "React Stacked Radial Column Chart | Stacked Radial Bar Chart",
                pageTitle: "React Stacked Radial Column Chart | Stacked Radial Bar Chart",
                metaDescription:
                ...
                markdownContent:
                    "## Polar Stacked Radial Column Chart - React\n\n### Overview\nThis React example showcases a **Polar Stacked Radial Column Chart** using SciChart's [SciChart React](https://www.scichart.com/blog/react-charts-with-scichart-js/) component. It visualizes Olympic medal data with stacked radial columns, demonstrating React integration with SciChart's polar charts.\n\n### Technical Implementation\nThe chart is initialized via the `initChart` prop passed to `<SciChartReact/>`, creating a [SciChartPolarSurface](https://www.scichart.com/documentation/js/v5/typedoc/classes/scichartpolarsurface.html) with radial columns. The implementation uses React's component structure while leveraging SciChart's WebAssembly core for high performance.\n\n### Features and Capabilities\nThe chart features medal data grouped by country with [PolarStackedColumnRenderableSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarstackedcolumnrenderableseries.html) for each medal type. Interactive elements include [PolarMouseWheelZoomModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarmousewheelzoommodifier.html) and a configurable legend.\n\n### Integration and Best Practices\nThe example demonstrates proper React integration patterns using SciChart's dedicated React component. The async initialization and theme application follow React best practices for data visualization components.",
            },
            angular: {
                subtitle:
                    "Creates a **Angular Stacked Radial Column Chart** representing Olympic medals per country, using SciChart.js",
                title: "Angular Stacked Radial Column Chart | Stacked Radial Bar Chart",
                pageTitle: "Angular Stacked Radial Column Chart | Stacked Radial Bar Chart",
                metaDescription:
