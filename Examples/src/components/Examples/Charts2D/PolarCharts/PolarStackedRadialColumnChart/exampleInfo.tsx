    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Polar Stacked Radial Column Chart - JavaScript\n\n### Overview\nThis example demonstrates how to create a **Polar Stacked Radial Column Chart** using SciChart.js, visualizing Winter Olympic medals per country with stacked columns in a polar coordinate system. The chart uses [PolarStackedColumnCollection](https://www.scichart.com/documentation/js/v4/typedoc/classes/polarstackedcolumncollection.html) to display medal counts as radial columns.\n\n### Technical Implementation\nThe chart initializes a [SciChartPolarSurface](https://www.scichart.com/documentation/js/v4/typedoc/classes/scichartpolarsurface.html) with radial (x) and angular (y) axes. The x-axis is configured with [EPolarAxisMode.Radial](https://www.scichart.com/documentation/js/current/globals.html#epolaraxismode) and uses a [TextLabelProvider](https://www.scichart.com/documentation/js/v4/typedoc/classes/textlabelprovider.html) for country names. Three [PolarStackedColumnRenderableSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/polarstackedcolumnrenderableseries.html) represent gold, silver, and bronze medals with gradient fills.\n\n### Features and Capabilities\nThe example includes interactive modifiers like [PolarZoomExtentsModifier](https://www.scichart.com/documentation/js/v4/typedoc/classes/polarzoomextentsmodifier.html) and [PolarLegendModifier](https://www.scichart.com/documentation/js/v4/typedoc/classes/polarlegendmodifier.html) for user interaction. The [WaveAnimation](https://www.scichart.com/documentation/js/v4/typedoc/classes/waveanimation.html) provides smooth series initialization.\n\n### Integration and Best Practices\nThe implementation follows async initialization patterns and includes proper cleanup. The radial layout with [flippedCoordinates](https://www.scichart.com/documentation/js/v4/typedoc/interfaces/ipolarnumericaxisoptions.html#flippedcoordinates) ensures optimal data presentation.",
            },
            react: {
                subtitle:
