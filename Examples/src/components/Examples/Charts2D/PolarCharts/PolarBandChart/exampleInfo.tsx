...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        description:
            "Creates a **JavaScript Polar Band Chart** using SciChart.js, our feature-rich JavaScript Chart Library",
        tips: [],
        frameworks: {
            javascript: {
                subtitle: "Create a **JavaScript Polar Band Chart** using SciChart.js",
                title: "JavaScript Polar Band | Polar Error Bands Chart",
                pageTitle: "JavaScript Polar Band | Polar Error Bands Chart",
                metaDescription:
        ...
        metaKeywords: "polar, band, chart, error, javascript, webgl, canvas",
        onWebsite: true,
