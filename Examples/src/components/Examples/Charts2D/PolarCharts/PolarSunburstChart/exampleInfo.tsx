    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                pageTitle: "JavaScript Polar Sunburst Chart",
                metaDescription:
                ...
                markdownContent:
                    "## Polar Sunburst Chart - JavaScript\n\n### Overview\nThis example demonstrates how to create an interactive **Polar Sunburst Chart** using SciChart.js in JavaScript. The chart visualizes hierarchical data through concentric rings of [PolarColumnRenderableSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarcolumnrenderableseries.html), where each segment represents a node in the tree structure.\n\n### Technical Implementation\nThe implementation processes hierarchical JSON data into level-wise flat arrays using `getDataById()`. Each level is rendered as a separate [PolarColumnRenderableSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarcolumnrenderableseries.html) with angular size corresponding to value and radial distance encoding depth. The chart uses [GenericAnimation](https://www.scichart.com/documentation/js/v5/typedoc/classes/genericanimation.html) for smooth drill-down transitions between hierarchy levels.\n\n### Features and Capabilities\nThe example features interactive drill-down/up functionality via [PolarDataPointSelectionModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/polardatapointselectionmodifier.html). Custom [SunburstPaletteProvider](https://www.scichart.com/documentation/js/v5/typedoc/interfaces/ifillpaletteprovider.html) dynamically adjusts segment colors based on selection state. Data labels display node metadata using a custom formatter.\n\n### Integration and Best Practices\nThe chart showcases efficient memory management by properly disposing series during navigation. The async initialization pattern ensures optimal performance when loading the WebAssembly context.",
            },
            react: {
                subtitle:
                ...
                pageTitle: "React Polar Sunburst Chart",
                metaDescription:
                ...
                markdownContent:
                    "## Polar Sunburst Chart - React\n\n### Overview\nThis React example demonstrates how to integrate SciChart.js's **Polar Sunburst Chart** using the [SciChart React](https://www.scichart.com/blog/react-charts-with-scichart-js/) component. The chart displays hierarchical data through animated polar columns with interactive drill-down capabilities.\n\n### Technical Implementation\nThe implementation uses React hooks pattern with the `SciChartReact` wrapper component. The core chart logic in `drawExample.ts` creates a [SciChartPolarSurface](https://www.scichart.com/documentation/js/v5/typedoc/classes/scichartpolarsurface.html) and configures polar axes. The recursive `drawSeriesFn` handles dynamic series generation for each hierarchy level.\n\n### Features and Capabilities\nThe chart features smooth animated transitions between levels using [GenericAnimation](https://www.scichart.com/documentation/js/v5/typedoc/classes/genericanimation.html). Interactive selection is implemented via [PolarCursorModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/polarcursormodifier.html) with custom tooltips. The [SunburstPaletteProvider](https://www.scichart.com/documentation/js/v5/typedoc/interfaces/ifillpaletteprovider.html) dynamically updates segment colors.\n\n### Integration and Best Practices\nThe example follows React best practices by encapsulating chart logic in a separate module. The `SciChartReact` component handles proper cleanup of WebAssembly resources when unmounting.",
            },
            angular: {
                subtitle:
                ...
                pageTitle: "Angular Polar Sunburst Chart",
                metaDescription:
        ...
        metaKeywords: "polar, sunburst, animation, column, chart, javascript, webgl, canvas",
        onWebsite: true,
