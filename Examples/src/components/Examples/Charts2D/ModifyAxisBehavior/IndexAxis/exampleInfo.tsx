...
const metaData: IExampleMetadata =
    ...
    {
        reactComponent: "IndexAxis",
        id: "chart2D_modifyAxisBehavior_IndexAxis",
        imagePath: "javascript-chart-index-axis.jpg",
        description:
            "Demonstrates how to create a **JavaScript Chart with Index axis** using SciChart.js, High Performance JavaScript Charts",
        tips: [],
        frameworks: {
            javascript: {
                subtitle:
                    "Demonstrates how to create a **JavaScript Chart with Index axis** using SciChart.js, High Performance JavaScript Charts",
                title: "JavaScript Chart with Index Axis Example",
                pageTitle: "JavaScript Chart with Index Axis Example",
                metaDescription:
                    "Demonstrates Index Axis on a JavaScript Chart using SciChart.js. SciChart supports logarithmic axis with scientific or engineering notation and positive and negative values",
                markdownContent:
            ...
            react: {
                ...
                title: "React Chart with Index Axis Example",
                pageTitle: "React Chart with Index Axis Example",
                metaDescription:
        ...
        path: "chart-index-axis",
        metaKeywords: "logarithmic, axis, chart, javascript, webgl, canvas",
        onWebsite: true,
        filepath: "Charts2D/ModifyAxisBehavior/IndexAxis",
        thumbnailImage: "javascript-chart-index-axis.jpg",
        sandboxConfig: {},
...
export const indexAxisExampleInfo = createExampleInfo(metaData);
export default indexAxisExampleInfo;
