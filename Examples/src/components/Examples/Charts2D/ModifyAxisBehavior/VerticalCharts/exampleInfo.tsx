    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Vertical Charts Example - JavaScript\n\n### Overview\nThis example demonstrates how to create a rotated chart in JavaScript using SciChart.js. The chart can be rotated 90-degrees and rendered vertically with series drawn top to bottom by configuring the `xAxis.axisAlignment = EAxisAlignment.Left` and the `yAxis.axisAlignment = EAxisAlignment.Bottom`. This approach enables users to visualize data in a vertical orientation, offering a unique perspective for data analysis.\n\n### Technical Implementation\nThe implementation initializes a `SciChartSurface` asynchronously using the WebAssembly context provided by SciChart.js. `NumericAxis` can be configured with specific alignment properties to rotate the chart, as detailed in the [Vertical Charts (Rotate, Transpose Axis) - SciChart](https://www.scichart.com/documentation/js/v4/2d-charts/axis-api/multi-axis-and-layout/vertical-charts-rotate-transpose-axis/) guide. Data for the chart is generated using a random walk generator and visualized via a `FastLineRenderableSeries` which ensures high performance. Interactive features are added with modifiers such as `ZoomPanModifier`, `ZoomExtentsModifier`, and `MouseWheelZoomModifier`, following guidelines from the [Tutorial 03 - Adding Zooming, Panning Behavior](https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-03-adding-zooming-panning-behavior/).\n\n### Features and Capabilities\nThe chart takes advantage of SciChart.js capabilities such as real-time updates and advanced customizations. The use of the `FastLineRenderableSeries` significantly optimizes performance, a topic further explained in the [Performance Tips & Tricks | JavaScript Chart Documentation](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/performance-tips-and-tricks/) resource. Additionally, custom point markers like the `EllipsePointMarker` provide visual enhancements, while native text annotations offer user guidance directly on the chart.\n\n### Integration and Best Practices\nThis implementation is tailored for JavaScript environments, illustrating best practices for asynchronous initialization and resource management. The example includes a cleanup function to properly dispose of the `SciChartSurface`, ensuring effective memory management as described in the [Memory Best Practices](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/memory-best-practices/) documentation. Developers looking to integrate SciChart.js in JavaScript can refer to the [Getting Started with SciChart JS](https://www.scichart.com/getting-started/scichart-javascript/) guide to further streamline their development process. By following these guidelines, this example encapsulates critical aspects of performance optimization, interactivity setup, and architectural best practices in JavaScript.",
            },
            react: {
                subtitle:
...
export default verticalChartsExampleInfo;
