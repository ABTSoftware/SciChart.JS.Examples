...
import { metaData } from "./VerticalChartsMetadata";
...
export const oldverticalChartsExampleInfo: TExampleInfo = {
    onWebsite: true,
...
export const verticalChartsExampleInfo = createExampleInfo(metaData as IExampleMetadata);
