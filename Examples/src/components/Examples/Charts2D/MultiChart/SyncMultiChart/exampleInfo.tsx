    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            ...
            react: {
                ...
                metaDescription: "Synchronise multiple dynamic charts and overview",
                markdownContent:
                    "## Synchronise Multiple Charts - React\n\n### Overview\nThis example demonstrates how to synchronise layout and visible range across multiple dynamic charts in a React application using SciChart.js. It features a main overview chart that is linked to several dynamic charts, allowing the user to zoom and pan in one chart and see the changes reflected in the others.\n\n### Technical Implementation\nThe implementation utilizes React hooks such as useState, useRef, and useEffect to manage the lifecycle of each `SciChartSurface` component dynamically. A custom `AxisSynchroniser` class manages the visible range updates for all linked X axes, ensuring synchronized navigation across charts. The example also demonstrates how to clone series for the overview chart using SciChart.js methods, and integrates various chart modifiers like RolloverModifier, `RubberBandXyZoomModifier`, `ZoomPanModifier`, and `MouseWheelZoomModifier` to enhance interactivity. For further technical details on synchronizing charts, refer to the [Synchronizing Multiple Charts Documentation](https://www.scichart.com/documentation/js/v4/2d-charts/chart-synchronization-api/synchronizing-multiple-charts/).\n\n### Features and Capabilities\nThis example offers several advanced features including real-time dynamic chart rendering, coordinated zooming and panning across multiple charts, and interactive adding or removing of chart components. Custom event handling through the `AxisSynchroniser` class allows for smooth updates between the main charts and the overview. The efficient use of [custom event handling for axis ranging](https://www.scichart.com/documentation/js/v4/2d-charts/axis-api/ranging-scaling/listen-to-visible-range-changes/) ensures that performance remains optimal even during dynamic data updates.\n\n### Integration and Best Practices\nBuilt exclusively with React, this example highlights best practices for integrating third-party libraries like SciChart.js into a React project. The use of refs for managing instances such as `SciChartVerticalGroup`, combined with meticulous cleanup within the `useEffect` hook, adheres to performance optimization techniques as detailed in the [Memory Best Practices](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/memory-best-practices/). Additionally, the integration of Material UI components for layout management provides a clear example of how to combine modern UI toolkits with high-performance charting. Developers looking for an in-depth understanding of React integration can explore the guidance provided in [Creating a SciChart React Component from the Ground Up](https://www.scichart.com/documentation/js/v4/get-started/tutorials-react/tutorial-01-setting-up-project-with-scichart-react/).",
            },
            angular: {
                subtitle:
                    "This example demonstrates how to synchronise layout and visible range across multiple dynamic charts, and how to synchronise series with an overview chart.using SciChart.js, High Performance JavaScript Charts",
        ...
        documentationLinks: [
            ...
            {
                href: "https://www.scichart.com/documentation/js/v4/2d-charts/chart-modifier-api/zooming-and-panning/overview/",
