...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        description: "Demonstrates how to create a **Choropleth map**",
        tips: [],
        frameworks: {
            javascript: {
                subtitle: "Demonstrates how to create a **Choropleth map**",
            ...
            react: {
                ...
                pageTitle: "Choropleth map | JavaScript Charts | View Examples",
                metaDescription:
                    "Easily create a Choropleth map or High-Low Fill with SciChart - high performance JavaScript Chart Library. Get your free trial now.",
                markdownContent:
