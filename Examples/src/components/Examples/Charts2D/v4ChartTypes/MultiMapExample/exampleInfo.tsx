...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        description: "Demonstrates how to create a **Multi Map Example**",
        tips: [],
        frameworks: {
            javascript: {
                subtitle: "Demonstrates how to create a **Multi Map Example**",
            ...
            react: {
                ...
                pageTitle: "Multi Map Example | JavaScript Charts | View Examples",
                metaDescription:
                    "Easily create a Multi Map Example or High-Low Fill with SciChart - high performance JavaScript Chart Library. Get your free trial now.",
                markdownContent:
            ...
            angular: {
                subtitle:
                    "Demonstrates how to create a **Multi Map Example** or High-Low Fill using SciChart.js, our High Performance JavaScript Chart Framework",
                title: "Multi Map Example",
                pageTitle: "Multi Map Example | JavaScript Charts | View Examples",
                metaDescription:
                    "Easily create a Multi Map Example or High-Low Fill with SciChart - high performance JavaScript Chart Library. Get your free trial now.",
