    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                pageTitle: "JavaScript Scatter Chart",
                metaDescription:
            ...
            react: {
                ...
                markdownContent:
                    "## React Scatter Chart Example\n\n### Overview\nThis example demonstrates how to create a high performance [scatter chart](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/xy-scatter-renderable-series/) within a React application using SciChart.js. It sets up a chart with two distinct scatter series that use custom point markers and animated transitions to enhance data visualization.\n\n### Technical Implementation\nThe chart is created asynchronously by invoking the SciChart.js API via a WASM context for optimized rendering performance. In this example, `NumericAxis` are added to a `SciChartSurface` and two `XyScatterRenderableSeries` are plotted using pointmarkers provided by `EllipsePointMarker` and `TrianglePointMarker` classes. The implementation follows asynchronous programming practices as described in [Creating a SciChart React Component from the Ground Up](https://www.scichart.com/documentation/js/v5/get-started/tutorials-react/tutorial-01-setting-up-project-with-scichart-react/), ensuring efficient initialization and resource management.\n\n### Features and Capabilities\nThe chart offers several advanced features including custom point markers and smooth animations. Each scatter series employs `SweepAnimation` to create animated transitions for the data points, as detailed in the [SweepAnimation Documentation](https://www.scichart.com/documentation/js/v5/2d-charts/animations-api/series-startup-animations/). Interactive modifiers such as `ZoomPanModifier`, `ZoomExtentsModifier`, and `MouseWheelZoomModifier` enable intuitive chart navigation, with further insights provided by the [ZoomPanModifier Documentation](https://www.scichart.com/documentation/js/v5/2d-charts/chart-modifier-api/zooming-and-panning/zoom-pan-modifier/). Additionally, the use of different marker types is aligned with the practices outlined in [Drawing PointMarkers on Series](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/common-series-apis/drawing-point-markers/).\n\n### Integration and Best Practices\nIntegrating SciChart.js into a React application is streamlined by the use of the `<SciChartReact/>` component, which encapsulates and abstracts away the complexities of chart creation. The example demonstrates how to effectively manage component lifecycle and asynchronous operations, while leveraging the WASM context for enhanced performance. Developers are encouraged to explore best practices for React integration and performance optimization as shared in [React Charts with SciChart.js: Introducing “SciChart React”](https://www.scichart.com/blog/react-charts-with-scichart-js/) and [Performance Optimisation of JavaScript Applications & Charts](https://www.scichart.com/blog/performance-optimisation-of-javascript-applications-charts/).",
            },
            angular: {
                subtitle:
                ...
                pageTitle: "Angular Scatter Chart",
                metaDescription:
