    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Digital Mountain Chart in JavaScript\n\n### Overview\nThis example demonstrates how to create a high-performance digital mountain chart using SciChart.js with JavaScript. It renders a stepped-line (digital) mountain series with gradient fills and smooth wave animations, providing an engaging data visualization experience in a WebGL-powered environment.\n\n### Technical Implementation\nThe chart is initialized by creating a `SciChartSurface` using the native JavaScript API, as explained in the [Tutorial 01 - Including SciChart.js in an HTML Page using CDN](https://www.scichart.com/documentation/js/v5/get-started/tutorials-cdn/tutorial-01-using-cdn/) guide. Numeric axes are configured with the `NumericAxis` class and fine-tuned with the `NumberRange` `growBy` property ([NumericAxis API Documentation](https://www.scichart.com/documentation/js/v5/2d-charts/axis-api/axis-types/numeric-axis/)) to ensure proper spacing. A digital mountain series is built using `FastMountainRenderableSeries` with the `isDigitalLine` property set to true, and its visual appeal is enhanced via a gradient fill defined by `GradientParams` ([GradientParams API Documentation](https://www.scichart.com/documentation/js/v5/typedoc/classes/gradientparams.html)). The series also incorporates a [WaveAnimation](https://www.scichart.com/documentation/js/v5/typedoc/classes/waveanimation.html) effect to create dynamic startup animations. Interactive modifiers such as `ZoomExtentsModifier`, `RubberBandXyZoomModifier`, and `MouseWheelZoomModifier` are added to enable intuitive zooming and panning, following guidelines from the [Tutorial 03 - Adding Zooming, Panning Behavior](https://www.scichart.com/documentation/js/v5/get-started/tutorials-js-npm-webpack/tutorial-03-adding-zooming-panning-behavior/) documentation.\n\n### Features and Capabilities\nKey features include real-time data simulation via a random walk generator, digital stepped-line rendering for clear data visualization, and a custom gradient fill that transitions seamlessly to transparency. These enhancements, combined with smooth wave animations, deliver an engaging and high-fidelity charting experience.\n\n### Integration and Best Practices\nThis JavaScript example emphasizes direct instantiation and granular control over chart components without any abstraction layers such as builder APIs. It implements a robust resource management strategy by returning a destructor function to clean up the `SciChartSurface`, which aligns with best practices for performance optimization as described in the [Performance Tips & Tricks](https://www.scichart.com/documentation/js/v5/2d-charts/performance-tips/performance-tips-and-tricks/) guide. This approach facilitates maintainability and efficient resource management in WebGL-based applications.\n",
            },
            react: {
                subtitle:
