export const rawDateValues: number[] = [
...
export const rawOpenValues: number[] = [
...
export const rawHighValues: number[] = [
...
export const rawLowValues: number[] = [
...
export const rawCloseValues: number[] = [
...
// Filter function
const filterWeekends = (timestamps: number[]) => {
    return timestamps
...
// Apply filter to remove weekends
const businessDayIndices = filterWeekends(rawDateValues);

export const dateValues = businessDayIndices.map((i) => rawDateValues[i]);
export const openValues = businessDayIndices.map((i) => rawOpenValues[i]);
export const highValues = businessDayIndices.map((i) => rawHighValues[i]);
export const lowValues = businessDayIndices.map((i) => rawLowValues[i]);
export const closeValues = businessDayIndices.map((i) => rawCloseValues[i]);
