    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                pageTitle: "JavaScript Digital Line Chart",
                metaDescription:
                ...
                markdownContent:
                    "## Digital Line Chart Example in JavaScript\n\n### Overview\nThis example demonstrates how to create a **Digital Line Chart** using SciChart.js in a JavaScript environment. It highlights the process of setting up a high-performance chart that renders a digital (step) line series with interactive capabilities and resource-efficient WebAssembly utilization.\n\n### Technical Implementation\nThe chart is initialized within an asynchronous function that creates a `SciChartSurface` along with its WebAssembly context as described in the [Getting Started with SciChart JS](https://www.scichart.com/getting-started/scichart-javascript/) guide. Numeric axes are configured using the `NumericAxis` class and enhanced with a `growBy` value via a `NumberRange` object to ensure proper padding. The data is generated using a random walk algorithm and plotted using an `XyDataSeries`. The digital line series is implemented by setting the `isDigitalLine` flag to true in a `FastLineRenderableSeries`, and a custom `EllipsePointMarker` is applied to clearly display data points. For more on digital line configuration, refer to the [Digital (Step) Line Series documentation](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/fast-line-digital-renderable-series/).\n\n### Features and Capabilities\nThis example incorporates several advanced features. It utilizes [ScaleAnimation](https://www.scichart.com/documentation/js/v4/2d-charts/animations-api/series-startup-animations) to animate the chart series for a dynamic visual effect and integrates interactive modifiers such as `ZoomPanModifier`, `ZoomExtentsModifier`, and the [MouseWheelZoomModifier](https://www.scichart.com/documentation/js/v4/2d-charts/chart-modifier-api/zooming-and-panning/mouse-wheel-zoom-modifier/) to allow users to zoom and pan seamlessly. The use of WebAssembly enables high-performance rendering, a key aspect in building responsive, real-time applications, as detailed in [WebAssembly performance optimization](https://www.scichart.com/blog/scichart-js-preview-creating-real-time-stock-charts-in-javascript/).\n\n### Integration and Best Practices\nThe integration in a JavaScript setup is designed for ease of use. The initialization function directly creates the chart and returns a cleanup (destructor) function to ensure proper resource disposal, aligning well with the [Memory Best Practices](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/memory-best-practices/). This pattern not only streamlines the process of embedding SciChart.js into web projects but also optimizes performance by leveraging asynchronous initialization patterns as highlighted in the [Tutorial on setting up a project with SciChart.js](https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-01-setting-up-npm-project-with-scichart-js/).",
            },
            react: {
                subtitle:
                ...
                pageTitle: "React Digital Line Chart",
                metaDescription:
            ...
            angular: {
                ...
                pageTitle: "Angular Digital Line Chart",
                metaDescription:
