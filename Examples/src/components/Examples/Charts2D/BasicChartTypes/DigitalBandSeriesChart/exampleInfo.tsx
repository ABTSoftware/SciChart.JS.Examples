    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Digital Band Series Chart - JavaScript\n\n### Overview\nThis example demonstrates how to create a high-performance digital band chart using SciChart.js in JavaScript. The implementation renders a digital band series with upper and lower fill effects, leveraging the capabilities of the [XyyDataSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/xyydataseries.html) to handle X, Y, and Y1 values.\n\n### Technical Implementation\nThe chart is initialized asynchronously using modern async/await patterns to create a `SciChartSurface` and configure numeric axes with [NumericAxis](https://www.scichart.com/documentation/js/v5/2d-charts/axis-api/axis-types/numeric-axis/) in conjunction with a [NumberRange](https://www.scichart.com/documentation/js/v5/typedoc/classes/numericaxis.html) for dynamic growth. The digital band series is constructed using [FastBandRenderableSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/fastbandrenderableseries.html) combined with an `XyyDataSeries`, with the digital styling enabled via the `isDigitalLine` property. A smooth animated transition is achieved using [SweepAnimation](https://www.scichart.com/documentation/js/v5/2d-charts/animations-api/style-transition-animations/). Unlike approaches using a Builder API, this example relies solely on direct JavaScript calls to configure the chart.\n\n### Features and Capabilities\nThe example showcases high-performance rendering of digital band series with customized styling through specific fill and stroke options, using contrasting colors for the high and low sections. It integrates interactive modifiers such as [ZoomPanModifier](https://www.scichart.com/documentation/js/v5/2d-charts/chart-modifier-api/zooming-and-panning/zoom-pan-modifier/), [ZoomExtentsModifier](https://www.scichart.com/documentation/js/v5/2d-charts/chart-modifier-api/zooming-and-panning/zoom-pan-modifier/), and `MouseWheelZoomModifier`, ensuring a responsive user experience with real-time zooming and panning capabilities.\n\n### Integration and Best Practices\nThis JavaScript implementation highlights best practices for chart lifecycle management by asynchronously initializing the `SciChartSurface` and providing a cleanup function for proper disposal. Developers are encouraged to explore additional performance optimizations and integration strategies as detailed in the [Getting Started with SciChart JS](https://www.scichart.com/getting-started/scichart-javascript/) guide. Moreover, the use of asynchronous patterns and modular configuration paves the way for scalable and maintainable charting solutions in production environments.",
            },
            react: {
                subtitle:
                ...
                markdownContent:
                    "## Digital Band Series Chart - React\n\n### Overview\n\nThis example demonstrates how to create a high-performance **Digital Band Series Chart** using SciChart.js within a React application. The chart showcases digital band rendering with high and low fill effects, animated transitions using a sweep animation, and interactive modifiers for zooming and panning.\n\n### Technical Implementation\n\nThe chart is initialized asynchronously through the `<SciChartReact/>` component by providing an `initChart` function. Within this function, a `SciChartSurface` is created along with numeric axes and a specialised data series (XyyDataSeries) that handles X, Y, and Y1 values. The series is configured with properties such as `isDigitalLine` and employs a [SweepAnimation](https://www.scichart.com/documentation/js/v5/2d-charts/animations-api/series-startup-animations/) for smooth animated transitions. Interactive modifiers like `ZoomExtentsModifier`, `ZoomPanModifier`, and `MouseWheelZoomModifier` enhance user interaction with the chart. The asynchronous setup and integration are in line with [React Charts with SciChart.js: Introducing “SciChart React”](https://www.scichart.com/blog/react-charts-with-scichart-js/) guidelines.\n\n### Features and Capabilities\n\nThe example showcases several advanced features including digital band rendering where different styles are applied to the upper and lower sections of the series. It leverages animated rendering and interactive zooming/panning to provide a responsive and dynamic user experience. Detailed configuration of the digital band is demonstrated based on [The Digital (Step) Band Series Type](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/fast-band-digital-renderable-series/) documentation.\n\n### Integration and Best Practices\n\nIntegration with React is achieved by using the `<SciChartReact/>` component, which simplifies the chart lifecycle management. Developers are encouraged to follow best practices for async initialization and resource cleanup as outlined in [Creating a SciChart React Component from the Ground Up](https://www.scichart.com/documentation/js/v5/get-started/tutorials-react/tutorial-01-setting-up-project-with-scichart-react/). The example also adheres to performance optimization techniques by ensuring proper disposal of the `SciChartSurface` when necessary, a crucial aspect covered in the sciChart documentation. Additionally, the implementation and use of interactive chart modifiers reflect common techniques described in [Tutorial 03 - Adding Zooming, Panning Behavior](https://www.scichart.com/documentation/js/v5/get-started/tutorials-js-npm-webpack/tutorial-03-adding-zooming-panning-behavior/).",
            },
            angular: {
                subtitle:
...
const digitalBandSeriesChartExampleInfo = createExampleInfo(metaData);
export default digitalBandSeriesChartExampleInfo;
