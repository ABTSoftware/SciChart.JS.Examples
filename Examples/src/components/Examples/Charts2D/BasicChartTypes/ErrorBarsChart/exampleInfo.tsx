    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## JavaScript Error Bars Chart\n\n### Overview\nThis example demonstrates how to create a high performance **JavaScript Error Bars Chart** using SciChart.js in JavaScript. It visualizes data uncertainty with both vertical and horizontal error bars, providing developers with a clear method to represent statistical confidence and variability in data points.\n\n### Technical Implementation\nThe chart is initialized by creating a `SciChartSurface` with a WebAssembly context using the [SciChartSurface.create](https://www.scichart.com/documentation/js/v4/2d-charts/surface/new-scichart-surface/#scichartsurfacecreate) method. Axes are set up using the `NumericAxis` class with customized `growBy` settings to ensure proper spacing. Error bars are rendered using the `FastErrorBarsRenderableSeries`, which uses an `HlcDataSeries` to provide absolute error values. This approach follows best practices as outlined in [The Error Bars Chart](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/fast-error-bars-renderable-series/) documentation. Additionally, a `SplineMountainRenderableSeries` with a gradient fill and scale animations (detailed in the [Spline (Smoothed) Mountain Series Type](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/spline-mountain-renderable-series/)) is implemented to add visual context and improve aesthetic appeal.\n\n### Features and Capabilities\nKey features of this implementation include dual error bars for both horizontal and vertical directions, smooth scale animations, and high performance rendering through WebGL. The example leverages interactive chart modifiers such as zooming and panning to offer users a dynamic and responsive experience. The integration of custom point markers further enhances the visualization, making it easier to identify specific data points.\n\n### Integration and Best Practices\nBuilt using JavaScript, this example emphasizes clean initialization and resource management. The chart is created within a dedicated function that returns a cleanup method to correctly dispose of the SciChartSurface, aligning with the guidelines found in [Memory Best Practices](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/memory-best-practices/). This approach ensures that applications maintain optimal performance and prevent memory leaks. Developers are encouraged to explore the linked documentation for further details on initializing WebAssembly contexts, configuring numeric axes, and optimizing interactive chart performance.",
            },
            react: {
                subtitle:
