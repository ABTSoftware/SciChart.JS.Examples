...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        id: "chart2D_basicCharts_PolarMapExample",
        imagePath: "javascript-polar-map-demo.jpg",
        description:
            "Demonstrates how to create a **Polar Map Example**",
        tips: [],
        frameworks: {
            javascript: {
                subtitle:
            ...
            react: {
                ...
                pageTitle: "Polar Map Example | JavaScript Charts | View Examples",
                metaDescription:
                    "Easily create a Polar Map Example or High-Low Fill with SciChart - high performance JavaScript Chart Library. Get your free trial now.",
                markdownContent:
            ...
            angular: {
                subtitle:
                    "Demonstrates how to create a **Polar Map Example** or High-Low Fill using SciChart.js, our High Performance JavaScript Chart Framework",
                title: "Polar Map Example",
                pageTitle: "Polar Map Example | JavaScript Charts | View Examples",
                metaDescription:
                    "Easily create a Polar Map Example or High-Low Fill with SciChart - high performance JavaScript Chart Library. Get your free trial now.",
        ...
        onWebsite: true,
        filepath: "Charts2D/BasicChartTypes/PolarMapExample",
