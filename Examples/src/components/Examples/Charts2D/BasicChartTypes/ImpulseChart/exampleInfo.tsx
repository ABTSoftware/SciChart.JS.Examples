    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Impulse Chart - JavaScript\n\n### Overview\nThis example demonstrates how to create a high-performance **Impulse Chart** using SciChart.js with JavaScript. The implementation renders a lollipop or stem chart by calculating dynamic data points and leveraging a modern WebGL and WASM-based rendering engine.\n\n### Technical Implementation\nThe chart is asynchronously initialized using `SciChartSurface.create()`, which sets up a WebGL-powered WASM context for optimal rendering performance. For detailed guidance on this initialization process, see the [Creating a new SciChartSurface and loading Wasm](https://www.scichart.com/documentation/js/v5/2d-charts/surface/new-scichart-surface/) documentation. `NumericAxis` are configured via the constructor options, and custom data series are populated using `XyDataSeries`. The `FastImpulseRenderableSeries` is used to render the impulse chart with a built-in wave animation effect, as described in the [Animations API](https://www.scichart.com/documentation/js/v5/2d-charts/animations-api/animations-api-overview/).\n\n### Features and Capabilities\nThis implementation includes interactive features such as panning and zooming through the use of `ZoomPanModifier`, `ZoomExtentsModifier`, and `MouseWheelZoomModifier`, enhancing user interaction with the chart. These interactive functionalities support real-time updates and dynamic customizations, ensuring that users can seamlessly explore the data. For more insights on interactive chart modifiers, refer to the [Adding Zooming, Panning Behavior](https://www.scichart.com/documentation/js/v5/get-started/tutorials-js-npm-webpack/tutorial-03-adding-zooming-panning-behavior/) tutorial.\n\n### Integration and Best Practices\nThe JavaScript implementation emphasizes efficient resource management. A dedicated cleanup function is provided which deletes the chart instance when it is no longer needed, following best practices outlined in the [Memory Best Practices | JavaScript Chart Documentation - SciChart](https://www.scichart.com/documentation/js/v5/2d-charts/performance-tips/memory-best-practices/). This approach ensures that memory is managed appropriately and resources are freed up promptly, maintaining optimal application performance.",
            },
            react: {
                subtitle:
