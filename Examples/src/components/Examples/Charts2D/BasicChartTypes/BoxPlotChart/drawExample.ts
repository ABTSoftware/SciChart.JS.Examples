...
export const drawExample = async (rootElement: string | HTMLDivElement) => {
    ...
    sub1.xAxes.add(new CategoryAxis(wasmContext, { 
        ...CATEGORY_AXIS_OPTIONS,
        labels: ["P1", "P2", "P3"], 
        axisAlignment: EAxisAlignment.Left,
    }));
    sub1.yAxes.add(new NumericAxis(wasmContext, {
    ...
    sub2.xAxes.add(new CategoryAxis(wasmContext, { 
        labels: ["Box1", "Box2", "Box3", "Box4", "Box5"],
        ...CATEGORY_AXIS_OPTIONS 
    }));
    sub2.yAxes.add(new NumericAxis(wasmContext, {
        ...NUMERIC_AXIS_OPTIONS,
    }));
    ...
    sub3.xAxes.add(new CategoryAxis(wasmContext, { 
        labels: ["A", "B", "C"], 
        ...CATEGORY_AXIS_OPTIONS 
    }));
    sub3.yAxes.add(new NumericAxis(wasmContext, {
        ...NUMERIC_AXIS_OPTIONS,
    }));
    ...
    sub4.xAxes.add(new CategoryAxis(wasmContext, { 
        ...CATEGORY_AXIS_OPTIONS,
        labels: ["1st", "2nd", "3rd", "4th"], 
        axisAlignment: EAxisAlignment.Left,
        flippedCoordinates: true,
    }));
    sub4.yAxes.add(new NumericAxis(wasmContext, {
        ...NUMERIC_AXIS_OPTIONS,
        axisAlignment: EAxisAlignment.Bottom,
        flippedCoordinates: true,
    }));
