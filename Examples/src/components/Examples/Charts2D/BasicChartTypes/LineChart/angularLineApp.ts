...
<div style="aspect-ratio: 3/2">
    <div class="flexOuterContainer">
        ...
        <div class="flexContainerRow">
            ...
            <div class="item"><scichart-angular [initChart]="initThresholdedLineCharts"></scichart-angular></div>
        </div>
    </div>
</div>`,
...
export class AppLineChartComponent {
    ...
    public initJustLineCharts: (rootElement: string | HTMLDivElement) => Promise<{ sciChartSurface: SciChartSurface; wasmContext: TSciChart; }>;
    public initDigitalLineCharts: (rootElement: string | HTMLDivElement) => Promise<{ sciChartSurface: SciChartSurface; wasmContext: TSciChart; }>;
    public initTooltipsOnLineCharts: (rootElement: string | HTMLDivElement) => Promise<{ sciChartSurface: SciChartSurface; wasmContext: TSciChart; }>;
    public initDashedLineCharts: (rootElement: string | HTMLDivElement) => Promise<{ sciChartSurface: SciChartSurface; wasmContext: TSciChart; }>;
    public initPalettedLineCharts: (rootElement: string | HTMLDivElement) => Promise<{ sciChartSurface: SciChartSurface; wasmContext: TSciChart; }>;
    public initHoveredLineCharts: (rootElement: string | HTMLDivElement) => Promise<{ sciChartSurface: SciChartSurface; wasmContext: TSciChart; }>;
    public initGapsInLineCharts: (rootElement: string | HTMLDivElement) => Promise<{ sciChartSurface: SciChartSurface; wasmContext: TSciChart; }>;
    public initVerticalLineCharts: (rootElement: string | HTMLDivElement) => Promise<{ sciChartSurface: SciChartSurface; wasmContext: TSciChart; }>;
    public initThresholdedLineCharts: (rootElement: string | HTMLDivElement) => Promise<{ sciChartSurface: SciChartSurface; wasmContext: TSciChart; }>;
