    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Smooth Stacked Mountain Chart Example using JavaScript\n\n### Overview\nThis example demonstrates how to create a high performance and interactive **Smooth Stacked Mountain Chart** using SciChart.js in a JavaScript environment. The chart showcases multiple smooth stacked mountain series with dynamic, randomized data, offering animated transitions and rich interactivity through various modifiers.\n\n### Technical Implementation\nThe chart is initialized asynchronously via [SciChartSurface.create()](https://www.scichart.com/documentation/js/v5/2d-charts/surface/new-scichart-surface/), ensuring efficient bootstrapping of the WebGL-based rendering engine. A `StackedMountainCollection` groups several `SmoothStackedMountainRenderableSeries`, each configured with randomized Y values and animated using [ScaleAnimation](https://www.scichart.com/documentation/js/v5/2d-charts/animations-api/style-transition-animations/) to achieve smooth state transitions. The series subscribe to visibility change events using the [Series isVisible and isVisibleChanged API](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/common-series-apis/is-visible/) for real-time updates.\n\n### Features and Capabilities\nThe implementation builds upon several advanced features:\n\n- The use of [StackedMountainCollection](https://www.scichart.com/documentation/js/v5/typedoc/classes/stackedmountaincollection.html) allows for effective stacking of multiple series to form a combined visual representation.\n- Animated transitions ensure changes in series visibility and data updates are smooth and visually appealing through the application of [ScaleAnimation](https://www.scichart.com/documentation/js/v5/2d-charts/animations-api/style-transition-animations/).\n- Interactive modifiers such as `ZoomExtentsModifier`, `ZoomPanModifier`, and `MouseWheelZoomModifier` offer enhanced user control over zooming and panning, making the chart highly responsive to user inputs.\n\n### Integration and Best Practices\nThe example leverages best practices for JavaScript integration by isolating the chart initialization logic and utilizing asynchronous loading for optimal performance. Developers are encouraged to explore the [ZoomPanModifier](https://www.scichart.com/documentation/js/v5/2d-charts/chart-modifier-api/zooming-and-panning/zoom-pan-modifier/) for customizing interactivity and to follow [performance optimization tips](https://www.scichart.com/documentation/js/v5/2d-charts/performance-tips/performance-tips-and-tricks/) available in SciChart.js documentation when managing multiple animated series. This approach ensures that charts remain responsive and maintain high performance even under complex rendering scenarios.",
            },
            react: {
                subtitle:
