    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## JavaScript Pie Chart Example (JavaScript)\n\n### Overview\nThis example demonstrates how to create a high performance, **animated pie chart** using SciChart.js with JavaScript. The implementation transforms a raw dataset into individual pie segments with dynamic gradient fills and adjustable segment radii, making it ideal for visualizing data such as market share statistics.\n\n### Technical Implementation\nThe core of the example is the asynchronous initialization of the chart using the `SciChartPieSurface`, which is created by calling an async function that returns a promise. This pattern, detailed in tutorials like [Including SciChart.js in an HTML Page using CDN](https://www.scichart.com/documentation/js/v4/get-started/tutorials-cdn/tutorial-01-using-cdn/), ensures that the WebGL context is fully ready before the chart is rendered. Additionally, the example leverages the `GradientParams` class to apply smooth gradient fills to each pie segment as shown in [The Pie Chart Type Documentation](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/pie-chart-type/). Data transformation is handled by mapping raw dataset values into `PieSegment` instances (see [PieSegment API Documentation](https://www.scichart.com/documentation/js/v4/typedoc/classes/piesegment.html)) with conditional label rendering based on segment values.\n\n### Features and Capabilities\nThis pie chart supports animated transitions for both the chart segments and the legend. The legend is configured for horizontal orientation and placed at the bottom left to optimize the display area. The implementation also demonstrates advanced visual customization through dynamic gradient fills and relative radius adjustments for each segment, providing an engaging and informative user experience. Furthermore, the chart is optimized for performance by leveraging WebGL rendering for smooth animations and efficient resource usage.\n\n### Integration and Best Practices\nDesigned for a JavaScript environment, the example follows modern asynchronous patterns and includes a cleanup mechanism that calls the `delete()` method on the `SciChartPieSurface`, ensuring proper disposal of WebGL resources. This approach aligns with recommended best practices for resource management as outlined in [Deleting DataSeries Memory](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/data-series-api/deleting-memory/). Developers can further refine their implementations by studying these techniques and integrating similar patterns in their projects, ensuring robust and maintainable charting applications.",
            },
            react: {
                subtitle:
            ...
            angular: {
                ...
                markdownContent:
                    "## Angular Pie Chart Example\n\n### Overview\nThis example demonstrates how to create a high performance Angular [Pie Chart](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/pie-chart-type/) using SciChart.js in an Angular application. The example visualizes market share data of mobile phone manufacturers for 2022 and focuses on delivering an animated, responsive pie chart with advanced styling options such as gradient fills and dynamically adjusted segment radii.\n\n### Technical Implementation\nThe chart is initialized asynchronously using a callback pattern within the `ScichartAngularComponent`. This is provided by the [scichart-angular](https://www.npmjs.com/package/scichart-angular) package. An asynchronous initialization approach, detailed in [Creating a SciChart React Component from the Ground Up](https://www.scichart.com/documentation/js/v4/get-started/tutorials-react/tutorial-01-setting-up-project-with-scichart-react/), ensures that the chart is properly rendered once the underlying webgl context is ready. The example leverages the `SciChartPieSurface` to configure properties such as animation, legend layout, series spacing, and gradient colors for each `PieSegment`.\n\n### Features and Capabilities\nThe example showcases several advanced features including animated transitions, customizable gradient fills using linear gradients, and relative radius adjustments per segment. Each pie segment is constructed programmatically from a dataset to highlight the flexibility in handling real-world data. The chart also includes interactive elements like legends with configurable orientation and placement, enhancing the overall user experience.\n\n### Integration and Best Practices\nThis example exemplifies best practices for integrating SciChart.js with Angular. It uses the `ScichartAngularComponent` for seamless integration of asynchronous chart initialization to Angular and relies on callback functions to manage the chart lifecycle. Resource cleanup is handled elegantly to ensure optimal performance and stability over time. Developers looking to further optimize their projects can refer to the [Getting Started with SciChart.js](https://www.scichart.com/getting-started/scichart-javascript/) for more guidance on initializing a Pie Chart using SciChart.js and Angular.\n",
            },
        },
        documentationLinks: [
            {
                href: "https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/pie-chart-type/",
