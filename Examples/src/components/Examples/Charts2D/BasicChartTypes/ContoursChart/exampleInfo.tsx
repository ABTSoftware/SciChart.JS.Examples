    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "# Contours Chart Example - Vanilla JavaScript\n\n## Overview\nThis example demonstrates how to create an interactive **heatmap chart with contours** using SciChart.js in vanilla JavaScript. It renders a vivid heatmap background combined with overlaid contour lines, providing a powerful visualization tool for data analysis.\n\n## Technical Implementation\nThe chart is initialized asynchronously using async/await, ensuring a smooth startup process. For more information on asynchronous initialization in JavaScript, refer to [Async and Await in Vanilla JavaScript](https://dev.to/this-is-learning/async-and-await-in-vanilla-javascript-2mep) and [How to use async and await with vanilla JavaScript](https://gomakethings.com/how-to-use-async-and-await-with-vanilla-javascript/). The implementation sets up hidden numeric X and Y axes and creates a data series using a custom generator. Two main renderable series are used: the **UniformHeatmapRenderableSeries** for the heatmap and the **UniformContoursRenderableSeries** for the contours. Detailed information about the heatmap series can be found in the [UniformHeatmapRenderableSeries API](https://www.scichart.com/documentation/js/current/typedoc/classes/uniformheatmaprenderableseries.html).\n\n## Features and Capabilities\nThe example supports advanced interactive features. Chart navigation is enhanced with modifiers such as **ZoomPanModifier**, **ZoomExtentsModifier**, and **MouseWheelZoomModifier**; further details are available in the [Tutorial 03 - Adding Zooming, Panning Behavior](https://www.scichart.com/documentation/js/current/Tutorial%2003%20-%20Adding%20Zooming,%20Panning%20Behavior.html). Additionally, a dynamic color mapping is applied via the **HeatmapColorMap** with multiple gradient stops, and the layered rendering of heatmap and contour series creates a comprehensive visualization platform.\n\n## Integration and Best Practices\nThe implementation follows best practices by separating data generation from rendering logic, which promotes maintainability and scalability. The use of WebGL rendering in SciChart.js guarantees high performance, as described in the [Advanced JavaScript Chart and Graph Library | SciChart JS](https://www.scichart.com/javascript-chart-features/). This example, built purely with vanilla JavaScript, serves as a solid foundation for developers looking to create high-performance, interactive charts without relying on additional frameworks.",
            },
            react: {
                subtitle:
            ...
            angular: {
                ...
                markdownContent:
                    "# Angular Heatmap Chart With Contours\n\n## Overview\nThis Angular example demonstrates how to render an interactive heatmap chart overlaid with contour lines using SciChart.js. The implementation leverages the scichart-angular package to integrate the chart into a standalone Angular component, ensuring a seamless integration within Angular applications.\n\n## Technical Implementation\nThe chart is initialized asynchronously using the async/await pattern as shown in the example. The SciChartSurface is created with hidden numeric X and Y axes, and a custom data generator produces the heatmap values. Two renderable series are used: one for the contour layer implemented with the UniformContoursRenderableSeries and another for the background heatmap provided by the UniformHeatmapRenderableSeries. Detailed documentation for these series can be found in the [UniformHeatmapRenderableSeries API](https://www.scichart.com/documentation/js/current/typedoc/classes/uniformheatmaprenderableseries.html). Chart interactions are enhanced by integrating modifiers such as ZoomPanModifier, ZoomExtentsModifier, and MouseWheelZoomModifier as described in the [Tutorial 03 - Adding Zooming, Panning Behavior](https://www.scichart.com/documentation/js/current/Tutorial%2003%20-%20Adding%20Zooming,%20Panning%20Behavior.html).\n\n## Features and Capabilities\nThe example showcases real-time interactive features including seamless panning and zooming while rendering detailed heatmap and contour overlays. Customization options such as adjustable color maps, opacity settings, and precise stroke definitions enable advanced data visualization and analysis. Developers can easily update the configuration to handle dynamic data sets, ensuring robust visualization performance.\n\n## Integration and Best Practices\nThe Angular integration is achieved using standalone component bindings from the scichart-angular package; more details can be found in the [scichart-angular - Yarn](https://classic.yarnpkg.com/en/package/scichart-angular) documentation and Angular binding guides. Efficient asynchronous initialization and modular design separate chart rendering logic from the Angular component, thereby enhancing maintainability and scalability. Additional chart elements like the HeatmapLegend are configured independently to further enrich the user experience, as explained in the [HeatmapLegend API Documentation](https://www.scichart.com/documentation/js/current/typedoc/classes/heatmaplegend.html).",
            },
        },
        documentationLinks: [
            {
