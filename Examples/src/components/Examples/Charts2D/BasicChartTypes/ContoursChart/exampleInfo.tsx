    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                subtitle:
                    "Our Contours Chart example demonstrates how to create a **JavaScript Contour-map Chart** using our powerful JavaScript Chart Library.",
                title: "JavaScript Heatmap Chart With Contours Example",
                pageTitle: "JavaScript Heatmap Chart With Contours",
                metaDescription:
            ...
            angular: {
                ...
                title: "Angular Heatmap Chart With Contours Example",
                pageTitle: "Angular Heatmap Chart With Contours",
                metaDescription:
                ...
                markdownContent:
                    "## Angular Heatmap Chart With Contours\n\n### Overview\nThis Angular example demonstrates how to render an interactive heatmap chart overlaid with contour lines using SciChart.js. The implementation leverages the scichart-angular package to integrate the chart into a standalone Angular component, ensuring a seamless integration within Angular applications.\n\n### Technical Implementation\nThe chart is initialized asynchronously using the async/await pattern as shown in the example. The `SciChartSurface` is created with hidden numeric X and Y axes, and a custom data generator produces the heatmap values. Two renderable series are used: one for the contour layer implemented with the `UniformContoursRenderableSeries` and another for the background heatmap provided by the `UniformHeatmapRenderableSeries`. Detailed documentation for these series can be found in the [Contours Series documentation](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/uniform-contours-renderable-series/). Chart interactions are enhanced by integrating modifiers such as `ZoomPanModifier`, `ZoomExtentsModifier`, and `MouseWheelZoomModifier` as described in the [Tutorial 03 - Adding Zooming, Panning Behavior](https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-03-adding-zooming-panning-behavior/).\n\n### Features and Capabilities\nThe example showcases real-time interactive features including seamless panning and zooming while rendering detailed heatmap and contour overlays. Customization options such as adjustable color maps, opacity settings, and precise stroke definitions enable advanced data visualization and analysis. Developers can easily update the configuration to handle dynamic data sets, ensuring robust visualization performance.\n\n### Integration and Best Practices\nThe Angular integration is achieved using standalone component bindings from the scichart-angular package; more details can be found in the [scichart-angular](https://www.npmjs.com/package/scichart-angular) npm page and Angular binding guides. Efficient asynchronous initialization and modular design separate chart rendering logic from the Angular component, thereby enhancing maintainability and scalability. Additional chart elements like the HeatmapLegend are configured independently to further enrich the user experience, as explained in the [HeatmapLegend API Documentation](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/uniform-heatmap-renderable-series/color-maps-and-legends/).",
            },
        },
        documentationLinks: [
            {
                href: "https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/uniform-contours-renderable-series/",
