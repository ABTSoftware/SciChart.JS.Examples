...
import { metaData } from "./MountainChartMetadata";
...
export const oldmountainChartExampleInfo: TExampleInfo = {
    onWebsite: true,
...
export const mountainChartExampleInfo = createExampleInfo(metaData as IExampleMetadata);
