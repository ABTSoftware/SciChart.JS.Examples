    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## JavaScript Spline Mountain Chart\n\n### Overview\nThis example demonstrates how to create a high-performance **Spline Mountain Chart** using JavaScript and SciChart.js. The chart is initialized asynchronously and leverages modern WebAssembly techniques to deliver smooth interpolation, dynamic gradient fills, and interactive modifiers for an engaging data visualization experience.\n\n### Technical Implementation\nThe chart is created by asynchronously initializing a `SciChartSurface` from a WebAssembly context, following techniques outlined in the [Getting Started with SciChart JS](https://www.scichart.com/getting-started/scichart-javascript/) guide. A `SplineMountainRenderableSeries` is then configured with an associated `XyDataSeries` and 20 interpolation points, ensuring a smooth curve as detailed in [The Spline (Smoothed) Mountain Series Type](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/spline-mountain-renderable-series/). The series utilizes a gradient fill set up with [GradientParams](https://www.scichart.com/documentation/js/v4/typedoc/classes/gradientparams.html) and incorporates an animated wave effect via the `WaveAnimation` API for visual appeal. Interactive modifiers such as `ZoomExtentsModifier`, `RubberBandXyZoomModifier`, and `MouseWheelZoomModifier` are added to enable intuitive zooming and panning, as described in the [Tutorial 03 - Adding Zooming, Panning Behavior](https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-03-adding-zooming-panning-behavior/) documentation.\n\n### Features and Capabilities\nThe example provides real-time chart rendering with advanced customizations. It employs a smooth spline interpolation technique and utilizes an `EllipsePointMarker` for clear data point visualization, as documented in the [PointMarkers API](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/common-series-apis/drawing-point-markers/) documentation. The inclusion of a `WaveAnimation` adds dynamic visual transitions, enhancing the overall user experience. Additionally, the use of WebAssembly technology helps achieve optimal performance, which is further explained in [Surpassing the limits of JavaScript for Charting with WebAssembly](https://www.scichart.com/blog/surpassing-limits-javascript-bigdata-webassembly/).\n\n### Integration and Best Practices\nDesigned exclusively for JavaScript, this implementation follows best practices for asynchronous initialization and resource cleanup. Developers can easily integrate this pattern by targeting a root HTML element and disposing of the `SciChartSurface` when necessary, in line with recommendations from the [Memory Best Practices](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/memory-best-practices/) guide. This clear and concise approach ensures efficient memory management and sets out a scalable path for further enhancements in high-performance charting solutions.",
            },
            react: {
                subtitle:
