    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                pageTitle: "JavaScript Spline Line Chart",
                metaDescription:
                ...
                markdownContent:
                    "## JavaScript Spline Line Chart\n\n### Overview\nThis example demonstrates how to implement a high-performance spline line chart using SciChart.js in a pure JavaScript environment. The chart displays three distinct series: a `FastLineRenderableSeries` for original data, a `SplineLineRenderableSeries` with smooth interpolation, and an advanced Bezier-transformed series using `BezierRenderDataTransform` with interactive curvature adjustments.\n\n### Technical Implementation\nThe implementation begins by initializing a `SciChartSurface` via an asynchronous factory method, as detailed in the [Getting Started with SciChart JS](https://www.scichart.com/getting-started/scichart-javascript/) guide. `NumericAxis` are added, with axis scaling managed through properties such as `growBy`; further specifics are available in the [NumericAxis API Documentation](https://www.scichart.com/documentation/js/v5/2d-charts/axis-api/axis-types/numeric-axis/). Data is provided to the chart using `XyDataSeries` structures, and series animations are implemented via [WaveAnimation](https://www.scichart.com/documentation/js/v5/typedoc/classes/waveanimation.html) to achieve dynamic transitions. The example further enhances the visual output by using the `SplineLineRenderableSeries` with adjustable interpolation points for smooth curve rendering and employs a Bezier render data transform, which allows for runtime adjustments of the smoothing curvature through interactive axis marker annotations—more details can be found in the [Spline Line Chart Documentation](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/spline-line-renderable-series/).\n\n### Features and Capabilities\nThis example not only illustrates real-time data updates and animated transitions but also demonstrates advanced customization capabilities. Interactive modifiers such as `ZoomPanModifier` and `MouseWheelZoomModifier` are integrated to enhance user experience, with additional insights available in the [ZoomPanModifier API Documentation](https://www.scichart.com/documentation/js/v5/2d-charts/chart-modifier-api/zooming-and-panning/zoom-pan-modifier/). Custom point markers, created using the `EllipsePointMarker` class, add clarity to data points while maintaining consistent visual styling.\n\n### Integration and Best Practices\nFollowing best practices, the chart’s resources are properly managed by disposing of the `SciChartSurface` with its `delete()` method, ensuring efficient WebGL context management and avoiding memory leaks; these strategies are outlined in the [Memory Best Practices](https://www.scichart.com/documentation/js/v5/2d-charts/performance-tips/memory-best-practices/) documentation. This JavaScript implementation serves as a robust example of how to integrate SciChart.js into a project while leveraging its advanced charting features and interactive capabilities for a seamless data visualization experience.\n",
            },
            react: {
                subtitle:
                ...
                pageTitle: "React Spline Line Chart",
                metaDescription:
            ...
            angular: {
                ...
                pageTitle: "Angular Spline Line Chart",
                metaDescription:
