...
const metaData: IExampleMetadata = {
    ...
    frameworks: {
        ...
        angular: {
            subtitle:
                "Demonstrates a Angular Parallel Coordinate Plot, which visualises multivariate data as polylines crossing one vertical axis per dimension. Switch between a multi-series chart and a single-series chart of 100,000 records.",
            title: "Angular Parallel Coordinate Plot",
            pageTitle: "Angular Parallel Coordinate Plot | SciChart.js Demo",
            metaDescription:
                "Create a high performance Angular Parallel Coordinate Plot with SciChart.js. Visualise multivariate data with one axis per dimension, reorder axes, highlight ranges and select records, with up to 100,000 records on screen.",
