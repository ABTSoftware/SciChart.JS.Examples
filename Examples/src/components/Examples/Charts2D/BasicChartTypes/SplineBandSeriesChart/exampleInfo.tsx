    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                pageTitle: "JavaScript Spline Band Chart",
                metaDescription:
            ...
            react: {
                ...
                pageTitle: "React Spline Band Chart",
                metaDescription:
            ...
            angular: {
                ...
                pageTitle: "Angular Spline Band Chart",
                metaDescription:
                ...
                markdownContent:
                    "## Angular Spline Band Series Chart Example\n\n### Overview\nThis example demonstrates how to create an **Angular Spline Band Chart** using SciChart.js. The chart visualizes two spline band series with high-low fills and smooth interpolations, leveraging advanced features such as real-time interactive annotations and multiple Y-axes. The sample is built as an Angular standalone component and utilizes the [scichart-angular](https://www.npmjs.com/package/scichart-angular) integration, ensuring seamless embedding of SciChart within an Angular application.\n\n### Technical Implementation\nThe chart is initialized asynchronously by calling the `SciChartSurface.create()` method, which is integrated within an Angular component. This pattern follows asynchronous initialization best practices, as described in the [Getting Started with SciChart JS](https://www.scichart.com/getting-started/scichart-javascript/) documentation. The example sets up two `NumericAxis` (one on the left and a secondary axis on the right) and populates data using the `XyyDataSeries` to represent two datasets for the spline band. A `SplineBandRenderableSeries` is configured with custom styling for strokes, fills, and point markers, and enhanced with a `ScaleAnimation` to provide smooth render transitions. Additionally, a `XyyBezierRenderDataTransform` is applied to one of the series to perform smooth spline interpolation with adjustable curvature, as referenced in the [XyyBezierRenderDataTransform](https://www.scichart.com/documentation/js/v5/typedoc/classes/xyybezierrenderdatatransform.html) documentation.\n\n### Features and Capabilities\nThe example showcases several key features including the ability to update chart parameters in real time. An interactive `AxisMarkerAnnotation` is implemented, allowing users to adjust the Bezier curvature dynamically. Furthermore, interactive modifiers such as `YAxisDragModifier` and `MouseWheelZoomModifier` enable intuitive mouse-based interactions, enhancing the user experience. Multiple Y-axes are configured with distinct visual styles, allowing users to compare different data ranges side-by-side; additional technical details can be found in the [Tutorial 08 - Adding Multiple Axis](https://www.scichart.com/documentation/js/v5/get-started/tutorials-js-npm-webpack/tutorial-08-adding-multiple-axis/) guide.\n\n### Integration and Best Practices\nThe integration is designed following Angular best practices by implementing a standalone component which encapsulates the SciChart setup. Efficient performance optimization is achieved through asynchronous resource loading and careful memory management, as recommended in the [Memory Best Practices | JavaScript Chart Documentation](https://www.scichart.com/documentation/js/v5/2d-charts/performance-tips/memory-best-practices/). Developers can further explore interactive chart modifications and custom theming—such as configuring interpolation points and applying custom fill and stroke styles—to create highly responsive and visually appealing charts. The use of [interactive modifiers](https://www.scichart.com/documentation/js/v5/2d-charts/chart-modifier-api/zooming-and-panning/mouse-wheel-zoom-modifier/) and [smooth animations](https://www.scichart.com/documentation/js/v5/2d-charts/animations-api/series-startup-animations/) illustrates the powerful capabilities provided by SciChart.js when integrated with Angular.\n",
            },
        },
        documentationLinks: [
            {
                href: "https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/spline-band-renderable-series/",
