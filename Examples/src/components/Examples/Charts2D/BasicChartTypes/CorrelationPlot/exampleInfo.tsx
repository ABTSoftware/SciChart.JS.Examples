...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        id: "chart2D_basicCharts_CorrelationPlot",
        imagePath: "javascript-correlation-plot.jpg",
        description:
            "We have created an example that demonstrates how to create a **JavaScript Correlation Plot** using SciChart.js",
        tips: [],
        frameworks: {
            javascript: {
                subtitle:
        ...
        onWebsite: true,
        filepath: "Charts2D/BasicChartTypes/CorrelationPlot",
