...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        id: "chart2D_basicCharts_TreemapChart",
        imagePath: "javascript-treemap-chart.jpg",
        description:
            "Creates a **JavaScript Treemap Chart** using SciChart.js, with the following features: DataLabels, Rounded corners, Gradient-palette fill, startup animations.",
        tips: [],
        frameworks: {
            javascript: {
                subtitle:
        ...
        onWebsite: true,
        filepath: "Charts2D/BasicChartTypes/TreemapChart",
