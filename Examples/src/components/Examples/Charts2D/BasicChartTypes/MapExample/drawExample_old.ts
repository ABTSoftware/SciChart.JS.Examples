...
import australiaJson from "./australian-states.json";
...
// australiaJson.features.forEach((state, i) => {
...
// //newSouthWales
// const newSouthWales = australiaJson.features[0].geometry.coordinates[0];

// newSouthWales.pop(); // remove one element because geojson repeats first point as last

// let newSouthWalesData = constrainedDelaunayTriangulation(newSouthWales).flat();

// //victoria
// const victoria = australiaJson.features[1].geometry.coordinates[0];

// victoria.pop();

// let victoriaData = constrainedDelaunayTriangulation(victoria).flat();

// //Queensland - "MultiPolygon"
// const queensland = australiaJson.features[2].geometry.coordinates[0][0];

// queensland.pop();

// let queenslandData = constrainedDelaunayTriangulation(queensland).flat();
...
export const drawExample = async (rootElement: string | HTMLDivElement) => {
    ...
    australiaJson.features.forEach((state, i) => {
        ...
        if (state.geometry.type === "Polygon") {
            ...
            console.log("MultiPolygon");
            let area = state.geometry.coordinates[0][0];
            area.pop();
            let areaData = constrainedDelaunayTriangulation(area).flat();
    ...
    const colors = ["#ffffd9", "#edf8ba", "#cdebb4", "#97d7b9", "#5dc0c0", "#32a5c2", "#217fb7", "#2255a4", "#1e3489"]
    ...
    // // newSouthWales
    // const dataSeriesnewSouthWales = new XyDataSeries(wasmContext, {
    //     xValues: newSouthWalesData.map((p) => p[0]),
    //     yValues: newSouthWalesData.map((p) => p[1]),
    // });

    // const triangleSeriesnewSouthWales = new TriangleRenderableSeries(wasmContext, {
    //     dataSeries: dataSeriesnewSouthWales,
    //     drawMode: ETriangleSeriesDrawMode.List,
    //     fill: "brown",
    //     opacity: 0.5,
    // });
    ...
    // // Victoria
    // const dataSeriesVictoria = new XyDataSeries(wasmContext, {
    //     xValues: victoriaData.map((p) => p[0]),
    //     yValues: victoriaData.map((p) => p[1]),
    // });

    // const triangleSeriesVictoria = new TriangleRenderableSeries(wasmContext, {
    //     dataSeries: dataSeriesVictoria,
    //     drawMode: ETriangleSeriesDrawMode.List,
    //     fill: "green",
    //     opacity: 0.5,
    // });
    ...
    // // Queensland
    // const dataSeriesQueensland = new XyDataSeries(wasmContext, {
    //     xValues: queenslandData.map((p) => p[0]),
    //     yValues: queenslandData.map((p) => p[1]),
    // });

    // const triangleSeriesQueensland = new TriangleRenderableSeries(wasmContext, {
    //     dataSeries: dataSeriesQueensland,
    //     drawMode: ETriangleSeriesDrawMode.List,
    //     fill: "orange",
    //     opacity: 0.5,
    // });
    ...
    // sciChartSurface.renderableSeries.add(triangleSeriesnewSouthWales);
    // sciChartSurface.renderableSeries.add(triangleSeriesVictoria);
    // sciChartSurface.renderableSeries.add(triangleSeriesQueensland);
