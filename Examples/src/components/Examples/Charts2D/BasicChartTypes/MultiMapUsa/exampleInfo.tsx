...
const metaData: IExampleMetadata =
    ...
    {
        reactComponent: "MultiMapUsa",
        id: "chart2D_basicCharts_MultiMapUsa",
        imagePath: "multi-map-usa.jpg",
        description:
            "Demonstrates how to create a **Multi Map USA Example**",
        tips: [],
        frameworks: {
            javascript: {
                subtitle:
                    "Demonstrates how to create a **Multi Map USA Example**",
                title: "Multi Map USA Example",
                pageTitle: "Multi Map USA Example | JavaScript Charts | View Examples",
                metaDescription:
        ...
        path: "multi-map-usa-example",
        metaKeywords: "band, chart, javascript, webgl, canvas",
        onWebsite: true,
        filepath: "Charts2D/BasicChartTypes/MultiMapUsa",
        thumbnailImage: "multi-map-usa.jpg",
        sandboxConfig: {},
