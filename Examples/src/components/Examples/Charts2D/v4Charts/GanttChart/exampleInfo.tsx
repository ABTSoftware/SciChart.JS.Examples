    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## JavaScript Gantt Chart Example\n\n### Overview\nThis example demonstrates how to create a **Gantt Chart** using SciChart.js in vanilla JavaScript. The implementation visualizes project tasks with start/end dates and completion percentages using [FastRectangleRenderableSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/fastrectanglerenderableseries.html) with [XyxyDataSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/xyxydataseries.html) for precise task positioning.\n\n### Technical Implementation\nThe chart uses a [CategoryAxis](https://www.scichart.com/documentation/js/v4/typedoc/classes/categoryaxis.html) for task names and [DateTimeNumericAxis](https://www.scichart.com/documentation/js/v4/typedoc/classes/datetimenumericaxis.html) for timeline display. Tasks are rendered as rectangles with configurable corner radii, opacity, and data labels showing completion percentages. The implementation uses [EColumnMode.StartEnd](https://www.scichart.com/documentation/js/v4/typedoc/enums/ecolumnmode.html) and [EColumnYMode.TopBottom](https://www.scichart.com/documentation/js/v4/typedoc/enums/ecolumnymode.html) for precise rectangle positioning.\n\n### Features and Capabilities\nInteractive features include horizontal zoom/pan via [ZoomPanModifier](https://www.scichart.com/documentation/js/v4/typedoc/classes/zoompanmodifier.html) and tooltips showing task dates through a custom [TCursorTooltipDataTemplate](https://www.scichart.com/documentation/js/v4/typedoc/interfaces/tcursortooltipdatatemplate.html). The chart efficiently handles task data conversion from Date objects to timestamps for rendering.\n\n### Integration and Best Practices\nThe example follows best practices for asynchronous chart initialization and includes proper cleanup. Developers can extend this by adding real-time updates or integrating with project management APIs.",
            },
            react: {
                subtitle:
                ...
                markdownContent:
                    "## React Gantt Chart Example\n\n### Overview\nThis React implementation showcases a **Gantt Chart** using SciChart.js through the [SciChartReact](https://www.scichart.com/documentation/js/v4/typedoc/globals.html) component. It visualizes project timelines with task completion percentages in a performant WebGL-rendered chart.\n\n### Technical Implementation\nThe chart is initialized via the `initChart` prop which creates a [SciChartSurface](https://www.scichart.com/documentation/js/v4/typedoc/classes/scichartsurface.html) with configured axes and series. Task data is processed into [XyxyDataSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/xyxydataseries.html) format for the [FastRectangleRenderableSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/fastrectanglerenderableseries.html). The implementation uses React's component lifecycle for efficient resource management.\n\n### Features and Capabilities\nThe component features interactive zooming (constrained to horizontal direction), task completion labels, and custom tooltips. The [CursorModifier](https://www.scichart.com/documentation/js/v4/typedoc/classes/cursormodifier.html) displays detailed task information on hover, while the reversed [CategoryAxis](https://www.scichart.com/documentation/js/v4/typedoc/classes/categoryaxis.html) ensures natural task ordering.\n\n### Integration and Best Practices\nThe example demonstrates proper React integration by encapsulating chart logic in a separate module. Developers can easily extend this by connecting to state management or adding dynamic updates while benefiting from SciChart's optimized rendering.",
            },
            angular: {
                subtitle:
