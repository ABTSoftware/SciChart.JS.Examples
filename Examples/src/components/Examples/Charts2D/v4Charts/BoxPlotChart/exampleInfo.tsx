    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                pageTitle: "JavaScript Box Plot Chart",
                metaDescription:
            ...
            react: {
                ...
                pageTitle: "React Box Plot Chart",
                metaDescription:
                ...
                markdownContent:
                    "## Box Plot Chart - React\n\n### Overview\nThis React example illustrates how to integrate a **Box Plot Chart** using SciChart.js, rendering four statistical visualizations in a grid layout. The example leverages the `<SciChartReact/>` component for seamless React integration.\n\n### Technical Implementation\nThe chart is initialized via the `initChart` prop, which references the `drawExample` function. This function creates a `SciChartSurface` with four sub-surfaces, each containing a [FastBoxPlotRenderableSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/fastboxplotrenderableseries.html). Data is configured using [BoxPlotDataSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/boxplotdataseries.html), with axes tailored for categorical and numeric data.\n\n### Features and Capabilities\nThe example showcases React-friendly chart lifecycle management and dynamic sub-surface positioning. Each box plot is styled independently, with options to customize [whiskers, caps, and median lines](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/fast-box-plot-renderable-series/).\n\n### Integration and Best Practices\nThe implementation adheres to React best practices, using the `SciChartReact` component for efficient rendering. Developers can explore further customization via [SciChart React documentation](https://www.scichart.com/documentation/js/v5/get-started/tutorials-react/tutorial-01-setting-up-project-with-scichart-react/).",
            },
            angular: {
                subtitle:
                ...
                pageTitle: "Angular Box Plot Chart",
                metaDescription:
