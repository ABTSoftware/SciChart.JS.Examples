...
const metaData: IExampleMetadata =
    ...
    {
        reactComponent: "SemiconductorsDashboard",
        id: "chart2D_v4Charts_SemiconductorsDashboard",
        imagePath: "javascript-heatmap-rectangle-chart.jpgg",
        description:
        ...
        onWebsite: true,
        filepath: "Charts2D/v4Charts/SemiconductorsDashboard",
...
const SemiconductorsDashboardExampleInfo = createExampleInfo(metaData);
export default SemiconductorsDashboardExampleInfo;
