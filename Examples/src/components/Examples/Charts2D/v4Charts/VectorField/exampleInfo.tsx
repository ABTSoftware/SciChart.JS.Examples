    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                subtitle:
                    "Creates a **JavaScript Vector Field** using our **FastLineSegmentRenderableSeries** paired with a custom **PaletteProvider** and optional arrow heads made with **FastTriangleRenderableSeries**",
                title: "JavaScript Vector Field Plot",
                pageTitle: "JavaScript Vector Field Plot",
                metaDescription:
                ...
                markdownContent:
                    "## Vector Field Chart - JavaScript\n\n### Overview\nThis example demonstrates a **Vector Field Chart** implementation using SciChart.js in vanilla JavaScript. It visualizes mathematical vector fields with directional arrows, combining [FastLineSegmentRenderableSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/fastlinesegmentrenderableseries.html) for vector lines and [FastTriangleRenderableSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/fasttrianglerenderableseries.html) for arrowheads.\n\n### Technical Implementation\nThe chart uses a [CentralAxesLayoutManager](https://www.scichart.com/documentation/js/v5/typedoc/classes/centralaxeslayoutmanager.html) to center axes and calculates vector endpoints using polynomial transformations. A custom [LineSegmentPaletteProvider](https://www.scichart.com/documentation/js/v5/typedoc/interfaces/istrokepaletteprovider.html) applies gradient colors to line segments, while the `addArrowheads` utility generates directional markers.\n\n### Features and Capabilities\nKey features include dynamic vector field generation, color-coded line segments, and interactive modifiers like [ZoomPanModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/zoompanmodifier.html) and [CursorModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/cursormodifier.html) with custom tooltips. The implementation showcases WebGL-accelerated rendering of hundreds of vectors.\n\n### Integration and Best Practices\nThe example follows best practices for WASM initialization and resource cleanup. Developers can extend this pattern for scientific visualization by modifying the vector calculation logic in the drawExample.ts function.",
            },
            react: {
                subtitle:
                ...
                title: "React Vector Field Plot",
                pageTitle: "React Vector Field Plot",
                metaDescription:
                ...
                markdownContent:
                    "## Vector Field Chart - React\n\n### Overview\nThis React implementation of a **Vector Field Chart** wraps the core SciChart.js visualization in a reusable [SciChartReact](https://www.scichart.com/blog/react-charts-with-scichart-js/) component. It demonstrates efficient integration of mathematical vector field visualization in a React application.\n\n### Technical Implementation\nThe chart configuration from drawExample.ts is passed via the initChart prop. React manages the component lifecycle while SciChart handles WebGL rendering. The solution uses [XyDataSeries](https://www.scichart.com/documentation/js/v5/typedoc/classes/xydataseries.html) for vector data and implements a custom tooltip template through [CursorModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/cursormodifier.html).\n\n### Features and Capabilities\nThe component maintains all JavaScript version features including dynamic vector generation, gradient-colored segments, and interactive zoom/pan. The React wrapper adds responsive resizing and clean unmounting through SciChartReact's built-in lifecycle management.\n\n### Integration and Best Practices\nThis pattern follows React best practices by separating visualization logic (drawExample) from presentation (ChartComponent). For advanced use cases, consider using React context for theme propagation or memoizing calculation-heavy operations.",
            },
            angular: {
                subtitle:
                ...
                title: "Angular Vector Field Plot",
                pageTitle: "Angular Vector Field Plot",
                metaDescription:
        ...
        path: "vector-field",
        metaKeywords: "vector field, vector, chart, javascript, webgl, canvas",
        onWebsite: true,
