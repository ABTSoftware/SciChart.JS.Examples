    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            ...
            react: {
                ...
                markdownContent:
                    "## Vector Field Chart - React\n\n### Overview\nThis React implementation of a **Vector Field Chart** wraps the core SciChart.js visualization in a reusable [SciChartReact](https://www.scichart.com/documentation/js/v4/typedoc/classes/scichartreact.html) component. It demonstrates efficient integration of mathematical vector field visualization in a React application.\n\n### Technical Implementation\nThe chart configuration from drawExample.ts is passed via the initChart prop. React manages the component lifecycle while SciChart handles WebGL rendering. The solution uses [XyDataSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/xydataseries.html) for vector data and implements a custom tooltip template through [CursorModifier](https://www.scichart.com/documentation/js/v4/typedoc/classes/cursormodifier.html).\n\n### Features and Capabilities\nThe component maintains all JavaScript version features including dynamic vector generation, gradient-colored segments, and interactive zoom/pan. The React wrapper adds responsive resizing and clean unmounting through SciChartReact's built-in lifecycle management.\n\n### Integration and Best Practices\nThis pattern follows React best practices by separating visualization logic (drawExample) from presentation (ChartComponent). For advanced use cases, consider using React context for theme propagation or memoizing calculation-heavy operations.",
            },
            angular: {
                subtitle:
