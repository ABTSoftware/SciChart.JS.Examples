    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                metaDescription: "View the JavaScript Linear Gauge Chart example to combine rectangles and annotations. Create a linear gauges dashboard with animated indicators and custom scales.",
                markdownContent:
            ...
            react: {
                ...
                metaDescription: "View the React Linear Gauge Chart example to combine rectangles and annotations. Create a linear gauges dashboard with animated indicators and custom scales.",
                markdownContent:
            ...
            angular: {
                ...
                metaDescription: "View the Angular Linear Gauge Chart example to combine rectangles and annotations. Create a linear gauges dashboard with animated indicators and custom scales.",
                markdownContent:
