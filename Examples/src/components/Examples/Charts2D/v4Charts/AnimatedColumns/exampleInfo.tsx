    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Animated Columns Chart - JavaScript\n\n### Overview\nThis example demonstrates how to create an animated column chart visualizing ATP tennis rankings over time using SciChart.js. The implementation uses [FastRectangleRenderableSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/fastrectanglerenderableseries.html) with custom coloring by country and smooth animations between yearly data updates.\n\n### Technical Implementation\nThe chart initializes with a [SciChartSurface](https://www.scichart.com/documentation/js/v4/typedoc/classes/scichartsurface.html) and configures a flipped [NumericAxis](https://www.scichart.com/documentation/js/v4/typedoc/classes/numericaxis.html) for rankings display. Data is loaded from a structured dataset containing player rankings by year. The [ColumnAnimation](https://www.scichart.com/documentation/js/v4/typedoc/classes/columnanimation.html) handles transitions between years with easing functions for smooth movement.\n\n### Features and Capabilities\nThe example showcases dynamic data updates with player position changes animated over time. A custom [CountryPaletteProvider](https://www.scichart.com/documentation/js/v4/typedoc/classes/defaultpaletteprovider.html) assigns colors based on player nationality, while data labels display player names and countries. The chart title updates automatically to reflect the current year being displayed.\n\n### Integration and Best Practices\nThe vanilla JavaScript implementation demonstrates proper resource management with surface disposal. For performance, the animation uses efficient data series updates rather than recreating the entire chart. The example could be extended with interactive features using [Chart Modifiers](https://www.scichart.com/documentation/js/v4/2d-charts/chart-modifier-api/common-features/).",
            },
            react: {
                subtitle:
            ...
            angular: {
                ...
                markdownContent:
                    "## Animated Columns Chart - Angular\n\n### Overview\nThis Angular standalone component demonstrates an animated tennis rankings visualization using SciChart.js. The implementation uses the [scichart-angular](https://www.npmjs.com/package/scichart-angular) package for seamless integration with Angular's component system.\n\n### Technical Implementation\nThe chart is configured through the `drawExample` function passed to the [ScichartAngularComponent](https://www.npmjs.com/package/scichart-angular). It creates a [SciChartSurface](https://www.scichart.com/documentation/js/v4/typedoc/classes/scichartsurface.html) with a [FastRectangleRenderableSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/fastrectanglerenderableseries.html) using [EColumnYMode.CenterHeight](https://www.scichart.com/documentation/js/v4/typedoc/enums/ecolumnymode.html) for proper column sizing.\n\n### Features and Capabilities\nThe component animates yearly ranking changes with smooth transitions using [ColumnAnimation](https://www.scichart.com/documentation/js/v4/typedoc/classes/columnanimation.html). A custom palette provider colors columns by player nationality, and data labels display player information. The flipped Y-axis correctly represents ranking positions.\n\n### Integration and Best Practices\nThe example follows Angular best practices by using standalone components and proper dependency management. The [scichart-angular](https://www.npmjs.com/package/scichart-angular) wrapper handles chart lifecycle management, including WebAssembly context creation and cleanup.",
            },
        },
        documentationLinks: [
            {
