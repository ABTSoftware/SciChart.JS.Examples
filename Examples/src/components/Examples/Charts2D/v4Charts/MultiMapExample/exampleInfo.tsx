    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                subtitle:
                    "Demonstrates how to create a **Multi Map Example**, by pairing our **FastTriangleRenderableSeries** with GeoJSON data-points turned to triangles with a constrained delaunay triangulation algorithm",
                title: "JavaScript Multi-Layer Map Example",
                pageTitle: "JavaScript Multi-Layer Map",
                metaDescription:
        ...
        metaKeywords: "map, triangle, multi-layer, chart, javascript, webgl, canvas",
        onWebsite: true,
