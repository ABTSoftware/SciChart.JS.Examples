...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        description: "Demonstrates how to create a **Multi Map Example**, by pairing our **FastTriangleRenderableSeries** with GeoJSON data-points turned to triangles with a constrained delaunay triangulation algorithm",
        tips: [],
        frameworks: {
            javascript: {
                subtitle: "Demonstrates how to create a **Multi Map Example**, by pairing our **FastTriangleRenderableSeries** with GeoJSON data-points turned to triangles with a constrained delaunay triangulation algorithm",
