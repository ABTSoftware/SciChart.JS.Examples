...
const metaData: IExampleMetadata =
    ...
    {
        reactComponent: "DragAndDropDashboard",
        id: "chart2D_v4Charts_DragAndDropDashboard",
        ...
        path: "draganddrop-dashboard",
        metaKeywords: "heatmap, chart, javascript, webgl, canvas",
        onWebsite: true,
        filepath: "Charts2D/v4Charts/DragAndDropDashboard",
        thumbnailImage: "draganddrop-dashboard.jpg",
        sandboxConfig: {},
        markdownContent: null,
        pageLayout: "default",
        extraDependencies: {},
...
const DragAndDropDashboardExampleInfo = createExampleInfo(metaData);
export default DragAndDropDashboardExampleInfo;
