    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Waterfall Chart - JavaScript\n\n### Overview\nThis example demonstrates how to create a **Waterfall Chart** using SciChart.js in vanilla JavaScript. The chart visualizes cumulative profit data with colored rectangles indicating positive (teal) and negative (pink) values, using the [FastRectangleRenderableSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/fastrectanglerenderableseries.html) for high-performance rendering.\n\n### Technical Implementation\nThe chart uses an [XyxyDataSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/xyxydataseries.html) to define rectangle positions (prior/accu values) and a custom [IFillPaletteProvider](https://www.scichart.com/documentation/js/v4/typedoc/interfaces/ifillpaletteprovider.html) to dynamically color rectangles based on profit values. The [TextLabelProvider](https://www.scichart.com/documentation/js/v4/typedoc/classes/textlabelprovider.html) maps indices to month labels, while a custom [RectangleSeriesDataLabelProvider](https://www.scichart.com/documentation/js/v4/typedoc/classes/rectangleseriesdatalabelprovider.html) displays formatted cumulative values.\n\n### Features and Capabilities\nKey features include dynamic coloring based on data values, formatted engineering notation labels, and interactive zoom/pan with [ZoomPanModifier](https://www.scichart.com/documentation/js/v4/typedoc/classes/zoompanmodifier.html). The implementation showcases how to transform raw data into waterfall format using a custom data processing function.\n\n### Integration and Best Practices\nThe example follows best practices for WASM initialization with `SciChartSurface.create()` and includes proper cleanup. For performance, it uses a single renderable series with palette providers instead of multiple series.",
            },
            react: {
                subtitle:
                ...
                markdownContent:
                    "## Waterfall Chart - React\n\n### Overview\nThis React example creates a **Waterfall Chart** using SciChart.js, demonstrating how to integrate the powerful charting library within a React application via the [SciChartReact](https://www.scichart.com/documentation/js/v4/typedoc/classes/scichartreact.html) component.\n\n### Technical Implementation\nThe chart logic is encapsulated in `drawExample.ts`, which initializes the [SciChartSurface](https://www.scichart.com/documentation/js/v4/typedoc/classes/scichartsurface.html) asynchronously. The React component simply passes this function to `<SciChartReact initChart={drawExample}>`. The implementation uses [FastRectangleRenderableSeries](https://www.scichart.com/documentation/js/v4/typedoc/classes/fastrectanglerenderableseries.html) with [EColumnMode.Mid](https://www.scichart.com/documentation/js/v4/typedoc/enums/ecolumnmode.html) for centered columns and custom data labels.\n\n### Features and Capabilities\nThe chart features dynamic coloring through a custom [IFillPaletteProvider](https://www.scichart.com/documentation/js/v4/typedoc/interfaces/ifillpaletteprovider.html), multi-line data labels showing both cumulative and delta values, and responsive design through the `ChartWrapper` CSS class. Interactive modifiers enable zooming and panning.\n\n### Integration and Best Practices\nThe example shows proper React integration by separating chart logic from presentation. The async initialization pattern ensures optimal performance, while the contained component structure makes it easy to reuse. For more on React best practices, see [Creating a SciChart React Component](https://www.scichart.com/documentation/js/v4/get-started/tutorials-react/tutorial-01-setting-up-project-with-scichart-react/).",
            },
            angular: {
                subtitle:
