...
import { metaData } from "./ChartLegendsAPIMetadata";
...
export const oldchartLegendsAPIExampleInfo: TExampleInfo = {
    onWebsite: true,
...
export const chartLegendsAPIExampleInfo = createExampleInfo(metaData as IExampleMetadata);
