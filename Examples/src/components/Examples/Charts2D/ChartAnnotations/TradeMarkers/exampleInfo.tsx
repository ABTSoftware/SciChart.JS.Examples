    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "# Trade Markers Example - Vanilla JavaScript\n\n## Overview\nThis example demonstrates how to integrate SciChart.js using vanilla JavaScript to create a high performance stock chart that features interactive buy/sell markers and news/dividend annotations. The implementation focuses on asynchronous chart initialization, dynamic annotation management, and performance optimization via WebGL rendering.\n\n## Technical Implementation\nThe chart is initialized asynchronously using async/await together with Promise.all to fetch simulated trading data and set up the SciChartSurface. A CategoryAxis is used for displaying dates (see [The Category Axis](https://www.scichart.com/documentation/js/current/CategoryAxis.html)) and NumericAxes represent pricing and additional metrics. Custom SVG-based annotations are created for buy and sell markers, and dynamic hover functionality is implemented via the SciChart [Annotation Hover API](https://www.scichart.com/documentation/js/current/AnnotationHover.html), which binds event handlers for interactive tooltips. Efficient chart rendering is achieved through WebGL, as detailed in [Performance Tips & Tricks](https://www.scichart.com/documentation/js/current/Performance%20Tips.html).\n\n## Features and Capabilities\nThe example simulates real-time trading actions by dynamically adding annotations based on randomized trading data. It supports advanced multi-axis layout configurations using techniques similar to those described for vertically and horizontally stacked axes. Interactive features such as hoverable annotations provide immediate trade details, and dynamically added news bullets give contextual information, enhancing user engagement. Additionally, the integration of custom SVG strings for marker design showcases how developers can tailor the visual appearance of annotations.\n\n## Integration and Best Practices\nDesigned for vanilla JavaScript applications, the example cleanly separates the initialization logic in a dedicated function that takes a DOM element as the chart container. This modular approach simplifies lifecycle management and cleanup via a destructor function. Developers are encouraged to follow these best practices, as explained in resources for asynchronous initialization in vanilla JavaScript like [Sequential promises using async/await in vanilla Javascript](https://stackoverflow.com/questions/52697719/sequential-promises-using-async-await-in-vanilla-javascript) to enhance maintainability and performance. Furthermore, the use of custom event subscriptions and dynamic annotation management illustrates best practices for interactive charting solutions.\n",
            },
            react: {
                subtitle:
