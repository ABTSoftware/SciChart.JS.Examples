    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            ...
            angular: {
                ...
                markdownContent:
                    '## Angular Chart Hoverable Buy Sell Marker Annotations\n\n### Overview\nThis example, "Trade Markers", demonstrates how to integrate SciChart.js within an Angular standalone component to render a high performance stock chart featuring interactive buy/sell markers and news/dividend bullet annotations. The implementation leverages the [scichart-angular](https://www.npmjs.com/package/scichart-angular) package to facilitate seamless integration within Angular applications, ensuring that all chart initialization and interactions are encapsulated in a dedicated Angular component.\n\n### Technical Implementation\nThe chart is initialized asynchronously using async/await together with `Promise.all()` to fetch trading data and set up the `SciChartSurface` efficiently. A `CategoryAxis` is used for date values and `NumericAxis` represent price and balance information, while custom SVG-based annotations are created for buy and sell trades. Custom event handlers, particularly through the use of the `AnnotationHoverModifier` (see [Annotation Hover API](https://www.scichart.com/documentation/js/v4/2d-charts/annotations-api/annotation-hover/)), allow annotations to respond to hover events by displaying additional tooltips. This approach mirrors common asynchronous integration strategies in Angular, as discussed in resources like [async/await in Angular ngOnInit](https://stackoverflow.com/questions/56092083/async-await-in-angular-ngoninit).\n\n### Features and Capabilities\nThe example provides real-time simulation of trading actions where markers are dynamically added to the chart. It demonstrates advanced features such as a multi-axis layout where a secondary axis displays profit and loss curves, a capability further detailed in the [Tutorial 08 - Adding Multiple Axis](https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-08-adding-multiple-axis/) documentation. Custom SVG annotations enable distinct visual representations for buy (green) and sell (red) actions, and interactive tooltips enhance user engagement by presenting detailed trade information on hover.\n\n### Integration and Best Practices\nThe integration follows Angular best practices by encapsulating the chart within a standalone component using the `ScichartAngularComponent`. The chart’s asynchronous initialization and the clear separation of concerns promote maintainability and reusability in large Angular applications. Performance optimizations are achieved through efficient WebGL rendering, ensuring that high-frequency data updates do not impact the user experience. Developers looking to extend or customize this approach should refer to the [Getting Started with SciChart JS](https://www.scichart.com/getting-started/scichart-javascript/) guide for foundational tips and consult the [Annotation Hover Documentation](https://www.scichart.com/documentation/js/v4/2d-charts/annotations-api/annotation-hover/) for advanced interactive customization strategies.\n',
            },
        },
        documentationLinks: [
            {
