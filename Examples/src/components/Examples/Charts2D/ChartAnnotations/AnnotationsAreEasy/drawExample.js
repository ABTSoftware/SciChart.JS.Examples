...
const addFadeEffect = (duration, delay, ...annotations) => {
...
const addTypewriterEffect = (duration, delay, textAnnotation) => {
    return new GenericAnimation({
        from: "",
...
const addRotateEffect = (duration, delay, textAnnotation) => {
    return new GenericAnimation({
        from: 0,
        to: 30,
        onAnimate: (from, to, progress) => {
...
const getBuyMarkerAnnotation = (x1, y1) => {
...
const getImageAnnotation = (x1, y1, image, width, height) => {
    return new CustomAnnotation({
        x1,
        y1,
        verticalAnchorPoint: EVerticalAnchorPoint.Top,
...
// The CustomAnnotation supports SVG as content. Using Inkscape or similar you can create SVG content for annotations
const getSellMarkerAnnotation = (x1, y1) => {
    return new CustomAnnotation({
        x1,
        y1,
        verticalAnchorPoint: EVerticalAnchorPoint.Bottom,
