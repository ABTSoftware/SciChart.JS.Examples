...
const emojiUrls =  "/assets/images/scichart-logo-white.png";
...
export class ChartExampleComponent implements AfterViewInit {
    ...
    async drawChart() {
        drawExample(emojiUrls)(this.chartContainer.nativeElement);
    }
}
//     ngOnInit(): void {
//         drawExample(this.chartContainer.nativeElement)
//             .then(({ sciChartSurface, wasmContext }) => {
//             })
//             .catch(error => {
//                 console.error('Failed to draw example:', error);
//             });
//     }
// }

// export const drawExample = async (rootElement: HTMLDivElement): Promise<{ sciChartSurface: SciChartSurface; wasmContext: TSciChart; }> => {
...
//         verticalAnchorPoint: EVerticalAnchorPoint.Bottom,
//     });
//     const image = getImageAnnotation(0.3, 2.8, '/assets/images/scichart-logo-white.png', 241, 62);
...
//     const allAnnotations: IAnnotation[] = [
//         text1,
//         text2,
//         nativeText,
//         lineDash,
