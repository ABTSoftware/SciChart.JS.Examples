...
export const drawExample = async (rootElement) => {
    ...
    const annotationHoverModifier = new AnnotationHoverModifier({
        ...
        onHover: (args) => {
            const [hoveredAnnotation] = args.hoveredEntities;
...
const mapAnnotationTypeToName = (type) => {
    switch (type) {
