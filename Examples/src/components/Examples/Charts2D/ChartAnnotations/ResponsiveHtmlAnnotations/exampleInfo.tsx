    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                subtitle:
                    "Demonstrates how to use the **HtmlCustomAnnotation** to create responsive text content using SciChart.js, High Performance JavaScript Charts",
                title: "JavaScript Responsive HTML Annotations Example",
                ...
                markdownContent:
                    "## Responsive HTML Annotations Example - JavaScript\n\n### Overview\nThis example demonstrates **responsive HTML annotations** in SciChart.js, creating an interactive schedule visualization with time-bound annotations. It showcases [HtmlCustomAnnotation](https://www.scichart.com/documentation/js/v5/typedoc/classes/htmlcustomannotation.html) and [HtmlTextAnnotation](https://www.scichart.com/documentation/js/v5/typedoc/classes/htmltextannotation.html) to display employee schedules with CSS container queries for responsive text layout.\n\n### Technical Implementation\nThe implementation uses [CategoryAxis](https://www.scichart.com/documentation/js/v5/typedoc/classes/categoryaxis.html) with [SmartDateLabelProvider](https://www.scichart.com/documentation/js/v5/typedoc/classes/smartdatelabelprovider.html) for time-based data. Annotations are positioned using [ECoordinateMode](https://www.scichart.com/documentation/js/v5/typedoc/enums/ecoordinatemode.html) with responsive CSS that adapts text orientation based on container size. An [AnnotationHoverModifier](https://www.scichart.com/documentation/js/v5/typedoc/classes/annotationhovermodifier.html) provides interactive tooltips with time formatting.\n\n### Features and Capabilities\nKey features include: dynamic annotation sizing, CSS-based responsive text layout, interactive hover tooltips, and multi-lane schedule visualization. The example leverages modern CSS features like container queries and viewport units for responsive behavior.\n\n### Integration and Best Practices\nThe implementation shows best practices for time-based data visualization, including proper axis configuration and annotation layering using [EAnnotationLayer](https://www.scichart.com/documentation/js/v5/typedoc/enums/eannotationlayer.html). Performance is maintained by limiting DOM updates during interactions.",
            },
            react: {
                subtitle:
                    "Demonstrates how to use the **HtmlCustomAnnotation** to create responsive text content using SciChart.js, High Performance JavaScript Charts",
                title: "React Responsive HTML Annotations Example",
                pageTitle: "Responsive HTML Annotations",
                metaDescription:
