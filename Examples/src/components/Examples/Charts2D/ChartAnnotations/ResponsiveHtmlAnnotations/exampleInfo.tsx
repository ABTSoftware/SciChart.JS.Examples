    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                metaDescription: "Build Responsive JavaScript HTML Annotations with SciChart. Use the advanced CSS container queries for responsive text layout and custom design. View demo now.",
                markdownContent:
            ...
            react: {
                ...
                pageTitle: "Responsive HTML Annotations",
                metaDescription: "Build Responsive React HTML Annotations with SciChart. Use the advanced CSS container queries for responsive text layout and custom design. View demo now.",
                markdownContent:
            ...
            angular: {
                ...
                pageTitle: "Responsive HTML Annotations",
                metaDescription: "Build Responsive Angular HTML Annotations with SciChart. Use the advanced CSS container queries for responsive text layout and custom design. View demo now.",
                markdownContent:
