    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Percentage Change Example in JavaScript\n\n### Overview\nThis example demonstrates how to transform raw data into a real-time percentage change chart using SciChart.js with JavaScript. It converts random walk data into percentage-based visualizations and offers dynamic interactivity with high performance.\n\n### Technical Implementation\nThe implementation generates two random walk data series that are transformed using the [XyScaleOffsetFilter](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/data-filters-api/scale-offset-filters/) to calculate percentage changes. By subscribing to the x-axis visible range changes, the chart dynamically adjusts the filter scale in real time, as detailed in the [Adding Realtime Updates documentation](https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-04-adding-realtime-updates/). Furthermore, a custom series extending the fast line renderable series is implemented to override tooltip behavior, providing precise display of original values—techniques similar to those covered in [Tutorial 07 - Adding Tooltips and Legends](https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-07-adding-tooltips-and-legends/).\n\n### Features and Capabilities\nThe example incorporates real-time data transformation and interactive features such as zooming and panning using modifiers like the [ZoomPanModifier](https://www.scichart.com/documentation/js/v4/2d-charts/chart-modifier-api/zooming-and-panning/zoom-pan-modifier/). It also provides a toggle mechanism to switch between the original data and its percentage change view, ensuring an engaging and informative user experience. Data simulation is achieved via the RandomWalkGenerator, echoing strategies used in the [Realtime JavaScript Chart Performance Demo](https://www.scichart.com/demo/javascript/chart-realtime-performance-demo/).\n\n### Integration and Best Practices\nFocusing on JavaScript, the example emphasizes clean integration with SciChart.js by adhering to event-driven update patterns and performance optimization techniques. By limiting updates to essential parameters and leveraging efficient WebGL rendering, the implementation serves as a robust template for developers aiming to build interactive, high-performance charts with SciChart.js.",
            },
            react: {
                subtitle:
                    "Demonstrates how to use a ScaleOffsetFilter to convert data to a **Percentage Change** with realtime updates, using SciChart.js, High Performance JavaScript Charts",
            ...
            angular: {
                ...
                metaDescription:
                    "How to use a ScaleOffsetFilter to convert data to a percentage change, with realtime updates, rescale on pan",
                markdownContent:
                    "## Realtime Percentage Change using Filter - Angular\n\n### Overview\nThis example demonstrates how to integrate SciChart.js with Angular for real-time data visualization. It focuses on converting series data into percentage change values by applying a dynamic [ScaleOffsetFilter](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/data-filters-api/scale-offset-filters/) transformation and allows users to toggle between displaying the original data and the percentage change view.\n\n### Technical Implementation\nThe implementation initializes a `SciChartSurface` with numeric X and Y axes and adds two line series that use random walk data as their source. A custom renderable series is created by extending the default series class to provide enhanced tooltip information. The key part of the logic involves subscribing to axis changes to update the scale factor of the filter dynamically, ensuring that percentage changes are calculated in real-time. Detailed technical insights on custom series development can be found in the [Custom RenderableSeries API](https://www.scichart.com/documentation/js/v4/user-manual/what-chart-types/#customrenderableseries-custom-series-in-2d-charts).\n\n### Features and Capabilities\nThe example offers real-time data updates, dynamic percentage recalculations, and interactive features such as zooming and panning. It leverages Angular’s event handling to subscribe to axis range changes and apply corresponding transformations on the fly. Additionally, the sample emphasizes performance by updating only the necessary filter parameters, which optimizes rendering performance during continuous data updates. For further reading on real-time updates and performance optimization, refer to the [Adding Realtime Updates documentation](https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-04-adding-realtime-updates/).\n\n### Integration and Best Practices\nThis example illustrates best practices for integrating SciChart.js into an Angular application. By utilizing component-based design and Angular’s robust event management system, developers can build charts that handle real-time data efficiently. Even though the source example originally demonstrates some concepts with React, the Angular integration follows a similar approach by using Angular-compatible toggle buttons and state management strategies. Developers interested in further Angular integrations should explore the [scichart-angular package](https://www.npmjs.com/package/scichart-angular) and review the [Memory Best Practices](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/memory-best-practices/) to ensure efficient resource management in high-performance applications.",
            },
        },
        documentationLinks: [
            {
                href: "https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/data-filters-api/scale-offset-filters/",
