...
const customFormatNumber = (value, format, precision) => {
    return value.toFixed(precision);
};
const getScaleValue = (dataSeries, zeroXValue) => {
...
export const drawExample = async (rootElement, usePercentage) => {
    ...
    yAxis.labelProvider.formatCursorLabel = (value) => customFormatNumber(value, ENumericFormat.Decimal, 1);
