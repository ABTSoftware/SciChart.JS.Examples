    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Create A Custom Theme for Vanilla JavaScript Chart\n\n### Overview\nThis example demonstrates how to create and apply a **custom theme** to a SciChart.js chart using vanilla JavaScript. The implementation focuses on leveraging SciChart.js's extensive theming API to modify the appearance of various chart components—including axes, grid lines, series, and interactive modifiers—while ensuring high-performance rendering through WebGL.\n\n### Technical Implementation\nThe chart is initialized asynchronously via the [SciChartSurface.create](https://www.scichart.com/documentation/js/current/SciChartSurface.create%20and%20createSingle.html) method, which sets up the required WebGL context for optimal performance. Once the surface is created, a custom theme is applied using the sciChartSurface.applyTheme method, where properties like axis borders, series colors, and annotation styles are meticulously defined. The example instantiates high-performance renderable series such as [FastLineRenderableSeries](https://www.scichart.com/documentation/js/current/typedoc/classes/fastcolumnrenderableseries.html), [FastCandlestickRenderableSeries](https://www.scichart.com/documentation/js/current/typedoc/classes/ohlcdataseries.html), and [FastColumnRenderableSeries](https://www.scichart.com/documentation/js/current/typedoc/classes/fastcolumnrenderableseries.html) to efficiently visualize complex datasets.\n\n### Features and Capabilities\nKey features of this example include asynchronous chart initialization and dynamic data binding using data series like XyDataSeries and OhlcDataSeries. An interactive [RolloverModifier](https://www.scichart.com/documentation/js/current/RolloverModifier.html) enhances the chart experience by providing tooltips on mouse hover, which is particularly useful for real-time data updates. The custom theme not only personalizes the visual style but also contributes to performance optimizations by maintaining consistent styling across different chart elements.\n\n### Integration and Best Practices\nAlthough this implementation is built with vanilla JavaScript, it follows best practices that are applicable to any modern web application. Asynchronous initialization using promises ensures that the WebGL context is loaded efficiently, while a dedicated cleanup function properly disposes of the SciChartSurface to avoid memory leaks. Developers are encouraged to explore further details in the [SciChart.js Custom Theme Documentation](https://demo.scichart.com/javascript/chart-custom-themes) and consult the [WebGL initialization guidelines](https://www.scichart.com/documentation/js/current/SciChartSurface.create%20and%20createSingle.html) to ensure robust implementation and optimal performance.",
            },
            react: {
                subtitle:
                    "Demonstrates how to create a **Custom Theme** for SciChart.js, High Performance JavaScript Charts",
