    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            ...
            angular: {
                ...
                markdownContent:
                    "## Data Labels - Angular\n\n### Overview\nThis example demonstrates how to integrate SciChart.js into an Angular application to render charts with advanced **Data Labels** customization. The implementation uses a standalone Angular component with the scichart-angular package to initialize the chart via a callback function, ensuring a smooth and modular integration.\n\n### Technical Implementation\nThe chart is constructed by creating a `SciChartSurface` within an Angular standalone component as described in [Getting started with standalone components](https://angular.io/guide/standalone-components). Axes and multiple renderable series are set up where each series applies custom data labels through the `DataLabelProvider`. For instance, the column series dynamically assigns label colors based on Y-value conditions, while spline and line series utilize metadata and custom functions to format labels, an approach detailed in [Adding DataLabels to a Chart Series](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/data-point-labels/data-labels-api-overview/). Interactive modifiers such as zoom, pan, and mouse wheel zoom are added to enhance the user experience, ensuring the chart remains responsive under various data densities.\n\n### Features and Capabilities\nThe example showcases several advanced features including conditional label styling, metadata-driven text for labels, and dynamic label display triggered by data peaks and zoom level. These capabilities follow best practices outlined in the [SciChart.js DataLabels API Documentation](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/data-point-labels/data-labels-api-overview/) and further elaborated in the [Getting Labels from Metadata](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/data-point-labels/getting-labels-from-metadata/) documentation.\n\n### Integration and Best Practices\nThis solution leverages Angular’s component binding to pass the chart initialization function efficiently while managing dependencies with modern Angular patterns. Developers can expand this approach by reviewing [Getting Started with SciChart JS](https://www.scichart.com/getting-started/scichart-javascript/) for comprehensive setup guidance. Interactive annotations are also incorporated using SciChart’s API, which aligns with techniques from [Tutorial 06 - Adding Annotations](https://www.scichart.com/documentation/js/v5/get-started/tutorials-js-npm-webpack/tutorial-06-adding-annotations/). This integration strategy promotes performance optimization in handling large datasets and ensures robust resource management through appropriate component lifecycle practices.",
            },
        },
        documentationLinks: [
            {
                href: "https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/data-point-labels/data-labels-api-overview/",
