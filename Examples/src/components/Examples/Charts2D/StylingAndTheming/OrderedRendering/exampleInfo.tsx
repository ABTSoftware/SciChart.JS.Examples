...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        description:
            "Demonstrates how to create a **Ordered Rendering**",
        tips: [],
        frameworks: {
            javascript: {
                subtitle:
                    "Demonstrates how to create a **OrderedRendering**",
            ...
            react: {
                ...
                pageTitle: "Ordered Rendering | JavaScript Charts | View Examples",
                metaDescription:
                    "Easily create a Ordered Rendering or High-Low Fill with SciChart - high performance JavaScript Chart Library. Get your free trial now.",
                markdownContent:
