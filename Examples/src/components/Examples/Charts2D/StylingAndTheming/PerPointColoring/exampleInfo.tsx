        ...
        frameworks: {
            ...
            angular: {
                ...
                metaDescription:
                    "Demonstrates per-point coloring in JavaScript chart types with SciChart.js PaletteProvider API",
                markdownContent:
                    "## Per Point Coloring - Angular\n\n### Overview\nThis Angular example demonstrates how to implement per point coloring for both line and scatter series using SciChart.js. The example utilizes the `ScichartAngularComponent` and Angular standalone components to integrate the chart seamlessly into an Angular application.\n\n### Technical Implementation\nThe chart is asynchronously initialized by calling `SciChartSurface.create()`, which loads the required WebAssembly context as detailed in the [Creating a new SciChartSurface and loading Wasm](https://www.scichart.com/documentation/js/v4/2d-charts/surface/new-scichart-surface/) documentation. Numeric axes are configured and a random walk data series is generated. Custom implementations of the PaletteProvider interfaces `IStrokePaletteProvider` and `IPointMarkerPaletteProvider` are used to override stroke and point marker colors on a per-data-point basis. This technique leverages the [The PaletteProvider API documentation](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/palette-provider-api/palette-provider-api-overview/) for dynamic color assignment based on defined threshold values.\n\n### Features and Capabilities\nThe example features interactive annotations, including draggable horizontal lines that update threshold levels in real-time. This behavior is implemented using editable annotations, as explained in the [Editable Annotations](https://www.scichart.com/documentation/js/v4/2d-charts/annotations-api/editable-annotations/) guide. Performance is optimized by processing color updates on each data point efficiently, ensuring high performance even with dynamic chart updates.\n\n### Integration and Best Practices\nDevelopers can easily integrate this version of SciChart.js in Angular by utilizing the standalone Angular component provided by the scichart-angular package, available on [scichart-angular](https://www.npmjs.com/package/scichart-angular). The example also follows the best practices outlined in the [Getting Started with SciChart JS](https://www.scichart.com/getting-started/scichart-javascript/) guide, ensuring that asynchronous initialization and component-based structuring lead to maintainable and efficient code. This approach enables seamless event handling and real-time updates in Angular applications.",
            },
        },
        documentationLinks: [
            {
                href: "https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/palette-provider-api/palette-provider-api-overview/",
