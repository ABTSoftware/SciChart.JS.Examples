    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            ...
            angular: {
                ...
                metaDescription: "Rotate to create vertical axis labels and fit more on an axis",
                markdownContent:
                    "## Rotated Axis Labels and Alignment in Angular\n\n### Overview\nThis example demonstrates how to implement **rotated axis labels** using SciChart.js within an Angular application. The primary goal is to enhance the readability of the X-Axis labels by rotating them 90 degrees, which allows more date-based data points to be displayed without overlap.\n\n### Technical Implementation\nThe chart is initialized asynchronously by creating a `SciChartSurface` and a WebAssembly context. A `NumericAxis` is configured for the X-Axis with a custom date format and a rotation value of 90 degrees, while additional properties such as increased major tick counts ensure optimal spacing. Dynamic time series data is generated and visualized using a `SplineMountainRenderableSeries` with gradient fill and a wave animation effect. This implementation follows best practices described in the [Spline Mountain Chart Documentation](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/spline-mountain-renderable-series/) and leverages axis customization techniques detailed in the [SciChart.js Axis Label Formatting Documentation](https://www.scichart.com/documentation/js/v4/2d-charts/axis-api/axis-labels/rotating-axis-labels/).\n\n### Features and Capabilities\nKey features of this example include:\n- **Axis Label Rotation and Alignment**: The X-Axis labels are rotated 90 degrees for better spacing and readability by setting `axis.rotation`.\n- **Dynamic Data Binding**: Time series data is generated on the fly for rendering in a Spline Mountain chart.\n- **Advanced Visual Effects**: The use of gradient fills and wave animation demonstrates enhanced visual customization as outlined in the [Animations API](https://www.scichart.com/documentation/js/v4/2d-charts/animations-api/animations-api-overview/).\n\n### Integration and Best Practices\nIn an Angular setting, integration involves embedding the chart creation within Angular components and properly managing resources. Developers are encouraged to initialize `SciChartSurface` in lifecycle hooks like `ngAfterViewInit` and dispose of it in `ngOnDestroy`, following recommendations from the [Memory Best Practices](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/memory-best-practices/) documentation. For further customization and theming, refer to the [Chart Styling - Creating a Custom Theme](https://www.scichart.com/documentation/js/v4/2d-charts/styling-and-theming/creating-custom-theme/) guide. This example provides a robust foundation for integrating high-performance SciChart.js charts with advanced axis label customization in Angular applications.",
            },
        },
        documentationLinks: [
            {
                href: "https://www.scichart.com/documentation/js/v4/2d-charts/axis-api/axis-labels/rotating-axis-labels/",
