...
export class EmojiPaletteProvider {
    strokePaletteMode = EStrokePaletteMode.SOLID;
    fillPaletteMode = EFillPaletteMode.SOLID;
    pfYellow = parseColorToUIntArgb("FFCC4D");
    pfBlue = parseColorToUIntArgb("5DADEC");
    pfOrange = parseColorToUIntArgb("F58E01");
    pfRed = parseColorToUIntArgb("DE2A43");
    pfPink = parseColorToUIntArgb("FE7891");
