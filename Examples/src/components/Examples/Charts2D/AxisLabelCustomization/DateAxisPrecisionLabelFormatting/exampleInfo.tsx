...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        description: "Demonstrates how to **customize specific label formats** on a High Precision Date Axis, using external libraries like **date-fns**.",
        tips: [],
        frameworks: {
            javascript: {
                subtitle: "Demonstrates how to **customize specific label formats** on a High Precision Date Axis, using external libraries like **date-fns**.",
                title: "Custom High Precision Date Labels",
                pageTitle: "Custom High Precision Date Labels",
                metaDescription: "Demonstrates how to use date-fns and custom logic to format High Precision Date Axes in SciChart.js",
                markdownContent:
