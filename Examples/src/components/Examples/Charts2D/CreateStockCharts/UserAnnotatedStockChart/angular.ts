...
//     width: 100%;
//     height: 100%;
//     background-color: #1e1e1e; /* Replace with your background color */
//   }
  
//   .toolbar-row {
//     display: flex;
//     flex-wrap: wrap; /* Allows wrapping of elements if needed */
//     gap: 10px; /* Space between elements */
//     padding: 10px;
//     background: ${appTheme.DarkIndigo} /* Replace with your background color */
//   }
  
//   mat-button-toggle-group {
//     border: 1px solid #ccc; /* Border for the button toggle group */
//     border-radius: 4px;
//     padding: 4px;
//   }
  
//   mat-button-toggle {
//     border: 1px solid #444; /* Border for individual toggles */
//     border-radius: 4px;
//   }
  
//   mat-form-field {
//     border: 1px solid #ccc; /* Border for form fields */
//     border-radius: 4px;
//     padding: 0 10px;
...
//   button {
//     border: 1px solid #888; /* Border for buttons */
//     border-radius: 4px;
//     margin-right: 10px;
//     padding: 8px 16px; /* Padding for buttons */
//     color: #fff; /* Text color for buttons */
//     &:hover {
//       background: #5a5a5a; /* Background color on hover */
//     }
//   }
//     </style>
//       <div class="chart-wrapper">
