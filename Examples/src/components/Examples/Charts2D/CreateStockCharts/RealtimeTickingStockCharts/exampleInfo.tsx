    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            ...
            react: {
                ...
                markdownContent:
                    "## React Realtime Ticking Stock Charts\n\n### Overview\nThis example demonstrates a real-time ticking stock chart implemented in [React Charts](https://www.scichart.com/react-charts/) component using the high performance SciChart.js library.\n\n### Technical Implementation\nThe implementation leverages React components along with hooks and refs to integrate `<SciChartReact/>` and `SciChartNestedOverview`. Real-time updates are achieved using RxJS operators like `combineLatest` and `scan` to `merge` and process live data streams from a custom WebSocket client powered by the websocket-ts package. For an in-depth discussion about real-time data streaming with RxJS in a React application, see [Reactive Programming in React With RxJS](https://dzone.com/articles/reactive-programming-in-react-with-rxjs).\n\n### Features and Capabilities\nThis example showcases several advanced features, including real-time chart updates, dynamic switching between candlestick and OHLC series, and the visualization of large trades above a $25,000 threshold with custom bubble renderings. It also applies moving average filters on streaming data, as detailed in the [Moving Average Filter | JavaScript Chart Documentation - SciChart](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/data-filters-api/moving-average-filter/). These capabilities highlight the customizability and performance strengths of SciChart.js when integrated within a React framework.\n\n### Integration and Best Practices\nThe integration follows best practices for React by encapsulating the SciChart surface and controls in reusable components and managing state through hooks. The use of `<SciChartReact/>` ensures a smooth React integration as demonstrated in [React Charts with SciChart.js: Introducing “SciChart React”](https://www.scichart.com/blog/react-charts-with-scichart-js/). Real-time WebSocket data is efficiently managed with RxJS, aligning with guidelines from [The complete guide to WebSockets with React](https://ably.com/blog/websockets-react-tutorial). Additionally, the example implements animated transitions for axis range updates, a technique explored in [Axis Ranging - How to Listen to VisibleRange Changes](https://www.scichart.com/documentation/js/v5/2d-charts/axis-api/ranging-scaling/listen-to-visible-range-changes/). Together, these practices ensure optimal performance and a seamless user experience.",
            },
            angular: {
                subtitle:
                    "Connects to Binance Exchange to fetch historical data on 1-minute timeframe. Subscribes to WebSocket and listens to candles & trades. Candles are updated in realtime. You can zoom, pan the example or use tooltips. ***Large trades > $25,000 size are plotted as bubbles.***",
