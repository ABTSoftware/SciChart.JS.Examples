...
const metaData: IExampleMetadata =
    ...
    {
        reactComponent: "PaneManagement",
        id: "chart2D_createStockCharts_PaneManagement",
        imagePath: "pane-management.jpg",
        description:
        ...
        path: "multi-pane-management",
        metaKeywords: "multi-pane, stock, chart, javascript, webgl, canvas",
        onWebsite: true,
        filepath: "Charts2D/CreateStockCharts/PaneManagement",
        thumbnailImage: "pane-management.jpg",
        sandboxConfig: {},
