...
import { metaData } from "./MetaDataMetadata";
...
export const oldmetaDataExampleInfo: TExampleInfo = {
    onWebsite: true,
...
export const metaDataExampleInfo = createExampleInfo(metaData as IExampleMetadata);
