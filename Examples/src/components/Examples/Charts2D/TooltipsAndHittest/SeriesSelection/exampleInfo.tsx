    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "# Series Selection Example - Vanilla JavaScript\n\n## Overview\nThis example demonstrates how to implement interactive series selection and hover events in SciChart.js using vanilla JavaScript. Multiple renderable series are added to a chart and enhanced with custom event handlers to provide visual feedback when a series is hovered or selected. Developers can learn more about these capabilities by exploring the [Series Selection](https://www.scichart.com/documentation/js/current/SeriesSelection.html) documentation and the [SeriesSelectionModifier](https://www.scichart.com/documentation/js/current/typedoc/classes/seriesselectionmodifier.html) API reference.\n\n## Technical Implementation\nThe chart is initialized by calling SciChartSurface.create with a WebAssembly context, and NumericAxis components are added to provide dynamic scaling with a customizable NumberRange. Custom hover and selection event handlers are implemented to adjust the opacity and stroke color of each series. In particular, the example uses [GenericAnimation](https://www.scichart.com/documentation/js/current/Generic%20Animations.html) to smoothly transition visual properties when series are hovered, while other series are dimmed to emphasize the active one. Annotations such as TextAnnotation are added to display instructions and, together with a LegendModifier, help provide context to the data.\n\n## Features and Capabilities\nThis example highlights several advanced features of SciChart.js including:\n\n- **Interactive Series Selection**: Implemented via the SeriesSelectionModifier, enabling both hover and click-based selection events.\n- **Custom Animations**: Smooth transitions for visual feedback are achieved using GenericAnimation, allowing dynamic changes in opacity and stroke color.\n- **Annotations and Legends**: A text annotation provides user guidance while a legend is integrated using the LegendModifier for clear data series labeling.\n- **Resource Management**: The chart instance is properly disposed of using the delete method on the SciChartSurface, following best practices detailed in the [Getting Started with SciChart JS](https://www.scichart.com/getting-started/scichart-javascript/) guide.\n\n## Integration and Best Practices\nWhile this example is implemented using vanilla JavaScript, it demonstrates patterns that are easily transferable to frameworks like React, Angular, or Vue. Developers are encouraged to follow efficient performance practices by leveraging the WebAssembly context (wasmContext) for processing large datasets, as showcased in the [SciChart.js Performance Demo](https://www.scichart.com/blog/scichart-js-performance-demo-1-million-datapoints-70ms/). Additionally, proper initialization and disposal of chart resources, as described in the [SciChartSurface API Documentation](https://www.scichart.com/documentation/js/current/typedoc/classes/scichartsurface.html), ensure that applications remain responsive and free of memory leaks.\n\nThis comprehensive example serves as a practical guide for adding interactivity and advanced visual customizations to SciChart.js charts using plain JavaScript while adhering to best practices for performance optimization and resource management.",
            },
            react: {
                subtitle:
                    "Demonstrates how to add **Series Selection** to a chart using SciChart.js, High Performance JavaScript Charts",
            ...
            angular: {
                ...
                markdownContent:
                    "# Using Series Selection in Angular\n\n## Overview\nThe Series Selection example in Angular demonstrates how to integrate SciChart.js to create highly interactive charts with dynamic hover and selection effects. The example illustrates how custom callbacks and animations can be used to provide immediate visual feedback when a chart series is hovered over or selected.\n\n## Technical Implementation\nIn this example, a SciChartSurface is initialized by creating numeric X and Y axes and adding multiple spline line series. Each series is configured with custom callbacks—onHoveredChanged and onSelectedChanged—to handle interactivity. Hovering over a series triggers a smooth opacity transition using the [GenericAnimation](https://www.scichart.com/documentation/js/current/Generic%20Animations.html) API, while selection changes the series’ stroke color to enhance visual distinction. The use of [Series Selection](https://www.scichart.com/documentation/js/current/SeriesSelection.html) modifiers streamlines the process of enabling these interactions without relying on the Builder API, thereby offering developers explicit control over the chart components.\n\n## Features and Capabilities\nThis Angular example provides several advanced features such as:\n- **Dynamic Hover Effects:** When a series is hovered, its opacity is animated to full visibility, while non-hovered series are dimmed, ensuring clear focus on the active series.\n- **Interactive Series Selection:** Click events update the series visual style by changing its stroke using custom selection callbacks, enhancing user interaction.\n- **Annotations and Legends:** Text annotations and integrated legends are added to improve data interpretation and chart usability.\n\n## Integration and Best Practices\nOptimized for Angular, this example adheres to best practices for real-time chart rendering and interactive event management. It leverages Angular’s component structure to cleanly encapsulate the chart initialization logic. Developers looking to create dynamic, high-performance charts in Angular can reference the [Angular Column Chart demo](https://demo.scichart.com/angular/column-chart) for further insights. Additionally, the example demonstrates effective performance optimization techniques by using smooth [GenericAnimation](https://www.scichart.com/documentation/js/current/Generic%20Animations.html) transitions and efficient event handling, which are critical for handling real-time data interactions and ensuring a responsive user interface. For more detailed guidance on integrating and configuring interactive chart features, consult the [Performance Tips](https://www.scichart.com/documentation/js/current/Performance%20Tips.html) and [Angular Chart Features](https://www.scichart.com/javascript-chart-features/) documentation.\n\n## Conclusion\nThis example clearly illustrates how to implement Series Selection in an Angular environment with SciChart.js. It combines interactive hover and selection events with real-time animations and intuitive chart customizations, making it a valuable reference for developers aiming to build robust, interactive charting applications with Angular.",
            },
        },
        documentationLinks: [
            {
