    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Using Rollover Modifier Tooltips with JavaScript\n\n### Overview\nThis example demonstrates how to create an interactive chart using SciChart.js in a pure JavaScript environment. It showcases the creation of a `SciChartSurface` with customized numeric axes, data series rendered from Fourier series data, and advanced interactivity through custom tooltip behaviors.\n\n### Technical Implementation\nThe chart is initialized by asynchronously creating a `SciChartSurface` and setting up numeric axes with properties such as `growBy`, `labelFormat`, and `labelPrecision` (see the [NumericAxis documentation](https://www.scichart.com/documentation/js/v4/2d-charts/axis-api/axis-types/numeric-axis/) for more details). Three separate `FastLineRenderableSeries` are added, each using an `EllipsePointMarker` to draw data points. Custom tooltip templates and legends are implemented by configuring a `RolloverModifier`, which overrides the default tooltip behavior as detailed in the [RolloverModifier documentation](https://www.scichart.com/documentation/js/v4/2d-charts/chart-modifier-api/rollover-modifier/). Additional interactive behaviors are provided with zooming and panning modifiers such as `ZoomPanModifier`, `ZoomExtentsModifier`, and `MouseWheelZoomModifier` (refer to the [ZoomPanModifier documentation](https://www.scichart.com/documentation/js/v4/2d-charts/chart-modifier-api/zooming-and-panning/zoom-pan-modifier/) for implementation guidance). WebAssembly is leveraged via the `wasmContext` to enhance performance, with more optimization techniques described in the [Performance Tips & Tricks documentation](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/performance-tips-and-tricks/).\n\n### Features and Capabilities\nThis example highlights advanced features including real-time tooltip customization and dynamic legend templates. The custom tooltips display formatted x and y values along with a tailored legend rendered using inline SVG, enhancing data readability. Such capabilities are critical for interactive data analysis and can be further explored in the [Adding Tooltips and Legends tutorial](https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-07-adding-tooltips-and-legends/).\n\n### Integration and Best Practices\nThe implementation follows best practices in resource management by providing a dedicated destructor that calls `sciChartSurface.delete()` to properly dispose of the chart instance, as recommended in the [Memory Best Practices](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/memory-best-practices/) guide. By integrating Fourier series data with custom point markers and interactivity through various chart modifiers, the example offers a comprehensive solution without relying on any framework-specific hooks or builder APIs. Developers can refer to the [SciChart.js User Manual](https://www.scichart.com/documentation/js/v4/intro/) for further insights on extending these techniques.",
            },
            react: {
                subtitle:
                    "Demonstrates how to create **tooltips on mouse-over** using SciChart.js, High Performance JavaScript Charts",
