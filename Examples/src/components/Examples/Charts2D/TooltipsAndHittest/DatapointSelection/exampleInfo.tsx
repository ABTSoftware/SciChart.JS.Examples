    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Datapoint Selection – Vanilla JavaScript\n\n### Overview\nThis example demonstrates how to implement data point selection in SciChart.js using vanilla JavaScript. The example creates several spline line series with simulated data and enables interactive selection of data points. It leverages the SciChart.js core components such as axes, renderable series, annotations, and modifiers to provide a rich, interactive charting experience.\n\n### Technical Implementation\nThe chart is set up by creating a SciChartSurface with a WebAssembly context (see [Creating a new SciChartSurface and loading Wasm](https://www.scichart.com/documentation/js/current/SciChartSurface.create%20and%20createSingle.html) for more details). Two numeric axes are added to the surface and a number of spline line renderable series are created using an XY data series. Each series uses custom point markers styled according to an automatic color scheme. In addition, a custom data label provider built with the LineSeriesDataLabelProvider is implemented to conditionally display labels only for selected points based on metadata. For handling data point selection, the [DataPointSelectionModifier](https://www.scichart.com/documentation/js/current/typedoc/classes/datapointselectionmodifier.html) is added to the chart. Its event subscription mechanism is used to update a table of selected points via a callback when selection changes occur. The example also makes use of the [DataPointSelectionPaletteProvider](https://www.scichart.com/example/javascript-chart/javascript-datapoint-selection/) to customize the stroke and fill of selected data points.\n\n### Features and Capabilities\nThis chart supports interactive selection via click, CTRL+CLICK, and click & drag actions. Selected data points display custom data labels that include the x and y values, and are visually distinguished by a custom palette. The example also includes text annotations (configured with [TextAnnotation](https://www.scichart.com/documentation/js/current/TextAnnotation.html)) to guide the user, and a legend provided by the [LegendModifier](https://www.scichart.com/documentation/js/current/LegendModifier.html) to give context to the rendered series. Overall, the example illustrates how multiple renderable series can be enhanced with conditional data labels, palette customization, and interactive selection behavior.\n\n### Integration and Best Practices\nEven though this example is implemented in vanilla JavaScript, it demonstrates several best practices applicable across different frameworks. It uses the native event subscription model provided by SciChart.js modifiers (see [Common ChartModifiers Features](https://www.scichart.com/documentation/js/current/Common%20ChartModifiers%20Features.html)) and leverages the high-performance WebAssembly context for rendering. Developers can use these techniques to efficiently manage real-time interactions and achieve optimal performance when handling multiple series and complex user interactions. Overall, the implementation provides a solid foundation that can be extended or integrated into larger applications.",
            },
            react: {
                subtitle:
                    "Demonstrates how to **Select Data Points** on a chart using SciChart.js, High Performance JavaScript Charts",
