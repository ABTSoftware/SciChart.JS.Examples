    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            ...
            angular: {
                ...
                markdownContent:
                    "# Zoom and Pan a Realtime Angular Chart\n\n## Overview\nThis example demonstrates a real-time chart in an Angular application using SciChart.js. The purpose is to display continuously updating sine and cosine data while allowing the user to interact with the chart through zooming and panning.\n\n## Technical Implementation\nThe implementation uses a standalone Angular component that integrates the [SciChartAngularComponent](https://www.scichart.com/getting-started/scichart-javascript/) for chart rendering. The chart is asynchronously initialized via the drawExample function, which creates a SciChartSurface with an associated WebAssembly context. It sets up numeric axes, a line series, and a scatter series, and assigns interactive modifiers such as the [RubberBandXyZoomModifier](https://www.scichart.com/documentation/js/current/ZoomPanModifier.html) for zooming and the [ZoomPanModifier](https://www.scichart.com/documentation/js/current/ZoomPanModifier.html) for right-click panning. Real-time data updates are implemented using setInterval at approximately 60Hz, reflecting best practices discussed in the [Adding Realtime Updates](https://www.scichart.com/documentation/js/current/Tutorial%2004%20-%20Adding%20Realtime%20Updates.html) tutorial.\n\n## Features and Capabilities\nThe example offers advanced real-time capabilities by dynamically appending new data points to both the sine (line) and cosine (scatter) series. It automatically adjusts the visible range of the x-axis when the user is not actively zooming, ensuring smooth performance and a responsive update mechanism, as explained in [Performance Optimisation of JavaScript Applications & Charts](https://www.scichart.com/blog/performance-optimisation-of-javascript-applications-charts/).\n\n## Integration and Best Practices\nThe Angular integration leverages standalone components as detailed in the [Angular Standalone Components](https://angular.io/guide/standalone-components) guide. Using Angular input bindings, the chart initialization function is passed to the SciChartAngularComponent, enabling asynchronous creation of the chart. Additionally, careful attention is paid to lifecycle management, ensuring appropriate resource cleanup and efficient real-time rendering in accordance with [Component Lifecycle - Angular](https://angular.io/guide/lifecycle-hooks). This example serves as a robust template for integrating high-performance, interactive charts within Angular applications using SciChart.js.",
            },
        },
        documentationLinks: [
            {
