...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        description: "Demonstrates the **DateTimeNumericAxis** with 64-bit precision, handling ranges from Nanoseconds to Billions of Years.",
        tips: [],
        frameworks: {
            javascript: {
                subtitle: "Demonstrates the **DateTimeNumericAxis** with 64-bit precision, handling ranges from Nanoseconds to Billions of Years.",
                title: "High Precision Date Axis",
                pageTitle: "High Precision Date Axis",
                metaDescription: "Demonstrates 64-bit precision Date Axis in SciChart.js handling Nanoseconds to Billions of Years",
                markdownContent:
