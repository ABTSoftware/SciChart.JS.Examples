...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                subtitle:
                    "Demonstrates a custom modifier adds a dynamic overview for multiple subcharts using SciChart.js, High Performance JavaScript Charts",
                title: "Overview For SubCharts",
                pageTitle: "Overview For SubCharts",
                metaDescription: "Demonstrates a custom modifier adds a dynamic overview for multiple subcharts.",
                markdownContent: "",
            },
            react: {
                subtitle:
                ...
                title: "Overview For SubCharts",
                pageTitle: "Overview For SubCharts",
                metaDescription: "Demonstrates a custom modifier which adds a dynamic overview for multiple subcharts.",
                markdownContent: "",
            },
            angular: {
                subtitle:
