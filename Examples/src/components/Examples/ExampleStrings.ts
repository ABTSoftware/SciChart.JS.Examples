...
export const ExampleStrings = {
    ...
    //
    // Data Animation
    urlDataAnimation: (framework: EPageFramework) => `/${framework}-data-animation`,
    ...
    // Style Animation
    urlStyleAnimation: (framework: EPageFramework) => `/${framework}-style-animation`,
    ...
    // OnStart Animation
    urlStartupAnimation: (framework: EPageFramework) => `/${framework}-startup-animation`,
    ...
    // Generic Animations
    urlGenericAnimation: (framework: EPageFramework) => `/${framework}-generic-animation`,
    titleGenericAnimation: `JavaScript Generic Animation`,
    urlTitleGenericAnimation: `JavaScript Generic Animation`,
    ...
    // Scatter chart
    urlScatterChart: (framework: EPageFramework) => `/${framework}-scatter-chart`,
    ...
    // Band chart
    urlBandChart: (framework: EPageFramework) => `/${framework}-band-chart`,
    ...
    urlSplineBandChart: (framework: EPageFramework) => `/${framework}-spline-band-chart`,
    ...
    // Digital Band chart
    urlDigitalBandChart: (framework: EPageFramework) => `/${framework}-digital-band-chart`,
    ...
    // Bubble Chart
    urlBubbleChart: (framework: EPageFramework) => `/${framework}-bubble-chart`,
    ...
    // Column Chart
    urlColumnChart: (framework: EPageFramework) => `/${framework}-column-chart`,
    ...
    // Error Bars Chart
    urlErrorBarsChart: (framework: EPageFramework) => `/${framework}-error-bars-chart`,
    ...
    // Impulse Chart
    urlImpulseChart: (framework: EPageFramework) => `/${framework}-impulse-chart`,
    ...
    urlMountainChart: (framework: EPageFramework) => `/${framework}-mountain-chart`,
    ...
    urlRealtimeMountainChart: (framework: EPageFramework) => `/${framework}-realtime-mountain-chart`,
    ...
    urlSplineMountainChart: (framework: EPageFramework) => `/${framework}-spline-mountain-chart`,
    ...
    urlDigitalMountainChart: (framework: EPageFramework) => `/${framework}-digital-mountain-chart`,
    ...
    // Candlestick Chart
    urlCandlestickChart: (framework: EPageFramework) => `/${framework}-candlestick-chart`,
    ...
    // Ohlc Chart
    urlOhlcChart: (framework: EPageFramework) => `/${framework}-ohlc-chart`,
    ...
    // Fan Chart
    urlFanChart: (framework: EPageFramework) => `/${framework}-fan-chart`,
    ...
    // Line Chart
    urlLineChart: (framework: EPageFramework) => `/${framework}-line-chart`,
    ...
    urlSplineLineChart: (framework: EPageFramework) => `/${framework}-spline-line-chart`,

    // Digital Line Chart
    urlDigitalLineChart: (framework: EPageFramework) => `/${framework}-digital-line-chart`,
    ...
    urlPieChart: (framework: EPageFramework) => `/${framework}-pie-chart`,
    urlTitlePieChart: `The JavaScript Pie Chart example demonstrates how to create an animated Pie Chart with SciChart.js`,
    titlePieChart: `JavaScript Pie Chart`,
    pageTitlePieChart: `JavaScript Pie Chart | JavaScript Chart Examples | SciChart`,

    // Donut Chart
    urlDonutChart: (framework: EPageFramework) => `/${framework}-donut-chart`,
    ...
    urlStackedColumnChart: (framework: EPageFramework) => `/${framework}-stacked-column-chart`,
    ...
    urlGroupedColumnChart: (framework: EPageFramework) => `/${framework}-stacked-grouped-column-chart-side-by-side`,
    ...
    urlStackedMountainChart: (framework: EPageFramework) => `/${framework}-stacked-mountain-chart`,
    ...
    // Heatmap Chart
    urlHeatmapChart: (framework: EPageFramework) => `/${framework}-heatmap-chart`,
    ...
    urlNonUniformHeatmapChart: (framework: EPageFramework) => `/${framework}-non-uniform-heatmap-chart`,
    ...
    urlContourChart: (framework: EPageFramework) => `/${framework}-heatmap-chart-with-contours`,

    // Annotations are easy
    urlAnnotationsAreEasy: (framework: EPageFramework) => `/${framework}-chart-annotations`,
    ...
    urlEditableAnnotations: (framework: EPageFramework) => `/editable-annotations`,
    ...
    // Trademarkers
    urlTradeMarkers: (framework: EPageFramework) => `/${framework}-stock-chart-buy-sell-markers`,
    titleTradeMarkers: `Trading Buy Sell Marker Annotations`,
    urlTitleTradeMarkers: `The Trade Markers example demonstrates how to add buy/sell arrows and markers to a trading application`,

    // Drag horizontal threshold
    titleDragHorizontalThreshold: `JavaScript Chart Drag Horizontal Threshold`,
    urlDragHorizontalThreshold: (framework: EPageFramework) => `/${framework}-chart-drag-horizontal-threshold`,
    ...
    urlBackgroundAnnotations: (framework: EPageFramework) => `/${framework}-chart-background-annotations`,
    titleBackgroundAnnotations: `Quadrant chart using Background Annotations`,

    // Use Pointmarkers
    urlPointMarkers: (framework: EPageFramework) => `/${framework}-chart-custom-pointmarkers`,
    ...
    urlMultiPaneStockChart: (framework: EPageFramework) => `/${framework}-multi-pane-stock-charts-sync-technique`,
    ...
    urluSubChartStockChart: (framework: EPageFramework) => `/${framework}-multi-pane-stock-charts`,
    ...
    // Subcharts Grid
    urlSubChartsGrid: (framework: EPageFramework) => `/${framework}-subcharts-grid`,
    ...
    urlRealtimeTickingStockCharts: (framework: EPageFramework) => `/${framework}-realtime-ticking-stock-charts`,
    ...
    // Depth chart
    urlDepthChart: (framework: EPageFramework) => `/${framework}-depth-chart`,
    titleDepthChart: `JavaScript Market Depth Chart`,

    // Chart Legends
    urlChartLegends: (framework: EPageFramework) => `/${framework}-chart-legends`,
    ...
    // Multiple XAxis
    urlMultipleXAxis: (framework: EPageFramework) => `/${framework}-chart-with-multiple-x-axis`,
    ...
    // Secondary YAxis
    urlSecondaryYAxis: (framework: EPageFramework) => `/${framework}-chart-with-secondary-y-axis`,
    ...
    // Logarithmic Axis
    urlLogarithmicAxis: (framework: EPageFramework) => `/${framework}-chart-logarithmic-axis`,
    ...
    urlVerticalCharts: (framework: EPageFramework) => `/${framework}-vertical-charts`,
    ...
    urlCentralAxes: (framework: EPageFramework) => `/${framework}-central-axes`,
    ...
    urlVerticallyStackedAxes: (framework: EPageFramework) => `/${framework}-vertically-stacked-axes`,
    ...
    urlDragAxisToScale: (framework: EPageFramework) => `/${framework}-chart-drag-axis-to-scale-pan`,
    ...
    urlDrawBehindAxes: (framework: EPageFramework) => `/${framework}-draw-behind-axes`,
    ...
    urlAxisLayout: (framework: EPageFramework) => `/${framework}-chart-axis-layout-options`,
    ...
    urlChartTitle: (framework: EPageFramework) => `/${framework}-chart-title`,

    // Realtime Zoom Pan
    titleRealtimeZoomPan: `Zoom and Pan a Realtime JavaScript Chart`,
    urlRealtimeZoomPan: (framework: EPageFramework) => `/zoom-pan-realtime-javascript-chart`,

    // Multiple Zoom Pan Modifiers
    titleZoomPanWithMultipleChartModifiers: `Zoom and Pan with multiple Chart Modifiers`,
    urlZoomPanWithMultipleChartModifiers: (framework: EPageFramework) => `/zoom-pan-multiple-modifiers`,
    ...
    urlPaletteProvider: (framework: EPageFramework) =>
        `/${framework}-chart-color-points-individually-with-paletteprovider`,
    ...
    urlDashedLineStyling: (framework: EPageFramework) => `/${framework}-dashed-line-chart`,
    ...
    // Styling in code
    urlStylingInCode: (framework: EPageFramework) => `/${framework}-chart-styling-theming-in-code`,
    ...
    urlTransparentBackground: (framework: EPageFramework) => `/${framework}-chart-transparent-background`,
    ...
    // ThemeManager
    urlThemeManager: (framework: EPageFramework) => `/${framework}-chart-themes`,
    ...
    urlCustomTheme: (framework: EPageFramework) => `/${framework}-chart-custom-themes`,
    ...
    urlHitTestApi: (framework: EPageFramework) => `/${framework}-chart-hit-test-on-click`,
    ...
    urlDataPointSelection: (framework: EPageFramework) => `/${framework}-datapoint-selection`,
    ...
    urlRolloverModifier: (framework: EPageFramework) => `/${framework}-chart-rollovermodifier-tooltips`,
    ...
    urlVerticalSliceModifier: (framework: EPageFramework) => `/${framework}-chart-vertical-slice-modifier`,
    ...
    urlSeriesSelection: (framework: EPageFramework) => `/${framework}-chart-series-selection`,

    // CursorModifier
    urlCursorModifier: (framework: EPageFramework) => `/${framework}-chart-cursormodifier-crosshairs`,
    ...
    // MetaData
    titleMetaData: `Datapoint Metadata Tooltips`,
    urlMetaData: (framework: EPageFramework) => `/${framework}-chart-metadata`,
    ...
    // 3D Bubble Chart
    urlBubble3DChart: (framework: EPageFramework) => `/${framework}-3d-bubble-chart`,
    ...
    urlSurfaceMesh3D: (framework: EPageFramework) => `/${framework}-3d-surface-mesh-chart`,
    ...
    urlRealtimeSurfaceMesh3D: (framework: EPageFramework) => `/${framework}-realtime-3d-surface-mesh-chart`,
    ...
    urlPointLine3DChart: (framework: EPageFramework) => `/${framework}-3d-point-line-chart`,
    ...
    urlLidarFeaturedApp: (framework: EPageFramework) => `/${framework}-3d-lidar-visualization`,
    ...
    urlLoad500By500: (framework: EPageFramework) => `/load-500-series-x-500-points-performance-demo`,
    ...
    urlLoadOneMillionPoints: (framework: EPageFramework) => `/${framework}-chart-performance-load-one-million-points`,

    // Featured Apps Performance Demo
    urlRealtimeJavaScriptChartDemo: (framework: EPageFramework) => `/${framework}-chart-realtime-performance-demo`,
    ...
    urlRealtimeGhostedTraces: (framework: EPageFramework) => `/${framework}-realtime-ghosted-traces-chart`,
    ...
    urlVitalSigns: (framework: EPageFramework) => `/${framework}-vital-signs-ecg-medical-chart-example`,

    // Featured Apps Audio Analyzer
    titleAudioAnalyzerFeaturedApp: `Realtime Audio Analyzer Demo`,
    urlAudioAnalyzerFeaturedApp: (framework: EPageFramework) => `/${framework}-audio-analyzer-fft-example`,

    // Featured Apps Tenor Curves
    titleTenorCurvesFeaturedApp: `Tenor Curves Demo`,
    urlTenorCurvesFeaturedApp: (framework: EPageFramework) => `/${framework}-2d-3d-chart-tenor-curves-example`,

    // Showcases RealtimeBigData Demo
    urlRealtimeBigDataJavaScriptChartDemo: (framework: EPageFramework) => `/${framework}-chart-websocket-bigdata-demo`,
    titleRealtimeBigDataJavaScriptChartDemo: `Client/Server Websocket Data Streaming`,

    // ServerTrafficDashboards Demo
    urlServerTrafficDashboard: (framework: EPageFramework) => `/${framework}-server-traffic-dashboard`,
    titleServerTrafficDashboard: `Server Traffic Dashboard`,

    // BuilderApi, Simple Chart
    urlBuilderSimpleChart: (framework: EPageFramework) => `/${framework}-builder-simple`,
    titleBuilderSimpleChart: `Simple Chart using Builder API`,

    // BuilderApi, Full Chart
    urlBuilderFullChart: (framework: EPageFramework) => `/${framework}-builder-full`,
    titleBuilderFullChart: `Full Chart using Builder API`,

    // BuilderApi, Chart From JSON
    urlChartFromJSON: (framework: EPageFramework) => `/${framework}-chart-from-json`,
    ...
    urlCustomTypes: (framework: EPageFramework) => `/${framework}-custom-types`,
    titleCustomTypes: `Custom Types with Builder API`,

    // BuilderApi, Shared Data
    urlSharedData: (framework: EPageFramework) => `/reusable-templates-using-shared-data`,
    ...
    // Multi Line labels
    urlMultiLineLabels: (framework: EPageFramework) => `/${framework}-multiline-labels`,
    ...
    // Image labels
    urlImageLabels: (framework: EPageFramework) => `/${framework}-image-labels`,
    ...
    // Rotated labels
    urlRotatedLabels: (framework: EPageFramework) => `/${framework}-rotated-labels`,
    ...
    urlPercentageChange: (framework: EPageFramework) => `/${framework}-percentage-change`,
    ...
    urlTrendMARatio: (framework: EPageFramework) => `/${framework}-trend-ma-ratio`,
    ...
    urlCustomFilters: (framework: EPageFramework) => `/${framework}-custom-filters`,
    ...
    // Overview
    urlOverview: (framework: EPageFramework) => `/${framework}-overview`,
    ...
    // SyncMultiChart
    urlSyncMultiChart: (framework: EPageFramework) => `/${framework}-sync-multi-chart`,
    ...
    urlOilAndGasExplorerDashboard: (framework: EPageFramework) => `/${framework}-oil-and-gas-dashboard-showcase`,

    // Datalabels
    urlDatalabels: (framework: EPageFramework) => `/${framework}-datalabels`,
    ...
    urlVirtualizedData: (framework: EPageFramework) => `/${framework}-chart-with-virtualized-data`,
    titleVirtualizedData: `Virtualized JS Charts: Load Data on Zoom/Pan`,

    urlHeatmapInteractionsData: (framework: EPageFramework) => `/${framework}-heatmap-interactions`,
    titleHeatmapInteractionsData: `Rich Interactions Showcase`,

    urlDynamicLayout: (framework: EPageFramework) => `/${framework}-dynamic-layout`,
    titleDynamicLayout: `Dynamic Layout Showcase`,

    urlEventMarkers: (framework: EPageFramework) => `/${framework}-dragabble-event-markers`,
    titleEventMarkers: `Dragabble Event Markers`,

    urlTextChart: (framework: EPageFramework) => `/${framework}-text-chart`,
