...
export const ExampleStrings = {
    ...
    //
    urlDocumentationHome: `https://www.scichart.com/documentation/js/v4/intro/`,
    ...
    urlTutorialsHome: `https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-01-setting-up-npm-project-with-scichart-js/`,
    ...
    urlRenderSeriesPropertiesDocumentation: `https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/renderable-series-api-overview/`,
    urlTitleRenderSeriesProperties: `Learn about common RenderableSeries properties in SciChart.js`,
    urlPerformanceTipsDocumentation: `https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/performance-tips-and-tricks/`,
    ...
    urlDataAnimationDocumentation: `https://www.scichart.com/documentation/js/v4/2d-charts/animations-api/dataset-animations/`,
    ...
    urlStyleAnimationDocumentation: `https://www.scichart.com/documentation/js/v4/2d-charts/animations-api/style-transition-animations/`,
    ...
    urlStartupAnimationDocumentation: `https://www.scichart.com/documentation/js/v4/2d-charts/animations-api/series-startup-animations/`,
    ...
    urlGenericAnimationDocumentation: `https://www.scichart.com/documentation/js/v4/2d-charts/animations-api/generic-animations/`,
    ...
    urlScatterChartDocumentation: `https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/xy-scatter-renderable-series/`,
