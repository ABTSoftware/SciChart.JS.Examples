    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    '## Column 3D Chart with JavaScript\n\n### Overview\nThis example, titled "Column 3D Chart", demonstrates how to create and dynamically update a fully interactive 3D column chart using SciChart.js in JavaScript. The example showcases how to configure a 3D chart environment without the need for additional frameworks or hooks.\n\n### Technical Implementation\nThe implementation begins by creating a SciChart3DSurface along with a WebAssembly context using the method [SciChart3DSurface.create()](https://www.scichart.com/documentation/js/v5/3d-charts/scichart-3d-basics/scichart-3d-basics-overview/). The camera is configured using a [CameraController](https://www.scichart.com/documentation/js/v5/3d-charts/scichart-3d-basics/scichart-surface-camera/) along with [Vector3](https://www.scichart.com/documentation/js/v5/typedoc/classes/vector3.html) to set the position and target of the 3D view. Three numeric axes are created using [NumericAxis3D](https://www.scichart.com/documentation/js/v5/typedoc/classes/numericaxis3d.html) to define the chart’s X, Y, and Z dimensions. Data is managed with an [XyzDataSeries3D](https://www.scichart.com/documentation/js/v5/typedoc/classes/xyzdataseries3d.html) and displayed through a [ColumnRenderableSeries3D](https://www.scichart.com/documentation/js/v5/typedoc/classes/columnrenderableseries3d.html). The code also implements dynamic data updates with functions that interpolate colors (using functions such as parseColorToTArgb and toHex) and update metadata for thousands of points. Interaction is enhanced by enabling modifiers such as [MouseWheelZoomModifier3D](https://www.scichart.com/documentation/js/v5/typedoc/classes/mousewheelzoommodifier3d.html) and [OrbitModifier3D](https://www.scichart.com/documentation/js/v5/3d-charts/chart-modifier-3d-api/zooming-and-panning/orbit-modifier-3d/) which facilitate zooming and orbiting in the 3D scene.\n\n### Features and Capabilities\nThis example highlights key features including real-time dynamic data updates, advanced visualization customization like switching between different 3D point marker types (Cylinder, Cube, Pyramid, Sphere), and fine control over column dimensions via properties such as dataPointWidthX and dataPointWidthZ. Different color modes are available (X, XZ, Height, Series) which enable developers to adjust the visual appearance of the chart by dynamically assigning metadata colors based on position or value.\n\n### Integration and Best Practices\nThe example is implemented entirely in plain JavaScript, ensuring simplicity and ease of integration into any web application without the overhead of frameworks like React. The initialization process leverages [SciChart3DSurface.create()](https://www.scichart.com/documentation/js/v5/3d-charts/scichart-3d-basics/scichart-3d-basics-overview/) for optimal setup and includes performance optimizations through efficient data-series updates and the use of a WebAssembly context. Developers are encouraged to refer to the [API documentation for SciChart.js](https://www.scichart.com/documentation/js/v5/typedoc/index.html) and the [Memory Best Practices](https://www.scichart.com/documentation/js/v5/2d-charts/performance-tips/memory-best-practices/) guide for additional techniques on optimizing performance in 3D charts.',
            },
            react: {
                subtitle:
