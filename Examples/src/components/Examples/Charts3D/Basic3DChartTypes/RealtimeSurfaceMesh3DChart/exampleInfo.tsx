    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Realtime Surface Mesh 3D Chart (JavaScript)\n\n### Overview\nThis example demonstrates how to build a **real-time 3D surface mesh chart** using SciChart.js in a JavaScript environment. The chart dynamically updates its mesh data by recalculating a heightmap at regular intervals, providing a fluid, animated visualization of mathematical functions.\n\n### Technical Implementation\nThe chart is constructed by creating a SciChart3DSurface and configuring a 3D camera with the [CameraController](https://www.scichart.com/documentation/js/v4/3d-charts/scichart-3d-basics/scichart-surface-camera/) and [Vector3](https://www.scichart.com/documentation/js/v4/typedoc/classes/vector3.html) to set its position and target. Three numeric axes (X, Y, and Z) are added using NumericAxis3D, and the data is managed through a UniformGridDataSeries3D that is initialized with a helper function (zeroArray2D). The data is updated in real time using the native JavaScript function setInterval, as described in the [Realtime Updates](https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-04-adding-realtime-updates/) documentation.\n\n### Features and Capabilities\nThe example includes several advanced features: \n- **Real-Time Updates**: The heightmap is recalculated every 20 milliseconds, showcasing dynamic data streaming.\n- **3D Surface Mesh Rendering**: The surface is rendered using a custom gradient color palette defined with GradientColorPalette, supporting smooth color transitions and contour effects; more details can be found in the [Surface Mesh 3D Chart Type](https://www.scichart.com/documentation/js/v4/3d-charts/chart-types/surface-mesh-3d/) guide.\n- **Chart Interactivity**: Interactivity modifiers such as [MouseWheelZoomModifier3D](https://www.scichart.com/documentation/js/v4/3d-charts/scichart-3d-basics/scichart-3d-basics-overview/), [OrbitModifier3D](https://www.scichart.com/documentation/js/v4/3d-charts/scichart-3d-basics/scichart-3d-basics-overview/), and [ResetCamera3DModifier](https://www.scichart.com/documentation/js/v4/3d-charts/scichart-3d-basics/scichart-3d-basics-overview/) let users effortlessly explore the 3D environment.\n\n### Integration and Best Practices\nThis implementation leverages JavaScript, ensuring that the chart library can be integrated into any standard web project without framework-specific overhead. Developers should consider [performance optimization techniques](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/performance-tips-and-tricks/) to handle rapid real-time updates efficiently. Additionally, using WebAssembly (via the wasmContext) further boosts performance as discussed in the [WebAssembly Integration](https://www.scichart.com/documentation/js/v4/2d-charts/surface/deploying-wasm/) documentation.\n\nBy focusing solely on JavaScript, this example highlights the core capabilities of SciChart.js for creating highly interactive, real-time 3D visualizations with minimal overhead.",
            },
            react: {
                subtitle:
