...
const exampleImage = "javascript-realtime-3d-surface-mesh-chart.jpg";
...
const Subtitle = () => (
    <p>
        Learn how to create a realtime updating <strong>JavaScript 3D Surface Mesh Chart</strong> using SciChart.js, and our {" "}
