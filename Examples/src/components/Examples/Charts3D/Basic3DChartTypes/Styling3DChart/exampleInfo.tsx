...
const metaData: IExampleMetadata =
    ...
    {
        reactComponent: "Styling3DChart",
        id: "chart3D_basic3DChartTypes_Styling3DChart",
        ...
        frameworks: {
            ...
            react: {
                ...
                markdownContent:
                    "## React 3D Styling Demo Chart\n\n### Overview\nThis example demonstrates the implementation of an advanced 3D Styling Demo in a React application using SciChart.js. The chart showcases comprehensive styling capabilities including multiple point marker types, axis styling controls, and interactive styling features. The example demonstrates how to create visually rich 3D charts with extensive customization options using the `<SciChartReact/>` component.\n\n### Technical Implementation\nThe 3D chart is initialized using the `<SciChartReact/>` component, which receives an initialization function (drawExample) that sets up the 3D surface, axes, and chart modifiers such as 3D camera controls (e.g., [MouseWheelZoomModifier3D](https://www.scichart.com/documentation/js/current/MouseWheelZoomModifier3D.html) and [OrbitModifier3D](https://www.scichart.com/documentation/js/current/OrbitModifier3D.html)). The chart features eight different [3D Point Scatter](https://www.scichart.com/documentation/js/v5/3d-charts/chart-types/scatter-3d-chart/) including EllipsePointMarker3D, TrianglePointMarker3D, SpherePointMarker3D, CubePointMarker3D, and more. Axis selection is shown by the label font color and plane selection uses axisPlaneBackgroundFill.\n\n### Features and Capabilities\nThe example implements advanced styling features including multiple point marker types with individual styling, comprehensive axis styling controls, and interactive plane visibility management. The styling controls include functions for axis plane visibility, label drawing modes, title positioning, grid bands, major grid lines, and label orientation modes. Each data point is rendered with unique metadata including custom colors and scaling factors, creating a visually diverse and informative 3D scatter plot.\n\n### Integration and Best Practices\nThe React integration leverages the `<SciChartReact/>` component to seamlessly incorporate high-performance WebGL charts with advanced styling capabilities into the React ecosystem. The implementation demonstrates best practices for modular styling control functions, and organized axis configuration. Developers are encouraged to explore the comprehensive styling API and reuse the modular control functions for creating highly customized 3D charts. The example serves as a template for building visually rich 3D applications with extensive styling options in React.",
            },
            angular: {
                subtitle:
                    "This demonstrates the **Angular 3D Styling capabilities** of SciChart.js v5, including axis label positioning, and control over 3d plane visibility",
        ...
        onWebsite: false,
        filepath: "Charts3D/Basic3DChartTypes/Styling3DChart",
...
export const Styling3DChartExampleInfo = createExampleInfo(metaData);
export default Styling3DChartExampleInfo;
