...
import {
    CameraController, HeatmapLegend,
    MouseWheelZoomModifier3D, NumericAxis3D,
    OrbitModifier3D, parseColorToUIntArgb, PointLineRenderableSeries3D,
    ResetCamera3DModifier,
    SciChart3DSurface, TGradientStop,
    Vector3, XyzDataSeries3D
} from "scichart";
