    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    '## Chart Title Example (JavaScript)\n\n### Overview\nThis example demonstrates how to configure a multi-line chart title in SciChart.js using JavaScript. The chart is initialized with a custom title, set to "Multiline\nChart Title", and styled with properties for font size, color, padding, and text alignment.\n\n### Technical Implementation\nThe chart is created by initializing a `SciChartSurface`, applying a custom theme, and setting up numeric axes with tailored axis titles via the `axis.axisTitleStyle` property (see [NumericAxis Documentation](https://www.scichart.com/documentation/js/v5/2d-charts/axis-api/axis-types/numeric-axis/)). A `FastLineRenderableSeries` is added using an `XyDataSeries` sourced from randomly generated data, which illustrates efficient handling of dynamic data sets as detailed in the [FastLineRenderableSeries documentation](https://www.scichart.com/documentation/js/v5/2d-charts/axis-api/axis-types/numeric-axis/). Dynamic update functions are provided to modify the title text, alignment, position, and other style properties in real-time, following the approaches recommended in the [Chart Styling - Chart Titles](https://www.scichart.com/documentation/js/v5/2d-charts/styling-and-theming/chart-titles/) guide.\n\n### Features and Capabilities\n- **Dynamic Updates:** The example includes functions to change the chart title and its alignment dynamically, demonstrating advanced customization techniques.\n- **Advanced Styling:** Title styling options such as font size, color, and padding are configurable, allowing for multi-line title adjustments as explained in the [Label Alignment and Positioning](https://www.scichart.com/documentation/js/v5/2d-charts/axis-api/axis-labels/label-style-alignment-and-positioning/) documentation.\n- **Efficient Rendering:** The use of `FastLineRenderableSeries` ensures optimized performance for rendering live data.\n\n### Integration and Best Practices\nAlthough the provided source code is wrapped in a React component for demonstration purposes, the core implementation leverages JavaScript for initializing and updating the chart. Developers can integrate this approach into any JavaScript application by following practices from the [Tutorial 01 - Including SciChart.js in an HTML Page using CDN](https://www.scichart.com/documentation/js/v5/get-started/tutorials-cdn/tutorial-01-using-cdn/). For further details on managing data series, refer to the [Working with Data](https://www.scichart.com/documentation/js/v5/2d-charts/builder-api/working-with-data/) section. Overall, this example illustrates how to combine efficient rendering, responsive updates, and advanced styling to create a powerful, high-performance chart using SciChart.js in a JavaScript environment.',
            },
            react: {
                subtitle:
                    "A Chart Title can be placed above, below, or either side of the chart, and be left, center or right aligned.",
