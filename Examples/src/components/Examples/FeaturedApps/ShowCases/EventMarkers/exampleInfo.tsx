...
const Subtitle = () => (
    <p>
        Demonstrates how to repurpose a Candlestick Series into dragabble, labled, event markers, using SciChart.js High Performance{" "}
...
export const eventMarkersExampleInfo: TExampleInfo = {
    ...
    pageTitle: ExampleStrings.titleEventMarkers + ExampleStrings.exampleGenericTitleSuffix,
