...
class CandleDragModifier extends ChartModifierBase2D {
    ...
    public onAttach(): void {
        ...
        this.annotation.dragDelta.subscribe(data => {
            if (this.selectedIndex >= 0) {
                ...
                this.dataSeries.updateXohlc(this.selectedIndex, 
                    newX,
                    this.annotation.y1,
    ...
    public modifierMouseUp(args: ModifierMouseArgs): void {
        ...
        const hitTestInfo = this.series.hitTestProvider.hitTest(
            point.x,
            point.y,
            0
        );
...
const drawExample = async () => {
    ...
    sciChartSurface.chartModifiers.add(
        ...
        new ZoomExtentsModifier({ onZoomExtents: (sciChartSurface: SciChartSurface) => {
    ...
    sciChartSurface.annotations.add(
        new TextAnnotation({
            ...
            text:
                "The boxes are rendered with a fast candlestick series, but can be selected and dragged like an annotation.",
