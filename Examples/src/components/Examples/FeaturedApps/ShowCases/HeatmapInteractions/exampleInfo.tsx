    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            ...
            angular: {
                ...
                markdownContent:
                    "## Interactive Wave Simulation Heatmap Demo in Angular\n\n### Overview\nThis example demonstrates a highly interactive 2D wave simulation implemented in Angular using SciChart.js. The application simulates dynamic heatmap data while incorporating multiple synchronized charts that include cross-sectional views, input drivers, and historical outputs. The simulation is enriched with interactive annotations and custom modifiers, allowing users to add, drag, and remove inputs and outputs seamlessly.\n\n### Technical Implementation\nThe Angular implementation leverages the `ScichartAngularComponent` from [scichart-angular](https://www.npmjs.com/package/scichart-angular) and `SciChartGroup` to initialize and synchronize multiple charts. The charts are created through the function returned by `getChartsInitializationApi()`, which sets up the main heatmap chart, cross section chart, input chart, and history chart with customized axes and data series. Custom modifiers, such as the `AddIOModifier` and `PointDragModifier`, extend the `ChartModifierBase2D` class to capture mouse events, perform hit testing, and implement drag-and-drop functionality. These custom modifiers enable users to interactively add annotations and update data in real-time. For instance, real-time heatmap updates are performed using a simulation loop with setTimeout, updating the `UniformHeatmapDataSeries`, and are implemented following the guidelines for [Adding Realtime Updates](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/data-series-api/realtime-updates/). High DPI support is achieved using `DpiHelper`, as documented in [Retina Support and Browser Zoom](https://www.scichart.com/documentation/js/v5/2d-charts/miscellaneous-apis/retina-support-and-browser-zoom/). Additionally, custom chart modifiers are built in line with the [Custom Chart Modifier API](https://www.scichart.com/documentation/js/v5/2d-charts/chart-modifier-api/custom-modifiers/custom-modifiers-overview/).\n\n### Features and Capabilities\nThe example provides several advanced features: \n- **Real-time Updates:** The 2D wave simulation continuously updates the heatmap data with dynamic visual effects, following techniques similar to those outlined in [Updating Uniform Heatmaps](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/uniform-heatmap-renderable-series/updating-realtime/).\n- **Interactive Annotations:** Users can add, resize, and drag annotations such as inputs, outputs, and axis markers, with smooth animation effects powered by GenericAnimation ([Generic Animations](https://www.scichart.com/documentation/js/v5/2d-charts/animations-api/generic-animations/)).\n- **Hit Testing and Drag Events:** Through the implementation of a custom `PointDragModifier`, the example demonstrates precise hit testing and drag event management, ensuring that data points can be modified interactively as explained in [Custom ChartModifiers docs](https://www.scichart.com/documentation/js/v5/2d-charts/chart-modifier-api/custom-modifiers/custom-modifiers-overview/).\n\n### Integration and Best Practices\nThis Angular integration showcases best practices by carefully managing chart lifecycle and synchronization. The use of `SciChartGroup` ensures that zooming, panning, and crosshair synchronization work seamlessly across multiple charts. The overall structure adheres to Angular component patterns and leverages dependency injection for configuration and theme management. Developers are encouraged to review [Memory Best Practices](https://www.scichart.com/documentation/js/v5/2d-charts/performance-tips/memory-best-practices/) and [Getting Started with SciChart JS](https://www.scichart.com/getting-started/scichart-javascript/) for further insights into performance optimization and optimal integration techniques.\n",
            },
        },
        documentationLinks: [
            {
