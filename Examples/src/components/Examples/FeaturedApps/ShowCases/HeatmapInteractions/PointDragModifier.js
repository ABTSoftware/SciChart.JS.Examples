import { ChartModifierBase2D, DpiHelper, translateFromCanvasToSeriesViewRect } from "scichart";
export class PointDragModifier extends ChartModifierBase2D {
    type = "PointDragModifier";
    selectedRS;
    ...
    modifierMouseMove(args) {
        ...
        const dataSeries = this.selectedRS.dataSeries;
