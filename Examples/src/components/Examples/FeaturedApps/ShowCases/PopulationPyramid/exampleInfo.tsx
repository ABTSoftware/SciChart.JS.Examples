    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Population Pyramid Example in JavaScript\n\n### Overview\nThis example demonstrates how to create a high-performance population pyramid chart using SciChart.js in JavaScript. It visualizes demographic data for regions such as Africa and Europe using stacked column charts with synchronized axes, all implemented without any additional frameworks.\n\n### Technical Implementation\nThe chart is initialized by creating a `SciChartSurface` along with a WebAssembly context (`wasmContext`), leveraging techniques described in the [Creating a new SciChartSurface and loading Wasm](https://www.scichart.com/documentation/js/v4/2d-charts/surface/new-scichart-surface/) documentation. NumericAxis instances are configured with custom properties and their visible ranges are synchronized as detailed in the [Axis Ranging - Setting and Getting VisibleRange](https://www.scichart.com/documentation/js/v4/2d-charts/axis-api/ranging-scaling/set-range-zoom-to-fit/) guide. A `CustomDataLabelManager` implementing `IDataLabelLayoutManager` is implemented to avoid overlapping labels, following strategies explained in [Data Label Positioning](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/data-point-labels/data-label-positioning/). The population pyramid is constructed by combining `StackedColumnRenderableSeries` into a `StackedColumnCollection`, as described in [The Stacked Column Series Type](https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/stacked-column-renderable-series/). Additionally, smooth series transitions are achieved using `WaveAnimation`, as covered by the [Animations API](https://www.scichart.com/documentation/js/v4/2d-charts/animations-api/animations-api-overview/).\n\n### Features and Capabilities\nThe example supports interactive zooming and panning through modifiers such as `ZoomExtentsModifier` and `MouseWheelZoomModifier`, providing an engaging user experience noted in [Tutorial 03 - Adding Zooming, Panning Behavior](https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-03-adding-zooming-panning-behavior/). It also includes advanced capabilities like selective legend configuration and the synchronization of dual axes for male and female data series within the stacked column chart.\n\n### Integration and Best Practices\nIn this JavaScript implementation, resource cleanup is handled by calling `sciChartSurface.delete()`, following best practices outlined in [Memory Best Practices](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/memory-best-practices/). Although SciChart.js can be integrated with frameworks like Angular and React, this example focuses solely on JavaScript, offering a lightweight yet powerful solution for building real-time, high-performance charts with extensive customization options.",
            },
            react: {
                subtitle:
                    "Population Pyramid of Europe and Africa using SciChart.js High Performance JavaScript Charts. This also demonstrates the use of DataLabelLayoutManager to Modify the positions of data labels from different series to prevent overlap",
