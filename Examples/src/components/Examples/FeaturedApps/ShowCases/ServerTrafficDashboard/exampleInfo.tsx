    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            ...
            react: {
                ...
                markdownContent:
                    '## Server Traffic Dashboard - React Example\n\n### Overview\nThis React-based example, "Server Traffic Dashboard," demonstrates how to build a complex, interactive dashboard using SciChart.js within a React application. The dashboard brings together multiple charts—including a main time series chart, a page statistics chart, a server load chart, and region-based charts (both column and pie charts)—to provide a comprehensive view of server traffic and performance data.\n\n### Technical Implementation\nThe example is structured around React hooks and  `<SciChartReact/>` components to manage lifecycle events and context. It uses a custom `VisibleRangeSynchronizationManager` to coordinate zooming and panning across different chart surfaces; see the [Synchronizing Multiple Charts](https://www.scichart.com/documentation/js/v5/2d-charts/chart-synchronization-api/synchronizing-multiple-charts/) documentation for more details. Custom tooltip templates are implemented via option functions registered with the ChartBuilder API, as described in the [Complex Options](https://www.scichart.com/documentation/js/v5/2d-charts/builder-api/complex-options/) guide. Dynamic styling is achieved through a `CustomPaletteProvider` that adjusts point markers based on metadata, following the guidelines in the [PaletteProvider API](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/palette-provider-api/palette-provider-api-overview/#what-is-the-paletteprovider-api). Additionally, a specialized `GridLayoutModifier` enables the transformation of the server load chart into a grid of sub-charts with smooth animations, which is in line with techniques presented in the [SubCharts Worked Example](https://www.scichart.com/documentation/js/v5/2d-charts/subcharts-api/example-using-sub-charts-to-create-large-dashboard/).\n\n### Features and Capabilities\nKey features include real-time data updates, interactive data filtering, and advanced tooltips that display aggregated statistics (such as average request duration). The dashboard also supports a 100% stacked column view for URL statistics, which aggregates data across different pages as detailed in our [Stacked Column Chart](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/stacked-column-renderable-series/) resources. Interactive animations and hover effects are implemented using the `GenericAnimation` framework ([Generic Animations](https://www.scichart.com/documentation/js/v5/2d-charts/animations-api/generic-animations/)), and mouse event synchronization across chart modifiers is managed by a custom `ModifierGroup` class.\n\n### Integration and Best Practices\nThe implementation demonstrates excellent integration with React by encapsulating individual charts into `<SciChartReact/>` components and coordinating them through a shared context and a chart group loader. Techniques for real-time updates are implemented to ensure efficient rendering and smooth performance, as recommended in [Realtime Updates](https://www.scichart.com/documentation/js/v5/2d-charts/chart-types/data-series-api/realtime-updates/). Additionally, advanced synchronization of mouse events across multiple charts highlights best practices for interactive dashboards; more details can be found in the [Synchronizing ChartModifier Mouse Events](https://www.scichart.com/synchronizing-chartmodifier-mouse-events-across-charts/) article. For further insights into integrating SciChart.js with React, developers are encouraged to review the [React Charts with SciChart.js](https://www.scichart.com/blog/react-charts-with-scichart-js/) blog post.',
            },
            angular: {
                subtitle:
                    "Demonstrates handling realtime big data with different chart types using SciChart.js, High Performance JavaScript Charts",
