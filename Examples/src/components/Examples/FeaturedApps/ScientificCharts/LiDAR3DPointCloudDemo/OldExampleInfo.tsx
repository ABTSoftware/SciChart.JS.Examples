...
import { metaData } from "./LiDAR3DPointCloudDemoMetadata";
...
export const oldlidar3DPointCloudExampleInfo: TExampleInfo = {
    onWebsite: true,
...
export const lidar3DPointCloudExampleInfo = createExampleInfo(metaData as IExampleMetadata);
