...
export class Radix2FFT {
    ...
    dft;
    TwoPi_N;
    WN = { re: 0, im: 0 }; // Wn is the exponential weighting function in the form a + jb
    TEMP = { re: 0, im: 0 }; // TEMP is used to save computation in the butterfly calc
    constructor(n) {
        this.n = n;
