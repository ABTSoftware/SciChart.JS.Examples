    ...
    return (
        <React.Fragment>
            <div className={classes.ExampleWrapperAudio}>
                <div
                    id={divElementIdAudioChart}
                    // style={{ width: TOP_CHART_WIDTH, height: TOP_CHART_HEIGHT }}
                />
                <div>
                    <div
                    ...
                    />
                    <div
                        id={divElementIdChart3}
                        // style={{ width: BOTTOM_CHART_WIDTH, height: BOTTOM_CHART_HEIGHT }}
                    />
                </div>
            </div>
        </React.Fragment>
