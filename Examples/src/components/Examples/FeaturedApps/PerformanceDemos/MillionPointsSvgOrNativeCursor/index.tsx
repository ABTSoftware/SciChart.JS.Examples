    ...
    return (
        <div className={commonClasses.ChartWithToolbar}>
            <div className={commonClasses.ToolbarRow} style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                >
                    <ToggleButton value={true} style={{ color: appTheme.ForegroundColor }}>
                        <svg style={{width: 32, height: 32}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="#FFF">
                    ...
                    <ToggleButton value={false} style={{ color: appTheme.ForegroundColor }}>
                        <svg style={{width: 32, height: 32}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="#FFF">
                            ...
                            <text x="13" y="13.3" fontSize="4" strokeWidth="0.5" textAnchor="middle">Y</text>
