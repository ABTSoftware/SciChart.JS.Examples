...
const metaData: IExampleMetadata =
    //// This metadata is computer generated - do not edit!
    {
        ...
        metaKeywords: "performance, cursor, svg, native, 1 million, scatter, gradient, palette, render loop, javascript, webgl",
        onWebsite: true,
