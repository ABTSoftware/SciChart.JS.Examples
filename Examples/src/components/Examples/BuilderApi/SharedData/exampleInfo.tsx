    ...
    //// This metadata is computer generated - do not edit!
    {
        ...
        frameworks: {
            javascript: {
                ...
                markdownContent:
                    "## Shared Data - JavaScript\n\n### Overview\nThis example demonstrates how to create **reusable chart templates** using the SciChart.js Builder API in a JavaScript environment. The chart template is defined using a JSON object that outlines multiple series and SVG text annotations, while the actual data is applied later via a shared data structure. Developers can learn more about the JSON configuration capabilities in the [Intro to the Builder API | JavaScript Chart Documentation - SciChart](https://www.scichart.com/documentation/js/v4/2d-charts/builder-api/builder-api-overview/).\n\n### Technical Implementation\nThe implementation leverages a JSON definition to configure various chart elements including a ColumnSeries, LineSeries, and SplineBandSeries. Data is injected asynchronously using async/await, ensuring efficient initialization. The shared data object enables the dynamic integration of x, column, and line data across multiple series, resonating with the practices outlined in the [Working with Data | JavaScript Chart Documentation - SciChart](https://www.scichart.com/documentation/js/v4/2d-charts/builder-api/working-with-data/). Additionally, the configuration includes SVG text annotations as described in the [Tutorial 06 - Adding Annotations | JavaScript Chart Documentation](https://www.scichart.com/documentation/js/v4/get-started/tutorials-js-npm-webpack/tutorial-06-adding-annotations/) guide.\n\n### Features and Capabilities\nThis example offers advanced functionality such as multi-series rendering, real-time data update capabilities through shared data, and custom theming via an externally defined appTheme. These features allow developers to build dynamic and visually consistent charts. Further customization of themes can be explored in the [Chart Styling - Creating a Custom Theme - SciChart](https://www.scichart.com/documentation/js/v4/2d-charts/styling-and-theming/creating-custom-theme/) documentation.\n\n### Integration and Best Practices\nAlthough a React component is provided to showcase multi-framework integration, the focus here is on JavaScript implementation. The example emphasizes best practices such as asynchronous chart initialization and proper memory management through chart disposal, which are critical for optimizing performance. Developers looking to further refine performance should consult the [Memory Best Practices | JavaScript Chart Documentation - SciChart](https://www.scichart.com/documentation/js/v4/2d-charts/performance-tips/memory-best-practices/) and the [Getting Started with SciChart JS](https://www.scichart.com/getting-started/scichart-javascript/) guides for comprehensive insights.",
            },
            react: {
                subtitle:
                    "Demonstrates how to use the Builder Api to create **Reusable Chart Templates** using SciChart.js Builder API. Use this method when you want to create a template for a chart and add data later.",
