    ...
    return {
        ...
        items: menuItem.submenu.map((subMenu) => {
            return {
                ...
                seoTitle: getFrameworkContent(subMenu.pageTitle, framework) + ExampleStrings.exampleGenericTitleSuffix(framework, getFrameworkContent(subMenu.pageTitle, framework).length),
