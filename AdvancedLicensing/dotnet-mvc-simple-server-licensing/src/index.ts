...
// also generates a client nonce in WASM and appends &nonce=<hex>. The route matches
// LicenseController.Get() via [Route("api/[controller]")] — no setServerLicenseEndpoint call needed.
