async function simpleColumnChartWithPointMarkers(divElementId) {
  // #region ExampleA
...
simpleColumnChartWithPointMarkers("scichart-root");
    ...
    series: [
      {
        ...
        options: {
          ...
          strokeThickness: 2,
          dataPointWidth: 0.0,
          pointMarker: { type: EPointMarkerType.Ellipse, options: {
              width: 9,
              height: 9,
              fill: "rgba(176, 196, 222, 0.7)",
              stroke: "rgba(176, 196, 222, 1)"
