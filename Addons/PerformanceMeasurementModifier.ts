...
import { CustomPerformanceDebugHelper, SCPerformanceMeasure } from "./performanceHelperOverrides";
...
function generateControlBarHtml(
    ...
    const keepDataSwitch = createSwitch("Keep collected data", initialKeepCollectedData, onKeepDataSwitchChange);
    ...
    controlBar.append(buttonGroup, autoInvalidateSwitch, keepDataSwitch, verboseSwitch, switch3Result.element);
