<template>
  <div>
    <button @click="initSciChart()">Show SciChart</button>

    <div id="scichart-root" style="width: 600px; height: 400px; margin: auto" />
  </div>
</template>
...
export default {
  ...
  methods: {
    async initSciChart() {
      ...
      //
      // Make sure to call `sciChartSurface.delete()` to do a cleanup when necessary.
      // Refer to the Vue boilerplate for an example.
