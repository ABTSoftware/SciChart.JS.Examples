...
const generateData = (xSize: number, zSize: number) => {
  const heightmapArray: number[][] = []
  const wc = xSize * 0.5,
    hc = zSize * 0.5
...
export default defineComponent({
  data(): { chartInitializationPromise?: Promise<SciChart3DSurface> } {
    return {
  ...
  beforeUnmount() {
    ...
    this.chartInitializationPromise!.then((sciChart3DSurface: SciChart3DSurface) => {
