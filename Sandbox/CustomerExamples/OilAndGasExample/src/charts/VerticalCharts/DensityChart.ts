...
const generateDensityLegend = (
  ...
  return `
    <div class="chart-legend">
        <div class="legend-color-item" style="height: 30px; color: ${
          appTheme.LegendTextColor
        }">
            <div class="color-label" style="background-color: ${
              appTheme.DensityBackgroundOne
            };"></div>
            <div class="color-label" style="background-color: ${
              appTheme.DensityBackgroundTwo
            };"></div>
        </div>
        <span class="scichart__legend-line" style="border-top: 2px solid ${
          appTheme.DensityLegendSeparator
        }"></span>
