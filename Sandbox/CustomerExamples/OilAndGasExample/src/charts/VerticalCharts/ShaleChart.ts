...
import {
  getCommonChartConfigs,
  getCommonChartModifiersConfig,
  getParsedData,
} from "./utils";
...
export const drawShaleChart = async () => {
  ...
  const { sciChartSurface, wasmContext } = await chartBuilder.build2DChart(
    "shale-chart",
    {
      ...
      surface: {
        ...
        theme: {
          type: appTheme.SciChartJsTheme.type,
  ...
  const stackedMountainCollection =
    renderableSeries[0] as StackedMountainCollection;
    ...
    <div class="chart-legend full-size-legend">
        <div class="legend-color-item">
            <div class="color-label" style="background-color: ${
              appTheme.ShaleOilLegendColor
            }; color: ${appTheme.LegendTextColor};"></div>
            <div class="color-label" style="background-color: ${
              appTheme.ShaleWaterLegendColor
            }; color: ${appTheme.LegendTextColor};"></div>
        </div>
        <div class="legend-text-item" style="color: ${
        ...
        <div class="legend-color-item" style="background-color: ${
          appTheme.ShaleBackgroundColor
        };">
