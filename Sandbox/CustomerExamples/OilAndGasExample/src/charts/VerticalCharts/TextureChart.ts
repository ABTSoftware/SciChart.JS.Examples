...
import {
  RangeFillPaletteProvider,
  PaletteRange,
} from "./RangeFillPaletteProvider";
import {
...
const generateTextureLegend = (
  ...
  return `
    <div class="chart-legend full-size-legend" style="color: ${
      appTheme.LegendTextColor
    };">
        <div class="legend-color-item">
            <div class="color-label" style="background-color: ${
              appTheme.TextureLine
            };"></div>
            <div class="color-label" style="background-color: ${
              appTheme.TextureGrainFill
            };"></div>
        </div>
        ...
        <div class="legend-color-item">
            <div class="color-label" style="background-color: ${
              appTheme.TextureSandFill
            };"></div>
            <div class="color-label" style="background-color: ${
              appTheme.TextureGravelFill
            };"></div>
        </div>
        <div class="legend-text-item">
            <span>${"SAND"}</span>
