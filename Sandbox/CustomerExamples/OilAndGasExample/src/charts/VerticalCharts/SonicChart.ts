...
const generateSonicLegend = (
  ...
  return `
    <div class="chart-legend full-size-legend">
        <div class="legend-color-item" style="background-image: linear-gradient(to right, ${
          appTheme.SonicGradient1
        }, ${appTheme.SonicGradient2}, ${appTheme.SonicGradient3}, ${
    appTheme.SonicGradient4
  }, ${appTheme.SonicGradient5}, ${appTheme.SonicGradient6});">
        </div>
        ...
        <div class="legend-color-item">
            ...
            <div class="color-label" style="background-color: ${
              appTheme.SonicGradient3
            };"></div>
            <div class="color-label" style="background-color: ${
              appTheme.SonicGradient4
            };"></div>
            <div class="color-label" style="background-color: ${
              appTheme.SonicGradient5
            };"></div>
            <div class="color-label" style="background-color: ${
