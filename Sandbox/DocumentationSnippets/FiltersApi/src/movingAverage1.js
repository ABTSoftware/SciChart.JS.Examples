...
export async function initSciChart4() {
    ...
    sciChartSurface.xAxes.add(
        new NumericAxis(wasmContext, { growBy: new NumberRange(0.01, 0.01), autoRange: EAutoRange.Always })
    );
    ...
    const filteredLine30 = new FastLineRenderableSeries(wasmContext, {
        dataSeries: movingAverage30,
        stroke: '#55dd55',
        strokeThickness: 3,
    });
