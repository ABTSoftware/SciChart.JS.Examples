...
export async function initSciChart3() {
    ...
    const rsHigh = new FastLineRenderableSeries(wasmContext, {
        dataSeries: linearTrendHigh,
        stroke: '#ddff33',
        strokeThickness: 3,
    });
    const rsLow = new FastLineRenderableSeries(wasmContext, {
        dataSeries: linearTrendLow,
        stroke: '#ff5599',
        strokeThickness: 3,
    });
