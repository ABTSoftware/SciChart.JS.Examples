...
export async function subChartWithBuilderApi(divElementId: string) {
...
export async function subChartOverLineSeries(divElementId: string) {
    const { sciChartSurface, wasmContext } = await SciChartSurface.create(divElementId);
...
export async function subChartOverLineSeriesWithBuilderApi(divElementId: string) {
    const { wasmContext, sciChartSurface } = await chartBuilder.build2DChart(divElementId, {
        // axes here are required to draw renderable series
        xAxes: { type: EAxisType.NumericAxis },
        yAxes: { type: EAxisType.NumericAxis },
...
export async function subChartPixelCoordinateMode(divElementId: string) {
    const { sciChartSurface, wasmContext } = await SciChartSurface.create(divElementId);
...
export async function subChartDataValueCoordinateMode(divElementId: string) {
    const { sciChartSurface, wasmContext } = await SciChartSurface.create(divElementId);
...
export async function subChartDataValueCoordinateModeWithBuilderApi(divElementId: string) {
    const { wasmContext, sciChartSurface } = await chartBuilder.build2DChart(divElementId, {
        xAxes: { type: EAxisType.NumericAxis },
        yAxes: { type: EAxisType.NumericAxis },
        subCharts: [
...
export async function subChartParentAxes(divElementId: string) {
    const { sciChartSurface, wasmContext } = await SciChartSurface.create(divElementId);
...
export async function subChartParentAxesWithBuilderApi(divElementId: string) {
    const { wasmContext, sciChartSurface } = await chartBuilder.build2DChart(divElementId, {
        // define multiple X and Y Axes
        xAxes: [
            {
...
export async function updateSubChartPosition(divElementId: string) {
    const { sciChartSurface, wasmContext } = await SciChartSurface.create(divElementId);
...
export async function updateSubChartPositionWithBuilderApi(divElementId: string) {
    const { wasmContext, sciChartSurface } = await chartBuilder.build2DChart(divElementId, {
        // define multiple X and Y Axes
        xAxes: [
            {
...
export async function nonTransparentSubChart(divElementId: string) {
    const { sciChartSurface, wasmContext } = await SciChartSurface.create(divElementId);
...
export async function nonTransparentSubChartWithBuilderApi(divElementId: string) {
    const { wasmContext, sciChartSurface } = await chartBuilder.build2DChart(divElementId, {
        xAxes: { type: EAxisType.NumericAxis },
        yAxes: { type: EAxisType.NumericAxis },
        series: {
