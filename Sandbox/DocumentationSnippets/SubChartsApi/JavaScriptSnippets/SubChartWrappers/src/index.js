...
export async function subChartWrapperExample(divElementId, subChartDivElementId) {
...
export async function subChartWrapperWithBuilderApi(divElementId, subChartDivElementId) {
...
export async function subChartWrapperByRefExample(divElementId, subChartDivElementId) {
    const { sciChartSurface, wasmContext } = await SciChartSurface.create(divElementId);
...
export async function subChartWrapperByRefWithBuilderApi(divElementId, subChartDivElementId) {
    const subChartContainer = document.getElementById(subChartDivElementId);
