...
export async function annotationAdornersDefaultStyle(divElementId: string) {
...
export async function annotationAdornersDefaultStyleViaBuilderAPI(divElementId: string) {
...
export async function annotationAdornersStylingViaOptions(divElementId: string) {
    const { sciChartSurface, wasmContext } = await SciChartSurface.create(divElementId);
...
export async function annotationAdornersStylingViaProperties(divElementId: string) {
    const { sciChartSurface, wasmContext } = await SciChartSurface.create(divElementId);
...
export async function annotationAdornersStylingViaBuilderAPI(divElementId: string) {
    const { sciChartSurface, wasmContext } = await chartBuilder.build2DChart(divElementId, {
        annotations: {
            type: EAnnotationType.RenderContextBoxAnnotation,
            options: {
...
export async function dragPointsCustomization(divElementId: string) {
    const { sciChartSurface, wasmContext } = await SciChartSurface.create(divElementId);
...
export async function dragPointsCustomizationViaBuilderAPI(divElementId: string) {
    const { sciChartSurface, wasmContext } = await chartBuilder.build2DChart(divElementId, {
        annotations: {
            type: EAnnotationType.RenderContextBoxAnnotation,
            options: {
...
export async function resizeDirectionCustomization(divElementId: string) {
    const { sciChartSurface, wasmContext } = await SciChartSurface.create(divElementId);
...
export async function resizeDirectionCustomizationViaBuilderAPI(divElementId: string) {
    const { sciChartSurface, wasmContext } = await chartBuilder.build2DChart(divElementId, {
        annotations: {
            type: EAnnotationType.RenderContextBoxAnnotation,
            options: {
...
export async function adornersSvgCustomization(divElementId: string) {
    const { sciChartSurface, wasmContext } = await SciChartSurface.create(divElementId);
