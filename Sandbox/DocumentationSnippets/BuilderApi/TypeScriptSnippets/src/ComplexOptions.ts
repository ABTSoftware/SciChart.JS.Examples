...
import { TPaletteProviderDefinition } from "scichart/Builder/types/SeriesDefinitions";
import { EllipsePointMarker } from "scichart/Charting/Visuals/PointMarkers/EllipsePointMarker";

export async function drawWithComplexOptionsUsingBuilderApi(
  divElementId: string
) {
...
export async function drawWithComplexOptionsAlternativeUsingBuilderApi(
  divElementId: string
) {
...
export async function drawChartWithRegisteredFunctionUsingBuilderApi(
  divElementId: string
) {
  ...
  chartBuilder.registerFunction(
    EBaseType.OptionFunction,
    "logOnSelectionChanged",
    logOnSelectionChanged
  );
...
export async function drawChartWithCustomSubtypeUsingBuilderApi(
  divElementId: string
) {
  ...
  chartBuilder.registerType(
    ...
    (options: { stroke: string; fill: string }) =>
      new ExampleMountainPaletteProvider(options)
  );
