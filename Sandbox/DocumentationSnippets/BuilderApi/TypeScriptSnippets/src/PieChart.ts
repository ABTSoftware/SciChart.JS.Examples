...
export async function drawSimplePieChartUsingBuilderApi(divElementId: string) {
...
export async function drawSimplePieChartUsingGenericBuilderApi(divElementId: string) {
