...
export async function customModifiersSandboxTs(divId: string) {
    ...
    sciChartSurface.xAxes.add(
        new NumericAxis(wasmContext, { id: 'XAxis_0', axisTitle: 'XAxis 0', axisAlignment: EAxisAlignment.Top })
    );
    sciChartSurface.xAxes.add(
        new NumericAxis(wasmContext, { id: 'XAxis_1', axisTitle: 'XAxis 1', axisAlignment: EAxisAlignment.Bottom })
    );
    sciChartSurface.yAxes.add(
        new NumericAxis(wasmContext, { id: 'YAxis_0', axisTitle: 'YAxis 0', axisAlignment: EAxisAlignment.Left })
    );
    sciChartSurface.yAxes.add(
        new NumericAxis(wasmContext, { id: 'YAxis_1', axisTitle: 'YAxis 1', axisAlignment: EAxisAlignment.Right })
    );
    ...
    sciChartSurface.renderableSeries.add(
        new FastLineRenderableSeries(wasmContext, {
            dataSeries: new XyDataSeries(wasmContext, { xValues, yValues, seriesName: 'Yellow series' }),
            strokeThickness: 3,
            stroke: 'Yellow',
            yAxisId: 'YAxis_0',
            xAxisId: 'XAxis_0',
