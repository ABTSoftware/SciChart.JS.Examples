...
```html
<script
  src="https://cdn.jsdelivr.net/npm/scichart@3.3.614/_wasm/scichart.browser.js"
...
SciChart.SciChartSurface.configure({
  dataUrl: `https://cdn.jsdelivr.net/npm/scichart@3.3.614${SciChart.libraryVersion}/_wasm/scichart2d.data`,
  wasmUrl: `https://cdn.jsdelivr.net/npm/scichart@3.3.614${SciChart.libraryVersion}/_wasm/scichart2d.wasm`,
});
```
