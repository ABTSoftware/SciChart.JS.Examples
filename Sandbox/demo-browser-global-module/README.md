...
```html
<script
  src="https://cdn.jsdelivr.net/npm/scichart@4.0.0-beta.629/_wasm/scichart.browser.js"
...
SciChart.SciChartSurface.configure({
  dataUrl: `https://cdn.jsdelivr.net/npm/scichart@4.0.0-beta.629${SciChart.libraryVersion}/_wasm/scichart2d.data`,
  wasmUrl: `https://cdn.jsdelivr.net/npm/scichart@4.0.0-beta.629${SciChart.libraryVersion}/_wasm/scichart2d.wasm`,
});
```
